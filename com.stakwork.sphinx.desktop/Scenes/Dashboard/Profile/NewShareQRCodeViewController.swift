//
//  NewShareQRCodeViewController.swift
//  Sphinx
//
//  Created by Tomas Timinskas on 01/07/2024.
//  Copyright © 2024 Tomas Timinskas. All rights reserved.
//

import Cocoa

class NewShareQrCodeViewController: NSViewController {
    ...
    static func instantiate(
        profile: UserContact,
        delegate: NewContactDismissDelegate?
    ) -> NewShareQrCodeViewController {
        let viewController = StoryboardScene.Dashboard.newShareQrCodeViewController.instantiate()
