...
export default defineStep({
    ...
    description: "Fetch the attribute schema for a SINGLE ontology node type. Returns exactly " +
    ...
    async run(cfg, ctx) {
        try {
            ...
            if (!schema)
                return `graph/get-ontology-type: unknown type ${cfg.type}`;
...
//# sourceMappingURL=get-ontology-type.js.map