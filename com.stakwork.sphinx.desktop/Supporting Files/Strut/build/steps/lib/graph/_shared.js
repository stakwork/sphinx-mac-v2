 ...
 * top level.
 */
export async function graphCtx(ctx) {
...
export async function writeEdge(b, a) {
    ...
    try {
        ...
        if (!a.create_schema_if_missing || graphErrorCode(e) !== "WRONG_TYPE")
            throw e;
