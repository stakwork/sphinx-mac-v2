...
export default defineStep({
    ...
    input: z.object({
        ...
        code: z
            .string()
            .describe('Full TypeScript source. Shape: import { z, defineStep } from "strut"; export default defineStep({ type: "<name>", input: z.object({...}), output: z.any(), async run(cfg, ctx) {...} });'),
