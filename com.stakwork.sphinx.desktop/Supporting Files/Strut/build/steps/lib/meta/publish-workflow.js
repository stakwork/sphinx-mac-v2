...
export default defineStep({
    ...
    output: z.any(),
    async run(cfg, ctx) {
        return requireAuthoring(ctx.services).publishWorkflow(cfg.name, cfg.yaml, cfg.description, cfg.category);
    },
});
