...
export default defineStep({
    ...
    description: "Get a published workflow's full YAML source plus version metadata. Defaults to the active version; pass `version` for a specific one. Read before republishing a candidate with meta/publish-workflow.",
    input: z.object({
