...
export default defineStep({
    type: "meta/get-step",
    description: "Get a step type's details: input schema fields, description, and (for lib/custom steps) source code. Read before editing a step or wiring it into a workflow.",
    input: z.object({
