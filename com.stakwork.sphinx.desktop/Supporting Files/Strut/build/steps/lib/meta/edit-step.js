...
export default defineStep({
    type: "meta/edit-step",
    description: "Publish a NEW VERSION of an EXISTING agent-authored custom step. Same self-contained source rules as meta/create-step; call meta/get-step first to read the current source. Identical content is a no-op; a change increments the version (v1 → v2 → …) with prior versions kept for rollback. Only steps the agent surface authored can be edited — built-ins and seeded steps are refused.",
    input: z.object({
...
//# sourceMappingURL=edit-step.js.map