...
__export(index_exports, {
  ...
  callGenerateText: () => callGenerateText,
  callModel: () => callModel,
  captureNativeFetchResults: () => captureNativeFetchResults,
  captureNativeResults: () => captureNativeResults,
  computeSessionCost: () => computeSessionCost,
  consoleLogger: () => consoleLogger,
  createWebFetch: () => createWebFetch,
  createWebSearch: () => createWebSearch,
  emptyUsage: () => emptyUsage,
  fetchUrl: () => fetchUrl,
  gatewayEnvForProviders: () => gatewayEnvForProviders,
  gatewayUrlFor: () => gatewayUrlFor,
  gatewayUrlForModel: () => gatewayUrlForModel,
  getApiKeyForProvider: () => getApiKeyForProvider,
  getContextLimit: () => getContextLimit,
  getGatewayBaseURL: () => getGatewayBaseURL,
  getLightModelForProvider: () => getLightModelForProvider,
  getModel: () => getModel,
  getModelDetails: () => getModelDetails,
  getProviderForModel: () => getProviderForModel,
  getProviderOptions: () => getProviderOptions,
  getProviderTool: () => getProviderTool,
  getSearchApiKey: () => getSearchApiKey,
  ...
  linkifyCitations: () => linkifyCitations,
  ...
  resolveFetchBackend: () => resolveFetchBackend,
  resolveLLMConfig: () => resolveLLMConfig,
  resolveSearchBackend: () => resolveSearchBackend,
  searchWeb: () => searchWeb,
  stripCitations: () => stripCitations,
  validateFetchUrl: () => validateFetchUrl,
  withLegacyUsage: () => withLegacyUsage,
  withProviderCacheUsage: () => withProviderCacheUsage
});
...
function parseArrayDef(def, refs) {
  ...
  if (((_a24 = def.type) == null ? void 0 : _a24._def) && ((_c = (_b24 = def.type) == null ? void 0 : _b24._def) == null ? void 0 : _c.typeName) !== import_v32.ZodFirstPartyTypeKind.ZodAny) {
...
function parseRecordDef(def, refs) {
  ...
  if (((_b24 = def.keyType) == null ? void 0 : _b24._def.typeName) === import_v33.ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
...
function standardSchema(standardSchema22) {
  return jsonSchema(
    () => {
      if (!hasStandardJsonSchema(standardSchema22)) {
        throw new Error(
          `Standard schema vendor '${standardSchema22["~standard"].vendor}' does not support JSON Schema conversion.`
        );
      }
...
var VERSION2 = true ? "3.0.105" : "0.0.0-test";
...
var anthropicStopDetailsSchema = import_v43.z.object({
  type: import_v43.z.string(),
  category: import_v43.z.string().nullish(),
  explanation: import_v43.z.string().nullish(),
  recommended_model: import_v43.z.string().nullish()
});
    ...
    import_v43.z.object({
      ...
      content: import_v43.z.array(
        import_v43.z.discriminatedUnion("type", [
          ...
          import_v43.z.object({
            type: import_v43.z.literal("advisor_tool_result"),
            tool_use_id: import_v43.z.string(),
            content: import_v43.z.discriminatedUnion("type", [
              import_v43.z.object({
                type: import_v43.z.literal("advisor_result"),
                text: import_v43.z.string()
              }),
              import_v43.z.object({
                type: import_v43.z.literal("advisor_redacted_result"),
                encrypted_content: import_v43.z.string()
              }),
              import_v43.z.object({
                type: import_v43.z.literal("advisor_tool_result_error"),
                error_code: import_v43.z.string()
              })
            ])
          }),
          ...
          import_v43.z.object({
            type: import_v43.z.literal("fallback")
          })
        ])
      ),
      ...
      usage: import_v43.z.looseObject({
        ...
        output_tokens_details: import_v43.z.object({
          thinking_tokens: import_v43.z.number().nullish()
        }).nullish(),
        ...
        iterations: import_v43.z.array(
          import_v43.z.object({
            type: import_v43.z.union([
              import_v43.z.literal("compaction"),
              import_v43.z.literal("message"),
              import_v43.z.literal("advisor_message"),
              import_v43.z.literal("fallback_message")
            ]),
            model: import_v43.z.string().nullish(),
            input_tokens: import_v43.z.number(),
            output_tokens: import_v43.z.number(),
...
var anthropicSystemMessageProviderOptions = import_v44.z.object({
  /**
   ...
   */
  toolChanges: import_v44.z.array(
    import_v44.z.discriminatedUnion("type", [
      import_v44.z.object({
        type: import_v44.z.literal("tool_addition"),
        toolName: import_v44.z.string()
      }),
      import_v44.z.object({
        type: import_v44.z.literal("tool_removal"),
        toolName: import_v44.z.string()
      })
    ])
  ).optional()
...
var anthropicLanguageModelOptions = import_v44.z.object({
  ...
  thinking: import_v44.z.discriminatedUnion("type", [
    import_v44.z.object({
       ...
       */
      display: import_v44.z.enum(["omitted", "summarized"]).optional()
    }),
    import_v44.z.object({
   ...
   * @default 'high'
   */
  effort: import_v44.z.enum(["low", "medium", "high", "xhigh", "max"]).optional(),
  /**
   ...
   */
  taskBudget: import_v44.z.object({
    type: import_v44.z.literal("tokens"),
    total: import_v44.z.number().int().min(2e4),
    remaining: import_v44.z.number().int().min(0).optional()
  }).optional(),
  /**
   ...
   */
  fallbacks: import_v44.z.union([
    import_v44.z.literal("default"),
    import_v44.z.array(
      import_v44.z.object({
        model: import_v44.z.string(),
        max_tokens: import_v44.z.number().int().optional(),
        thinking: import_v44.z.record(import_v44.z.string(), import_v44.z.unknown()).optional(),
        output_config: import_v44.z.record(import_v44.z.string(), import_v44.z.unknown()).optional(),
        speed: import_v44.z.enum(["fast", "standard"]).optional()
      })
    )
  ]).optional(),
...
function getCacheControl(providerMetadata) {
  ...
  const cacheControlValue = (_a20 = anthropic2 == null ? void 0 : anthropic2.cacheControl) != null ? _a20 : anthropic2 == null ? void 0 : anthropic2.cache_control;
...
var advisor_20260301ArgsSchema = lazySchema(
  () => zodSchema(
    import_v45.z.object({
      ...
      caching: import_v45.z.object({
        type: import_v45.z.literal("ephemeral"),
        ttl: import_v45.z.union([import_v45.z.literal("5m"), import_v45.z.literal("1h")])
      }).optional()
    })
  )
);
var advisor_20260301OutputSchema = lazySchema(
  () => zodSchema(
    import_v45.z.discriminatedUnion("type", [
      import_v45.z.object({
        type: import_v45.z.literal("advisor_result"),
        text: import_v45.z.string()
      }),
      import_v45.z.object({
        type: import_v45.z.literal("advisor_redacted_result"),
        encryptedContent: import_v45.z.string()
      }),
      import_v45.z.object({
        type: import_v45.z.literal("advisor_tool_result_error"),
        errorCode: import_v45.z.string()
      })
    ])
  )
);
var advisor_20260301InputSchema = lazySchema(
  () => zodSchema(import_v45.z.object({}).strict())
);
...
var textEditor_20250728ArgsSchema = lazySchema(
  () => zodSchema(
    import_v46.z.object({
      maxCharacters: import_v46.z.number().optional()
    })
  )
);
var textEditor_20250728InputSchema = lazySchema(
  () => zodSchema(
    import_v46.z.object({
      command: import_v46.z.enum(["view", "create", "str_replace", "insert"]),
      ...
      insert_text: import_v46.z.string().optional(),
...
var webSearch_20250305ArgsSchema = lazySchema(
  () => zodSchema(
    import_v48.z.object({
      ...
      userLocation: import_v48.z.object({
        type: import_v48.z.literal("approximate"),
        city: import_v48.z.string().optional(),
        region: import_v48.z.string().optional(),
        country: import_v48.z.string().optional(),
        timezone: import_v48.z.string().optional()
      }).optional()
    })
  )
);
  ...
  () => zodSchema(
    import_v48.z.array(
      import_v48.z.object({
        ...
        pageAge: import_v48.z.string().nullable(),
        encryptedContent: import_v48.z.string(),
        type: import_v48.z.literal("web_search_result")
      })
    )
  )
);
...
var webFetch_20250910ArgsSchema = lazySchema(
  () => zodSchema(
    import_v410.z.object({
      maxUses: import_v410.z.number().optional(),
      allowedDomains: import_v410.z.array(import_v410.z.string()).optional(),
      blockedDomains: import_v410.z.array(import_v410.z.string()).optional(),
      citations: import_v410.z.object({ enabled: import_v410.z.boolean() }).optional(),
      maxContentTokens: import_v410.z.number().optional()
    })
  )
);
var webFetch_20250910OutputSchema = lazySchema(
  () => zodSchema(
    import_v410.z.object({
      type: import_v410.z.literal("web_fetch_result"),
      url: import_v410.z.string(),
      content: import_v410.z.object({
        type: import_v410.z.literal("document"),
        title: import_v410.z.string().nullable(),
        citations: import_v410.z.object({ enabled: import_v410.z.boolean() }).optional(),
        source: import_v410.z.union([
          import_v410.z.object({
            type: import_v410.z.literal("base64"),
            mediaType: import_v410.z.literal("application/pdf"),
            data: import_v410.z.string()
          }),
          import_v410.z.object({
            type: import_v410.z.literal("text"),
            mediaType: import_v410.z.literal("text/plain"),
            data: import_v410.z.string()
          })
        ])
      }),
      retrievedAt: import_v410.z.string().nullable()
    })
  )
);
...
async function prepareTools({
  ...
  for (const tool6 of tools) {
    switch (tool6.type) {
      case "function": {
        const cacheControl = validator.getCacheControl(tool6.providerOptions, {
          type: "tool definition",
          canCache: true
        });
        const anthropicOptions = (_a20 = tool6.providerOptions) == null ? void 0 : _a20.anthropic;
        const eagerInputStreaming = (_b20 = anthropicOptions == null ? void 0 : anthropicOptions.eagerInputStreaming) != null ? _b20 : defaultEagerInputStreaming;
        const deferLoading = anthropicOptions == null ? void 0 : anthropicOptions.deferLoading;
        const allowedCallers = anthropicOptions == null ? void 0 : anthropicOptions.allowedCallers;
        if (!supportsStrictTools && tool6.strict != null) {
          toolWarnings.push({
            type: "unsupported",
            feature: "strict",
            details: `Tool '${tool6.name}' has strict: ${tool6.strict}, but strict mode is not supported by this provider. The strict property will be ignored.`
          });
        }
        anthropicTools2.push({
          name: tool6.name,
          description: tool6.description,
          input_schema: tool6.inputSchema,
          cache_control: cacheControl,
          ...eagerInputStreaming ? { eager_input_streaming: true } : {},
          ...supportsStrictTools === true && tool6.strict != null ? { strict: tool6.strict } : {},
          ...deferLoading != null ? { defer_loading: deferLoading } : {},
          ...allowedCallers != null ? { allowed_callers: allowedCallers } : {},
          ...tool6.inputExamples != null ? {
            input_examples: tool6.inputExamples.map(
        ...
        if (tool6.inputExamples != null || allowedCallers != null) {
        ...
        switch (tool6.id) {
          ...
          case "anthropic.computer_20250124": {
            ...
            anthropicTools2.push({
              ...
              display_width_px: tool6.args.displayWidthPx,
              display_height_px: tool6.args.displayHeightPx,
              display_number: tool6.args.displayNumber,
              cache_control: void 0
            });
            break;
          }
          case "anthropic.computer_20251124": {
            ...
            anthropicTools2.push({
              ...
              display_height_px: tool6.args.displayHeightPx,
              display_number: tool6.args.displayNumber,
              enable_zoom: tool6.args.enableZoom,
              cache_control: void 0
            });
            break;
          }
...
function convertAnthropicMessagesUsage({
  ...
  var _a20, _b20, _c, _d, _e;
  const cacheCreationTokens = (_a20 = usage.cache_creation_input_tokens) != null ? _a20 : 0;
  const cacheReadTokens = (_b20 = usage.cache_read_input_tokens) != null ? _b20 : 0;
  ...
  () => zodSchema(
    import_v413.z.discriminatedUnion("type", [
      import_v413.z.object({
        type: import_v413.z.literal("code_execution_result"),
        stdout: import_v413.z.string(),
        stderr: import_v413.z.string(),
        return_code: import_v413.z.number(),
        content: import_v413.z.array(
          import_v413.z.object({
            type: import_v413.z.literal("code_execution_output"),
            file_id: import_v413.z.string()
          })
        ).optional().default([])
      }),
      import_v413.z.object({
        type: import_v413.z.literal("encrypted_code_execution_result"),
        encrypted_stdout: import_v413.z.string(),
        stderr: import_v413.z.string(),
        return_code: import_v413.z.number(),
        content: import_v413.z.array(
          import_v413.z.object({
      ...
      import_v413.z.object({
        type: import_v413.z.literal("bash_code_execution_result"),
        content: import_v413.z.array(
          import_v413.z.object({
            type: import_v413.z.literal("bash_code_execution_output"),
            file_id: import_v413.z.string()
          })
        ),
        stdout: import_v413.z.string(),
      ...
      import_v413.z.object({
        type: import_v413.z.literal("bash_code_execution_tool_result_error"),
        error_code: import_v413.z.string()
      }),
      import_v413.z.object({
        type: import_v413.z.literal("text_editor_code_execution_tool_result_error"),
        error_code: import_v413.z.string()
      }),
      import_v413.z.object({
        type: import_v413.z.literal("text_editor_code_execution_view_result"),
        content: import_v413.z.string(),
        file_type: import_v413.z.string(),
        num_lines: import_v413.z.number().nullable(),
        start_line: import_v413.z.number().nullable(),
        total_lines: import_v413.z.number().nullable()
      }),
      import_v413.z.object({
        type: import_v413.z.literal("text_editor_code_execution_create_result"),
        is_file_update: import_v413.z.boolean()
      }),
      import_v413.z.object({
        type: import_v413.z.literal("text_editor_code_execution_str_replace_result"),
        lines: import_v413.z.array(import_v413.z.string()).nullable(),
        new_lines: import_v413.z.number().nullable(),
        new_start: import_v413.z.number().nullable(),
        old_lines: import_v413.z.number().nullable(),
        old_start: import_v413.z.number().nullable()
      })
    ])
  )
);
var codeExecution_20260120InputSchema = lazySchema(
  () => zodSchema(
    import_v413.z.discriminatedUnion("type", [
      import_v413.z.object({
        type: import_v413.z.literal("programmatic-tool-call"),
        code: import_v413.z.string()
      }),
      import_v413.z.object({
        type: import_v413.z.literal("bash_code_execution"),
        command: import_v413.z.string()
      }),
      import_v413.z.discriminatedUnion("command", [
        import_v413.z.object({
          type: import_v413.z.literal("text_editor_code_execution"),
        ...
        import_v413.z.object({
          ...
          path: import_v413.z.string(),
          file_text: import_v413.z.string().nullish()
        }),
        import_v413.z.object({
          type: import_v413.z.literal("text_editor_code_execution"),
  ...
  () => zodSchema(
    import_v414.z.array(
      import_v414.z.object({
        type: import_v414.z.literal("tool_reference"),
        toolName: import_v414.z.string()
      })
    )
  )
);
var toolSearchRegex_20251119InputSchema = lazySchema(
  () => zodSchema(
    import_v414.z.object({
       ...
       */
      limit: import_v414.z.number().optional()
    })
  )
);
...
async function convertToAnthropicMessagesPrompt({
  ...
  var _a20, _b20, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v;
  const betas = /* @__PURE__ */ new Set();
  ...
  async function shouldEnableCitations(providerMetadata) {
    ...
    return (_b24 = (_a24 = anthropicOptions == null ? void 0 : anthropicOptions.citations) == null ? void 0 : _a24.enabled) != null ? _b24 : false;
  }
    ...
    switch (type) {
      case "system": {
        ...
        for (const { content: text, providerOptions } of block.messages) {
          ...
          const toolChanges = (_a20 = systemMessageOptions == null ? void 0 : systemMessageOptions.toolChanges) != null ? _a20 : [];
          ...
          switch (role) {
            case "user": {
              for (let j = 0; j < content.length; j++) {
                ...
                const cacheControl = (_b20 = validator.getCacheControl(part.providerOptions, {
                  type: "user message part",
                  canCache: true
                })) != null ? _b20 : isLastPart ? validator.getCacheControl(message.providerOptions, {
                  type: "user message",
                  canCache: true
                }) : void 0;
                switch (part.type) {
...
function sanitizeSchema(schema) {
  ...
  if (schema.definitions != null) {
    result.definitions = Object.fromEntries(
      Object.entries(schema.definitions).map(([name19, definition]) => [
        name19,
  ...
  if (schemaWithDefs.$defs != null) {
    ...
    resultWithDefs.$defs = Object.fromEntries(
      Object.entries(schemaWithDefs.$defs).map(([name19, definition]) => [
        name19,
        sanitizeDefinition(definition)
      ])
    );
  ...
  if (schema.type === "object" || schema.properties != null) {
    if (schema.properties != null) {
      result.properties = Object.fromEntries(
        Object.entries(schema.properties).map(([name19, definition]) => [
          name19,
          sanitizeDefinition(definition)
        ])
      );
...
function createCitationSource(citation, citationDocuments, generateId32) {
  ...
  return {
    ...
    title: (_a20 = citation.document_title) != null ? _a20 : documentInfo.title,
...
var AnthropicMessagesLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a20 = config.generateId) != null ? _a20 : generateId;
  }
  supportsUrl(url) {
  ...
  get supportedUrls() {
    var _a20, _b20, _c;
    return (_c = (_b20 = (_a20 = this.config).supportedUrls) == null ? void 0 : _b20.call(_a20)) != null ? _c : {};
  }
  async getArgs({
    userSuppliedBetas,
    prompt,
    ...
    var _a20, _b20, _c, _d, _e, _f, _g, _h, _i, _j, _k;
    const warnings = [];
    ...
    const supportsStructuredOutput = ((_a20 = this.config.supportsNativeStructuredOutput) != null ? _a20 : true) && modelSupportsStructuredOutput;
    const supportsStrictTools = ((_b20 = this.config.supportsStrictTools) != null ? _b20 : true) && modelSupportsStructuredOutput;
    ...
    if ((anthropicOptions == null ? void 0 : anthropicOptions.container) && anthropicOptions.container.skills && anthropicOptions.container.skills.length > 0) {
      ...
      if (!(tools == null ? void 0 : tools.some(
        (tool6) => tool6.type === "provider" && (tool6.id === "anthropic.code_execution_20250825" || tool6.id === "anthropic.code_execution_20260120")
      ))) {
        warnings.push({
          type: "other",
  ...
  async getBetasFromHeaders(requestHeaders) {
    ...
    const configBetaHeader = (_a20 = configHeaders["anthropic-beta"]) != null ? _a20 : "";
    const requestBetaHeader = (_b20 = requestHeaders == null ? void 0 : requestHeaders["anthropic-beta"]) != null ? _b20 : "";
    return new Set(
      [
  ...
  buildRequestUrl(isStreaming) {
    var _a20, _b20, _c;
    return (_c = (_b20 = (_a20 = this.config).buildRequestUrl) == null ? void 0 : _b20.call(_a20, this.config.baseURL, isStreaming)) != null ? _c : `${this.config.baseURL}/messages`;
  }
  transformRequestBody(args, betas) {
    var _a20, _b20, _c;
    return (_c = (_b20 = (_a20 = this.config).transformRequestBody) == null ? void 0 : _b20.call(_a20, args, betas)) != null ? _c : args;
  }
  extractCitationDocuments(prompt) {
    const isCitationPart = (part) => {
      ...
      const anthropic2 = (_a20 = part.providerOptions) == null ? void 0 : _a20.anthropic;
      const citationsConfig = anthropic2 == null ? void 0 : anthropic2.citations;
      return (_b20 = citationsConfig == null ? void 0 : citationsConfig.enabled) != null ? _b20 : false;
    };
    return prompt.filter((message) => message.role === "user").flatMap((message) => message.content).filter(isCitationPart).map((part) => {
      var _a20;
      const filePart = part;
      return {
        title: (_a20 = filePart.filename) != null ? _a20 : "Untitled Document",
  ...
  async doGenerate(options) {
    var _a20, _b20, _c, _d, _e, _f, _g, _h;
    const {
      args,
      warnings,
      betas,
      ...
      switch (part.type) {
        case "text": {
          if (!usesJsonResponseTool) {
            const webSearchCitations = (_a20 = part.citations) == null ? void 0 : _a20.filter(
        ...
        case "web_fetch_tool_result": {
          if (part.content.type === "web_fetch_result") {
            citationDocuments.push({
              title: (_b20 = part.content.content.title) != null ? _b20 : part.content.url,
  ...
  async doStream(options) {
    ...
    const transformedStream = response.pipeThrough(
      new TransformStream({
        ...
        transform(chunk, controller) {
          var _a24, _b24, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n;
    ...
    try {
      ...
      if (((_a20 = result.value) == null ? void 0 : _a20.type) === "raw") {
        result = await firstChunkReader.read();
      }
      if (((_b20 = result.value) == null ? void 0 : _b20.type) === "error") {
...
function hasWebTool20260209WithoutCodeExecution(tools) {
  ...
  for (const tool6 of tools) {
    if ("type" in tool6 && (tool6.type === "web_fetch_20260209" || tool6.type === "web_search_20260209")) {
      hasWebTool20260209 = true;
      continue;
    }
    if (tool6.name === "code_execution") {
...
var bash_20250124InputSchema = lazySchema(
  () => zodSchema(
    import_v416.z.object({
      command: import_v416.z.string(),
      restart: import_v416.z.boolean().optional()
    })
  )
);
...
var computer_20241022InputSchema = lazySchema(
  () => zodSchema(
    import_v417.z.object({
      ...
      coordinate: import_v417.z.array(import_v417.z.number().int()).optional(),
...
var computer_20251124InputSchema = lazySchema(
  () => zodSchema(
    import_v419.z.object({
      ...
      coordinate: import_v419.z.tuple([import_v419.z.number().int(), import_v419.z.number().int()]).optional(),
      duration: import_v419.z.number().optional(),
      region: import_v419.z.tuple([
        import_v419.z.number().int(),
        import_v419.z.number().int(),
        import_v419.z.number().int(),
        import_v419.z.number().int()
      ]).optional(),
      scroll_amount: import_v419.z.number().optional(),
      scroll_direction: import_v419.z.enum(["up", "down", "left", "right"]).optional(),
      start_coordinate: import_v419.z.tuple([import_v419.z.number().int(), import_v419.z.number().int()]).optional(),
      text: import_v419.z.string().optional()
    })
  )
);
...
var memory_20250818InputSchema = lazySchema(
  () => zodSchema(
    import_v420.z.discriminatedUnion("command", [
      import_v420.z.object({
        command: import_v420.z.literal("view"),
        path: import_v420.z.string(),
        view_range: import_v420.z.tuple([import_v420.z.number(), import_v420.z.number()]).optional()
      }),
      import_v420.z.object({
        command: import_v420.z.literal("create"),
        path: import_v420.z.string(),
        file_text: import_v420.z.string()
      }),
      import_v420.z.object({
        command: import_v420.z.literal("str_replace"),
        path: import_v420.z.string(),
        old_str: import_v420.z.string(),
        new_str: import_v420.z.string()
      }),
      import_v420.z.object({
        command: import_v420.z.literal("insert"),
        path: import_v420.z.string(),
        insert_line: import_v420.z.number(),
        insert_text: import_v420.z.string()
      }),
      import_v420.z.object({
        command: import_v420.z.literal("delete"),
        path: import_v420.z.string()
      }),
      import_v420.z.object({
        command: import_v420.z.literal("rename"),
        old_path: import_v420.z.string(),
        new_path: import_v420.z.string()
      })
    ])
  )
);
...
var textEditor_20250124InputSchema = lazySchema(
  () => zodSchema(
    import_v422.z.object({
      command: import_v422.z.enum(["view", "create", "str_replace", "insert", "undo_edit"]),
...
var textEditor_20250429InputSchema = lazySchema(
  () => zodSchema(
    import_v423.z.object({
      command: import_v423.z.enum(["view", "create", "str_replace", "insert"]),
      path: import_v423.z.string(),
      file_text: import_v423.z.string().optional(),
      insert_line: import_v423.z.number().int().optional(),
      new_str: import_v423.z.string().optional(),
      insert_text: import_v423.z.string().optional(),
      old_str: import_v423.z.string().optional(),
      view_range: import_v423.z.array(import_v423.z.number().int()).optional()
    })
  )
);
  ...
  () => zodSchema(
    import_v424.z.array(
      import_v424.z.object({
        type: import_v424.z.literal("tool_reference"),
        toolName: import_v424.z.string()
      })
    )
  )
);
var toolSearchBm25_20251119InputSchema = lazySchema(
  () => zodSchema(
    import_v424.z.object({
       ...
       */
      query: import_v424.z.string(),
      /**
       * Maximum number of tools to return. Optional.
       */
      limit: import_v424.z.number().optional()
    })
  )
);
...
function createAnthropic(options = {}) {
  var _a20, _b20;
  const baseURL = (_a20 = normalizeBaseURL(
    loadOptionalSetting({
      settingValue: options.baseURL,
      environmentVariableName: "ANTHROPIC_BASE_URL"
    })
  )) != null ? _a20 : ANTHROPIC_API_VERSIONED_URL;
  const providerName = (_b20 = options.name) != null ? _b20 : "anthropic.messages";
...
function isBunNetworkError2(error) {
  if (!(error instanceof Error)) {
    return false;
  }
  const code = error.code;
...
var VERSION3 = true ? "4.0.26" : "0.0.0-test";
...
function parseArrayDef2(def, refs) {
  ...
  if (((_a24 = def.type) == null ? void 0 : _a24._def) && ((_c = (_b24 = def.type) == null ? void 0 : _b24._def) == null ? void 0 : _c.typeName) !== import_v35.ZodFirstPartyTypeKind.ZodAny) {
...
function parseRecordDef2(def, refs) {
  ...
  if (((_b24 = def.keyType) == null ? void 0 : _b24._def.typeName) === import_v36.ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
    const { type, ...keyType } = parseStringDef2(def.keyType._def, refs);
    return {
      ...schema,
      propertyNames: keyType
    };
  } else if (((_d = def.keyType) == null ? void 0 : _d._def.typeName) === import_v36.ZodFirstPartyTypeKind.ZodEnum) {
    return {
      ...schema,
      propertyNames: {
        enum: def.keyType._def.values
  ...
  } else if (((_e = def.keyType) == null ? void 0 : _e._def.typeName) === import_v36.ZodFirstPartyTypeKind.ZodBranded && def.keyType._def.type._def.typeName === import_v36.ZodFirstPartyTypeKind.ZodString && ((_f = def.keyType._def.type._def.checks) == null ? void 0 : _f.length)) {
...
var selectParser2 = (def, typeName, refs) => {
  switch (typeName) {
    case import_v34.ZodFirstPartyTypeKind.ZodString:
      return parseStringDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodNumber:
      return parseNumberDef2(def);
    case import_v34.ZodFirstPartyTypeKind.ZodObject:
      return parseObjectDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodBigInt:
      return parseBigintDef2(def);
    case import_v34.ZodFirstPartyTypeKind.ZodBoolean:
      return parseBooleanDef2();
    case import_v34.ZodFirstPartyTypeKind.ZodDate:
      return parseDateDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodUndefined:
      return parseUndefinedDef2();
    case import_v34.ZodFirstPartyTypeKind.ZodNull:
      return parseNullDef2();
    case import_v34.ZodFirstPartyTypeKind.ZodArray:
      return parseArrayDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodUnion:
    case import_v34.ZodFirstPartyTypeKind.ZodDiscriminatedUnion:
      return parseUnionDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodIntersection:
      return parseIntersectionDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodTuple:
      return parseTupleDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodRecord:
      return parseRecordDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodLiteral:
      return parseLiteralDef2(def);
    case import_v34.ZodFirstPartyTypeKind.ZodEnum:
      return parseEnumDef2(def);
    case import_v34.ZodFirstPartyTypeKind.ZodNativeEnum:
      return parseNativeEnumDef2(def);
    case import_v34.ZodFirstPartyTypeKind.ZodNullable:
      return parseNullableDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodOptional:
      return parseOptionalDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodMap:
      return parseMapDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodSet:
      return parseSetDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodLazy:
      return () => def.getter()._def;
    case import_v34.ZodFirstPartyTypeKind.ZodPromise:
      return parsePromiseDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodNaN:
    case import_v34.ZodFirstPartyTypeKind.ZodNever:
      return parseNeverDef2();
    case import_v34.ZodFirstPartyTypeKind.ZodEffects:
      return parseEffectsDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodAny:
      return parseAnyDef2();
    case import_v34.ZodFirstPartyTypeKind.ZodUnknown:
      return parseUnknownDef2();
    case import_v34.ZodFirstPartyTypeKind.ZodDefault:
      return parseDefaultDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodBranded:
      return parseBrandedDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodReadonly:
      return parseReadonlyDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodCatch:
      return parseCatchDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodPipeline:
      return parsePipelineDef2(def, refs);
    case import_v34.ZodFirstPartyTypeKind.ZodFunction:
    case import_v34.ZodFirstPartyTypeKind.ZodVoid:
    case import_v34.ZodFirstPartyTypeKind.ZodSymbol:
      return void 0;
    default:
      return /* @__PURE__ */ ((_) => void 0)(typeName);
  }
...
function zod4Schema2(zodSchema22, options) {
  ...
  return jsonSchema2(
    ...
    {
      validate: async (value) => {
        const result = await z43.safeParseAsync(zodSchema22, value);
        return result.success ? { success: true, value: result.data } : { success: false, error: result.error };
      }
    }
  );
...
var VERSION4 = true ? "3.0.67" : "0.0.0-test";
var googleErrorDataSchema = lazySchema2(
  () => zodSchema2(
    import_v426.z.object({
      error: import_v426.z.object({
        code: import_v426.z.number().nullable(),
        message: import_v426.z.string(),
        status: import_v426.z.string()
      })
    })
  )
);
...
var googleEmbeddingContentPartSchema = import_v427.z.union([
  import_v427.z.object({ text: import_v427.z.string() }),
  import_v427.z.object({
    inlineData: import_v427.z.object({
      mimeType: import_v427.z.string(),
      data: import_v427.z.string()
    })
  })
]);
var googleEmbeddingModelOptions = lazySchema2(
  () => zodSchema2(
    import_v427.z.object({
       ...
       */
      outputDimensionality: import_v427.z.number().optional(),
      /**
       ...
       */
      content: import_v427.z.array(import_v427.z.array(googleEmbeddingContentPartSchema).min(1).nullable()).optional()
    })
  )
);
...
var googleGenerativeAITextEmbeddingResponseSchema = lazySchema2(
  () => zodSchema2(
    import_v425.z.object({
      embeddings: import_v425.z.array(import_v425.z.object({ values: import_v425.z.array(import_v425.z.number()) }))
    })
  )
);
var googleGenerativeAISingleEmbeddingResponseSchema = lazySchema2(
  () => zodSchema2(
    import_v425.z.object({
      embedding: import_v425.z.object({ values: import_v425.z.array(import_v425.z.number()) })
    })
  )
);
function convertGoogleGenerativeAIUsage(usage) {
  ...
  const promptTokens = (_a20 = usage.promptTokenCount) != null ? _a20 : 0;
  const candidatesTokens = (_b20 = usage.candidatesTokenCount) != null ? _b20 : 0;
...
function convertJSONSchemaToOpenAPISchema(jsonSchema4, isRoot = true) {
  if (jsonSchema4 == null) {
    return void 0;
  }
...
function convertToGoogleGenerativeAIMessages(prompt, options) {
  ...
  const providerOptionsName = (_b20 = options == null ? void 0 : options.providerOptionsName) != null ? _b20 : "google";
      ...
      case "assistant": {
        ...
        contents.push({
          ...
          parts: content.map((part) => {
            var _a24, _b24, _c2, _d2;
            const providerOpts = (_d2 = (_a24 = part.providerOptions) == null ? void 0 : _a24[providerOptionsName]) != null ? _d2 : providerOptionsName !== "google" ? (_b24 = part.providerOptions) == null ? void 0 : _b24.google : (_c2 = part.providerOptions) == null ? void 0 : _c2.vertex;
...
var googleLanguageModelOptions = lazySchema2(
  () => zodSchema2(
    import_v429.z.object({
      responseModalities: import_v429.z.array(import_v429.z.enum(["TEXT", "IMAGE"])).optional(),
      thinkingConfig: import_v429.z.object({
        thinkingBudget: import_v429.z.number().optional(),
        includeThoughts: import_v429.z.boolean().optional(),
        // https://ai.google.dev/gemini-api/docs/gemini-3?thinking=high#thinking_level
        thinkingLevel: import_v429.z.enum(["minimal", "low", "medium", "high"]).optional()
      }).optional(),
      /**
       * Optional.
       ...
       */
      cachedContent: import_v429.z.string().optional(),
      /**
       ...
       */
      structuredOutputs: import_v429.z.boolean().optional(),
      /**
       * Optional. A list of unique safety settings for blocking unsafe content.
       */
      safetySettings: import_v429.z.array(
        import_v429.z.object({
          category: import_v429.z.enum([
       ...
       */
      audioTimestamp: import_v429.z.boolean().optional(),
      /**
       * Optional. Defines labels used in billing reports. Available on Vertex AI only.
       *
       * https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/add-labels-to-api-calls
       */
      labels: import_v429.z.record(import_v429.z.string(), import_v429.z.string()).optional(),
      /**
       * Optional. If specified, the media resolution specified will be used.
       *
       * https://ai.google.dev/api/generate-content#MediaResolution
       */
      mediaResolution: import_v429.z.enum([
       ...
       */
      imageConfig: import_v429.z.object({
        aspectRatio: import_v429.z.enum([
          "1:1",
          "2:3",
          "3:2",
          "3:4",
        ...
        imageSize: import_v429.z.enum(["1K", "2K", "4K", "512"]).optional()
      }).optional(),
      /**
       ...
       */
      retrievalConfig: import_v429.z.object({
        latLng: import_v429.z.object({
          latitude: import_v429.z.number(),
          longitude: import_v429.z.number()
        }).optional()
      }).optional(),
      /**
       ...
       */
      streamFunctionCallArguments: import_v429.z.boolean().optional(),
      /**
       * Optional. The service tier to use for the request.
       */
      serviceTier: import_v429.z.enum(["standard", "flex", "priority"]).optional()
    })
  )
);
...
function prepareTools2({
  ...
  const hasFunctionTools = tools.some((tool6) => tool6.type === "function");
  const hasProviderTools = tools.some((tool6) => tool6.type === "provider");
  ...
  if (hasProviderTools) {
    const googleTools2 = [];
    const ProviderTools = tools.filter((tool6) => tool6.type === "provider");
    ProviderTools.forEach((tool6) => {
      switch (tool6.id) {
        case "google.google_search":
          if (isGemini2orNewer) {
            googleTools2.push({ googleSearch: { ...tool6.args } });
          } else {
            toolWarnings.push({
              type: "unsupported",
              feature: `provider-defined tool ${tool6.id}`,
        ...
        case "google.file_search":
          if (supportsFileSearch) {
            googleTools2.push({ fileSearch: { ...tool6.args } });
          } else {
            toolWarnings.push({
              type: "unsupported",
              feature: `provider-defined tool ${tool6.id}`,
          ...
          if (isGemini2orNewer) {
            googleTools2.push({
              retrieval: {
                vertex_rag_store: {
                  rag_resources: {
                    rag_corpus: tool6.args.ragCorpus
                  },
                  similarity_top_k: tool6.args.topK
                }
              }
            });
          } else {
    ...
    if (hasFunctionTools && isGemini3orNewer && googleTools2.length > 0) {
      ...
      for (const tool6 of tools) {
        if (tool6.type === "function") {
          functionDeclarations2.push({
            name: tool6.name,
            description: (_a20 = tool6.description) != null ? _a20 : "",
            parameters: convertJSONSchemaToOpenAPISchema(tool6.inputSchema)
          });
        }
      }
    ...
    switch (tool6.type) {
      case "function":
        functionDeclarations.push({
          name: tool6.name,
          description: (_b20 = tool6.description) != null ? _b20 : "",
          parameters: convertJSONSchemaToOpenAPISchema(tool6.inputSchema)
        });
        if (tool6.strict === true) {
          hasStrictTools = true;
        }
        break;
      default:
        toolWarnings.push({
          type: "unsupported",
          feature: `function tool ${tool6.name}`
        });
        break;
    }
  }
...
function resolvePartialArgValue(arg) {
  var _a20, _b20;
  const value = (_b20 = (_a20 = arg.stringValue) != null ? _a20 : arg.numberValue) != null ? _b20 : arg.boolValue;
...
var GoogleGenerativeAILanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a20 = config.generateId) != null ? _a20 : generateId2;
  }
  get provider() {
    return this.config.provider;
  }
  ...
  async getArgs({
    ...
    if ((tools == null ? void 0 : tools.some(
      (tool6) => tool6.type === "provider" && tool6.id === "google.vertex_rag_store"
    )) && !isVertexProvider) {
      warnings.push({
        type: "other",
    ...
    const streamFunctionCallArguments = isStreaming && isVertexProvider ? (_a20 = googleOptions == null ? void 0 : googleOptions.streamFunctionCallArguments) != null ? _a20 : false : void 0;
    ...
    return {
      args: {
        generationConfig: {
          ...
          ((_b20 = googleOptions == null ? void 0 : googleOptions.structuredOutputs) != null ? _b20 : true) ? convertJSONSchemaToOpenAPISchema(responseFormat.schema) : void 0,
  ...
  async doGenerate(options) {
    var _a20, _b20, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
    ...
    const content = [];
    const parts = (_b20 = (_a20 = candidate.content) == null ? void 0 : _a20.parts) != null ? _b20 : [];
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a20, _b20, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            const candidate = (_a20 = value.candidates) == null ? void 0 : _a20[0];
            if (candidate == null) {
              return;
            }
            ...
            if (content != null) {
              const parts = (_b20 = content.parts) != null ? _b20 : [];
              for (const part of parts) {
                if ("executableCode" in part && ((_c = part.executableCode) == null ? void 0 : _c.code)) {
                  ...
                  const toolCallId = (_e = part.toolCall.id) != null ? _e : generateId32();
                  lastServerToolCallId = toolCallId;
                  const serverMeta = {
                    [providerOptionsName]: {
                  ...
                  const responseToolCallId = (_g = lastServerToolCallId != null ? lastServerToolCallId : part.toolResponse.id) != null ? _g : generateId32();
                  const serverMeta = {
                    [providerOptionsName]: {
                      ...part.thoughtSignature ? { thoughtSignature: part.thoughtSignature } : {},
                      serverToolCallId: responseToolCallId,
  ...
  for (const chunk of groundingMetadata.groundingChunks) {
    if (chunk.web != null) {
      ...
      sources.push({
        ...
        title: (_b20 = chunk.image.title) != null ? _b20 : void 0
      });
...
var getGroundingMetadataSchema = () => import_v428.z.object({
  webSearchQueries: import_v428.z.array(import_v428.z.string()).nullish(),
  imageSearchQueries: import_v428.z.array(import_v428.z.string()).nullish(),
  retrievalQueries: import_v428.z.array(import_v428.z.string()).nullish(),
  searchEntryPoint: import_v428.z.object({ renderedContent: import_v428.z.string() }).nullish(),
  groundingChunks: import_v428.z.array(
    import_v428.z.object({
      web: import_v428.z.object({ uri: import_v428.z.string(), title: import_v428.z.string().nullish() }).nullish(),
      image: import_v428.z.object({
        sourceUri: import_v428.z.string(),
        imageUri: import_v428.z.string(),
        title: import_v428.z.string().nullish(),
        domain: import_v428.z.string().nullish()
      }).nullish(),
      retrievedContext: import_v428.z.object({
        uri: import_v428.z.string().nullish(),
        title: import_v428.z.string().nullish(),
        text: import_v428.z.string().nullish(),
        fileSearchStore: import_v428.z.string().nullish()
      }).nullish(),
      maps: import_v428.z.object({
        uri: import_v428.z.string().nullish(),
        title: import_v428.z.string().nullish(),
        text: import_v428.z.string().nullish(),
        placeId: import_v428.z.string().nullish()
      }).nullish()
    })
  ).nullish(),
  groundingSupports: import_v428.z.array(
    import_v428.z.object({
      segment: import_v428.z.object({
        startIndex: import_v428.z.number().nullish(),
        endIndex: import_v428.z.number().nullish(),
        text: import_v428.z.string().nullish()
      }).nullish(),
      segment_text: import_v428.z.string().nullish(),
      groundingChunkIndices: import_v428.z.array(import_v428.z.number()).nullish(),
      supportChunkIndices: import_v428.z.array(import_v428.z.number()).nullish(),
      confidenceScores: import_v428.z.array(import_v428.z.number()).nullish(),
      confidenceScore: import_v428.z.array(import_v428.z.number()).nullish()
    })
  ).nullish(),
  retrievalMetadata: import_v428.z.union([
    import_v428.z.object({
      webDynamicRetrievalScore: import_v428.z.number()
    }),
    import_v428.z.object({})
  ]).nullish()
});
var partialArgSchema = import_v428.z.object({
  jsonPath: import_v428.z.string(),
  stringValue: import_v428.z.string().nullish(),
  numberValue: import_v428.z.number().nullish(),
  boolValue: import_v428.z.boolean().nullish(),
  nullValue: import_v428.z.unknown().nullish(),
  willContinue: import_v428.z.boolean().nullish()
});
var getContentSchema = () => import_v428.z.object({
  parts: import_v428.z.array(
    import_v428.z.union([
      // note: order matters since text can be fully empty
      import_v428.z.object({
        functionCall: import_v428.z.object({
          name: import_v428.z.string().nullish(),
          args: import_v428.z.unknown().nullish(),
          partialArgs: import_v428.z.array(partialArgSchema).nullish(),
          willContinue: import_v428.z.boolean().nullish()
        }),
        thoughtSignature: import_v428.z.string().nullish()
      }),
      import_v428.z.object({
        inlineData: import_v428.z.object({
          mimeType: import_v428.z.string(),
          data: import_v428.z.string()
        }),
        thought: import_v428.z.boolean().nullish(),
        thoughtSignature: import_v428.z.string().nullish()
      }),
      import_v428.z.object({
        toolCall: import_v428.z.object({
          toolType: import_v428.z.string(),
          args: import_v428.z.unknown().nullish(),
      ...
      import_v428.z.object({
        toolResponse: import_v428.z.object({
          toolType: import_v428.z.string(),
          response: import_v428.z.unknown().nullish(),
          id: import_v428.z.string()
        }),
        thoughtSignature: import_v428.z.string().nullish()
      }),
      import_v428.z.object({
        executableCode: import_v428.z.object({
          language: import_v428.z.string(),
          code: import_v428.z.string()
        }).nullish(),
        codeExecutionResult: import_v428.z.object({
          outcome: import_v428.z.string(),
          output: import_v428.z.string().nullish()
        }).nullish(),
        text: import_v428.z.string().nullish(),
        thought: import_v428.z.boolean().nullish(),
        thoughtSignature: import_v428.z.string().nullish()
...
var getSafetyRatingSchema = () => import_v428.z.object({
  category: import_v428.z.string().nullish(),
  probability: import_v428.z.string().nullish(),
  probabilityScore: import_v428.z.number().nullish(),
  severity: import_v428.z.string().nullish(),
  severityScore: import_v428.z.number().nullish(),
  blocked: import_v428.z.boolean().nullish()
});
var tokenDetailsSchema = import_v428.z.array(
  import_v428.z.object({
    modality: import_v428.z.string(),
    tokenCount: import_v428.z.number()
  })
).nullish();
var usageSchema = import_v428.z.object({
  cachedContentTokenCount: import_v428.z.number().nullish(),
  thoughtsTokenCount: import_v428.z.number().nullish(),
  promptTokenCount: import_v428.z.number().nullish(),
  candidatesTokenCount: import_v428.z.number().nullish(),
  totalTokenCount: import_v428.z.number().nullish(),
  // https://cloud.google.com/vertex-ai/generative-ai/docs/reference/rest/v1/GenerateContentResponse#TrafficType
  trafficType: import_v428.z.string().nullish(),
  // https://ai.google.dev/api/generate-content#Modality
  promptTokensDetails: tokenDetailsSchema,
  candidatesTokensDetails: tokenDetailsSchema
});
var getUrlContextMetadataSchema = () => import_v428.z.object({
  urlMetadata: import_v428.z.array(
    import_v428.z.object({
      retrievedUrl: import_v428.z.string(),
      urlRetrievalStatus: import_v428.z.string()
    })
  ).nullish()
});
var responseSchema = lazySchema2(
  () => zodSchema2(
    import_v428.z.object({
      candidates: import_v428.z.array(
        import_v428.z.object({
          content: getContentSchema().nullish().or(import_v428.z.object({}).strict()),
          finishReason: import_v428.z.string().nullish(),
          finishMessage: import_v428.z.string().nullish(),
          safetyRatings: import_v428.z.array(getSafetyRatingSchema()).nullish(),
          groundingMetadata: getGroundingMetadataSchema().nullish(),
          urlContextMetadata: getUrlContextMetadataSchema().nullish()
        })
      ),
      usageMetadata: usageSchema.nullish(),
      promptFeedback: import_v428.z.object({
        blockReason: import_v428.z.string().nullish(),
        safetyRatings: import_v428.z.array(getSafetyRatingSchema()).nullish()
      }).nullish(),
      serviceTier: import_v428.z.string().nullish()
    })
  )
);
...
var codeExecution = createProviderToolFactoryWithOutputSchema2({
  id: "google.code_execution",
  inputSchema: import_v430.z.object({
    language: import_v430.z.string().describe("The programming language of the code."),
    code: import_v430.z.string().describe("The code to be executed.")
  }),
  outputSchema: import_v430.z.object({
    outcome: import_v430.z.string().describe('The outcome of the execution (e.g., "OUTCOME_OK").'),
    output: import_v430.z.string().describe("The output from the code execution.")
  })
});
var enterpriseWebSearch = createProviderToolFactory2({
  id: "google.enterprise_web_search",
  inputSchema: lazySchema2(() => zodSchema2(import_v431.z.object({})))
});
var fileSearchArgsBaseSchema = import_v432.z.object({
  /** The names of the file_search_stores to retrieve from.
   *  Example: `fileSearchStores/my-file-search-store-123`
   */
  fileSearchStoreNames: import_v432.z.array(import_v432.z.string()).describe(
    "The names of the file_search_stores to retrieve from. Example: `fileSearchStores/my-file-search-store-123`"
  ),
  /** The number of file search retrieval chunks to retrieve. */
  topK: import_v432.z.number().int().positive().describe("The number of file search retrieval chunks to retrieve.").optional(),
  /** Metadata filter to apply to the file search retrieval documents.
   *  See https://google.aip.dev/160 for the syntax of the filter expression.
   */
  metadataFilter: import_v432.z.string().describe(
...
var googleMaps = createProviderToolFactory2({
  ...
  inputSchema: lazySchema2(() => zodSchema2(import_v433.z.object({})))
});
var googleSearchToolArgsBaseSchema = import_v434.z.object({
  searchTypes: import_v434.z.object({
    webSearch: import_v434.z.object({}).optional(),
    imageSearch: import_v434.z.object({}).optional()
  }).optional(),
  timeRangeFilter: import_v434.z.object({
    startTime: import_v434.z.string(),
    endTime: import_v434.z.string()
  }).optional()
}).passthrough();
...
var urlContext = createProviderToolFactory2({
  id: "google.url_context",
  inputSchema: lazySchema2(() => zodSchema2(import_v435.z.object({})))
});
var vertexRagStore = createProviderToolFactory2({
  id: "google.vertex_rag_store",
  inputSchema: import_v436.z.object({
    ragCorpus: import_v436.z.string(),
    topK: import_v436.z.number().optional()
  })
});
var googleTools = {
  /**
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerateImagen(options) {
    ...
    const currentDate = (_c = (_b20 = (_a20 = this.config._internal) == null ? void 0 : _a20.currentDate) == null ? void 0 : _b20.call(_a20)) != null ? _c : /* @__PURE__ */ new Date();
    const parameters = {
      sampleCount: n
    };
    if (aspectRatio != null) {
  ...
  async doGenerateGemini(options) {
    var _a20, _b20, _c, _d, _e, _f, _g, _h, _i;
    const {
      prompt,
      n,
      size,
    ...
    const languageModel = new GoogleGenerativeAILanguageModel(this.modelId, {
      ...
      headers: (_a20 = this.config.headers) != null ? _a20 : {},
      fetch: this.config.fetch,
      generateId: (_b20 = this.config.generateId) != null ? _b20 : generateId2
    });
...
var googleImageResponseSchema = lazySchema2(
  () => zodSchema2(
    import_v437.z.object({
      predictions: import_v437.z.array(import_v437.z.object({ bytesBase64Encoded: import_v437.z.string() })).default([])
    })
  )
);
var googleImageModelOptionsSchema = lazySchema2(
  () => zodSchema2(
    import_v437.z.object({
      personGeneration: import_v437.z.enum(["dont_allow", "allow_adult", "allow_all"]).nullish(),
      aspectRatio: import_v437.z.enum(["1:1", "3:4", "4:3", "9:16", "16:9"]).nullish()
    })
  )
);
...
var googleOperationSchema = import_v438.z.object({
  name: import_v438.z.string().nullish(),
  done: import_v438.z.boolean().nullish(),
  error: import_v438.z.object({
    code: import_v438.z.number().nullish(),
    message: import_v438.z.string(),
    status: import_v438.z.string().nullish()
  }).nullish(),
  response: import_v438.z.object({
    generateVideoResponse: import_v438.z.object({
      generatedSamples: import_v438.z.array(
        import_v438.z.object({
          video: import_v438.z.object({
            uri: import_v438.z.string().nullish()
          }).nullish()
        })
      ).nullish()
    }).nullish()
...
var googleVideoModelOptionsSchema = lazySchema2(
  () => zodSchema2(
    import_v438.z.object({
      pollIntervalMs: import_v438.z.number().positive().nullish(),
      pollTimeoutMs: import_v438.z.number().positive().nullish(),
      personGeneration: import_v438.z.enum(["dont_allow", "allow_adult", "allow_all"]).nullish(),
      negativePrompt: import_v438.z.string().nullish(),
      referenceImages: import_v438.z.array(
        import_v438.z.object({
          bytesBase64Encoded: import_v438.z.string().nullish(),
          gcsUri: import_v438.z.string().nullish()
        })
      ).nullish()
    }).passthrough()
  )
...
function createGoogleGenerativeAI(options = {}) {
  var _a20, _b20;
  const baseURL = (_a20 = withoutTrailingSlash2(options.baseURL)) != null ? _a20 : "https://generativelanguage.googleapis.com/v1beta";
  const providerName = (_b20 = options.name) != null ? _b20 : "google.generative-ai";
...
var _a18;
var _b18;
var AISDKError3 = class _AISDKError3 extends (_b18 = Error, _a18 = symbol18, _b18) {
  /**
   * Creates an AI SDK Error.
   *
   * @param {Object} params - The parameters for creating the error.
   ...
   */
  static isInstance(error) {
    return _AISDKError3.hasMarker(error, marker18);
  }
  static hasMarker(error, marker152) {
    const markerSymbol = Symbol.for(marker152);
    return error != null && typeof error === "object" && markerSymbol in error && typeof error[markerSymbol] === "boolean" && error[markerSymbol] === true;
...
Error message: ${getErrorMessage3(cause)}`,
  ...
  static wrap({
    ...
    var _a152, _b152, _c;
    if (_TypeValidationError3.isInstance(cause) && cause.value === value && ((_a152 = cause.context) == null ? void 0 : _a152.field) === (context == null ? void 0 : context.field) && ((_b152 = cause.context) == null ? void 0 : _b152.entityName) === (context == null ? void 0 : context.entityName) && ((_c = cause.context) == null ? void 0 : _c.entityId) === (context == null ? void 0 : context.entityId)) {
      return cause;
    }
    return new _TypeValidationError3({ value, cause, context });
  }
};
...
var _a19;
var _b19;
var DownloadError3 = class extends (_b19 = AISDKError3, _a19 = symbol19, _b19) {
  constructor({
    url,
    statusCode,
    statusText,
  ...
  static isInstance(error) {
    return AISDKError3.hasMarker(error, marker19);
  }
};
...
async function downloadBlob(url, options) {
  ...
  try {
    ...
    const data = await readResponseWithSizeLimit2({
      response,
      url,
      maxBytes: (_a24 = options == null ? void 0 : options.maxBytes) != null ? _a24 : DEFAULT_MAX_DOWNLOAD_SIZE3
    });
    const contentType = (_b24 = response.headers.get("content-type")) != null ? _b24 : void 0;
    return new Blob([data], contentType ? { type: contentType } : void 0);
  } catch (error) {
    if (DownloadError3.isInstance(error)) {
      throw error;
    }
    throw new DownloadError3({ url, cause: error });
  }
}
...
function isBunNetworkError3(error) {
  if (!(error instanceof Error)) {
    return false;
  }
  const code = error.code;
...
var VERSION5 = true ? "4.0.26" : "0.0.0-test";
...
function parseArrayDef3(def, refs) {
  ...
  if (((_a24 = def.type) == null ? void 0 : _a24._def) && ((_c = (_b24 = def.type) == null ? void 0 : _b24._def) == null ? void 0 : _c.typeName) !== import_v38.ZodFirstPartyTypeKind.ZodAny) {
...
function parseRecordDef3(def, refs) {
  ...
  const schema = {
    type: "object",
    additionalProperties: (_a24 = parseDef3(def.valueType._def, {
      ...refs,
      currentPath: [...refs.currentPath, "additionalProperties"]
    })) != null ? _a24 : refs.allowedAdditionalProperties
  };
  if (((_b24 = def.keyType) == null ? void 0 : _b24._def.typeName) === import_v39.ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
    const { type, ...keyType } = parseStringDef3(def.keyType._def, refs);
    return {
      ...schema,
      propertyNames: keyType
    };
  } else if (((_d = def.keyType) == null ? void 0 : _d._def.typeName) === import_v39.ZodFirstPartyTypeKind.ZodEnum) {
    return {
      ...schema,
      propertyNames: {
        enum: def.keyType._def.values
  ...
  } else if (((_e = def.keyType) == null ? void 0 : _e._def.typeName) === import_v39.ZodFirstPartyTypeKind.ZodBranded && def.keyType._def.type._def.typeName === import_v39.ZodFirstPartyTypeKind.ZodString && ((_f = def.keyType._def.type._def.checks) == null ? void 0 : _f.length)) {
...
var selectParser3 = (def, typeName, refs) => {
  switch (typeName) {
    case import_v37.ZodFirstPartyTypeKind.ZodString:
      return parseStringDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodNumber:
      return parseNumberDef3(def);
    case import_v37.ZodFirstPartyTypeKind.ZodObject:
      return parseObjectDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodBigInt:
      return parseBigintDef3(def);
    case import_v37.ZodFirstPartyTypeKind.ZodBoolean:
      return parseBooleanDef3();
    case import_v37.ZodFirstPartyTypeKind.ZodDate:
      return parseDateDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodUndefined:
      return parseUndefinedDef3();
    case import_v37.ZodFirstPartyTypeKind.ZodNull:
      return parseNullDef3();
    case import_v37.ZodFirstPartyTypeKind.ZodArray:
      return parseArrayDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodUnion:
    case import_v37.ZodFirstPartyTypeKind.ZodDiscriminatedUnion:
      return parseUnionDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodIntersection:
      return parseIntersectionDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodTuple:
      return parseTupleDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodRecord:
      return parseRecordDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodLiteral:
      return parseLiteralDef3(def);
    case import_v37.ZodFirstPartyTypeKind.ZodEnum:
      return parseEnumDef3(def);
    case import_v37.ZodFirstPartyTypeKind.ZodNativeEnum:
      return parseNativeEnumDef3(def);
    case import_v37.ZodFirstPartyTypeKind.ZodNullable:
      return parseNullableDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodOptional:
      return parseOptionalDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodMap:
      return parseMapDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodSet:
      return parseSetDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodLazy:
      return () => def.getter()._def;
    case import_v37.ZodFirstPartyTypeKind.ZodPromise:
      return parsePromiseDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodNaN:
    case import_v37.ZodFirstPartyTypeKind.ZodNever:
      return parseNeverDef3();
    case import_v37.ZodFirstPartyTypeKind.ZodEffects:
      return parseEffectsDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodAny:
      return parseAnyDef3();
    case import_v37.ZodFirstPartyTypeKind.ZodUnknown:
      return parseUnknownDef3();
    case import_v37.ZodFirstPartyTypeKind.ZodDefault:
      return parseDefaultDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodBranded:
      return parseBrandedDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodReadonly:
      return parseReadonlyDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodCatch:
      return parseCatchDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodPipeline:
      return parsePipelineDef3(def, refs);
    case import_v37.ZodFirstPartyTypeKind.ZodFunction:
    case import_v37.ZodFirstPartyTypeKind.ZodVoid:
    case import_v37.ZodFirstPartyTypeKind.ZodSymbol:
      return void 0;
    default:
      return /* @__PURE__ */ ((_) => void 0)(typeName);
  }
...
var zod3ToJsonSchema3 = (schema, options) => {
  var _a24;
    ...
    (acc, [name34, schema2]) => {
      ...
      return {
        ...
        [name34]: (_a34 = parseDef3(
          ...
          true
        )) != null ? _a34 : parseAnyDef3()
      };
    },
    {}
  ) : void 0;
  const name24 = typeof options === "string" ? options : (options == null ? void 0 : options.nameStrategy) === "title" ? void 0 : options == null ? void 0 : options.name;
  const main = (_a24 = parseDef3(
    schema._def,
    name24 === void 0 ? refs : {
      ...refs,
      currentPath: [...refs.basePath, refs.definitionPath, name24]
...
function asSchema3(schema) {
  return schema == null ? jsonSchema3({ properties: {}, additionalProperties: false }) : isSchema3(schema) ? schema : "~standard" in schema ? schema["~standard"].vendor === "zod" ? zodSchema3(schema) : standardSchema3(schema) : schema();
}
...
function zod4Schema3(zodSchema22, options) {
  ...
  return jsonSchema3(
    ...
    {
      validate: async (value) => {
        const result = await z45.safeParseAsync(zodSchema22, value);
        return result.success ? { success: true, value: result.data } : { success: false, error: result.error };
      }
    }
  );
...
async function validateTypes3({
  ...
  const result = await safeValidateTypes3({ value, schema, context });
  if (!result.success) {
    throw TypeValidationError3.wrap({ value, cause: result.error, context });
  }
  return result.value;
}
async function safeValidateTypes3({
  ...
  try {
    ...
    return {
      success: false,
      error: TypeValidationError3.wrap({ value, cause: result.error, context }),
      rawValue: value
    };
  } catch (error) {
    return {
      success: false,
      error: TypeValidationError3.wrap({ value, cause: error, context }),
      rawValue: value
    };
  }
}
...
var createJsonResponseHandler3 = (responseSchema2) => async ({ response, url, requestBodyValues }) => {
  const responseBody = await response.text();
...
var openaiErrorDataSchema = import_v439.z.object({
  error: import_v439.z.object({
    message: import_v439.z.string(),
    // The additional information below is handled loosely to support
    // OpenAI-compatible providers that have slightly different error
    // responses:
    type: import_v439.z.string().nullish(),
    param: import_v439.z.any().nullish(),
    code: import_v439.z.union([import_v439.z.string(), import_v439.z.number()]).nullish()
  })
});
var openaiFailedResponseHandler = createJsonErrorResponseHandler3({
...
function convertOpenAIChatUsage(usage) {
  ...
  const promptTokens = (_a20 = usage.prompt_tokens) != null ? _a20 : 0;
  const completionTokens = (_b20 = usage.completion_tokens) != null ? _b20 : 0;
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    image_url: {
                      ...
                      detail: (_b20 = (_a24 = part.providerOptions) == null ? void 0 : _a24.openai) == null ? void 0 : _b20.imageDetail
                    }
                  };
        ...
        for (const toolResponse of content) {
          ...
          switch (output.type) {
            ...
            case "error-text":
              ...
              break;
            case "execution-denied":
              contentValue = (_a20 = output.reason) != null ? _a20 : "Tool execution denied.";
              break;
            case "content":
            case "json":
            case "error-json":
...
var openaiChatResponseSchema = lazySchema3(
  () => zodSchema3(
    import_v440.z.object({
      id: import_v440.z.string().nullish(),
      created: import_v440.z.number().nullish(),
      model: import_v440.z.string().nullish(),
      choices: import_v440.z.array(
        import_v440.z.object({
          message: import_v440.z.object({
            role: import_v440.z.literal("assistant").nullish(),
            content: import_v440.z.string().nullish(),
            tool_calls: import_v440.z.array(
              import_v440.z.object({
                id: import_v440.z.string().nullish(),
                type: import_v440.z.literal("function"),
                function: import_v440.z.object({
                  name: import_v440.z.string(),
                  arguments: import_v440.z.string()
                })
              })
            ).nullish(),
            annotations: import_v440.z.array(
              import_v440.z.object({
                type: import_v440.z.literal("url_citation"),
                url_citation: import_v440.z.object({
                  start_index: import_v440.z.number(),
                  end_index: import_v440.z.number(),
                  url: import_v440.z.string(),
                  title: import_v440.z.string()
                })
              })
            ).nullish()
          }),
          index: import_v440.z.number(),
          logprobs: import_v440.z.object({
            content: import_v440.z.array(
              import_v440.z.object({
                token: import_v440.z.string(),
                logprob: import_v440.z.number(),
                top_logprobs: import_v440.z.array(
                  import_v440.z.object({
                    token: import_v440.z.string(),
                    logprob: import_v440.z.number()
                  })
          ...
          finish_reason: import_v440.z.string().nullish()
        })
      ),
      usage: import_v440.z.object({
        prompt_tokens: import_v440.z.number().nullish(),
        completion_tokens: import_v440.z.number().nullish(),
        total_tokens: import_v440.z.number().nullish(),
        prompt_tokens_details: import_v440.z.object({
          cached_tokens: import_v440.z.number().nullish()
        }).nullish(),
        completion_tokens_details: import_v440.z.object({
          reasoning_tokens: import_v440.z.number().nullish(),
          accepted_prediction_tokens: import_v440.z.number().nullish(),
          rejected_prediction_tokens: import_v440.z.number().nullish()
        }).nullish()
      }).nullish()
    })
  )
);
var openaiChatChunkSchema = lazySchema3(
  () => zodSchema3(
    import_v440.z.union([
      import_v440.z.object({
        id: import_v440.z.string().nullish(),
        ...
        choices: import_v440.z.array(
          import_v440.z.object({
            delta: import_v440.z.object({
              role: import_v440.z.enum(["assistant"]).nullish(),
              content: import_v440.z.string().nullish(),
              tool_calls: import_v440.z.array(
                import_v440.z.object({
                  index: import_v440.z.number(),
                  id: import_v440.z.string().nullish(),
                  type: import_v440.z.literal("function").nullish(),
                  function: import_v440.z.object({
                    name: import_v440.z.string().nullish(),
                    arguments: import_v440.z.string().nullish()
                  })
                })
              ).nullish(),
              annotations: import_v440.z.array(
...
var openaiLanguageModelChatOptions = lazySchema3(
  () => zodSchema3(
    import_v441.z.object({
       ...
       */
      logitBias: import_v441.z.record(import_v441.z.coerce.number(), import_v441.z.number()).optional(),
      /**
       ...
       */
      logprobs: import_v441.z.union([import_v441.z.boolean(), import_v441.z.number()]).optional(),
      /**
       * Whether to enable parallel function calling during tool use. Default to true.
       */
      parallelToolCalls: import_v441.z.boolean().optional(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse.
       */
      user: import_v441.z.string().optional(),
      /**
       * Reasoning effort for reasoning models. Defaults to `medium`.
       */
      reasoningEffort: import_v441.z.enum(["none", "minimal", "low", "medium", "high", "xhigh"]).optional(),
      /**
       * Maximum number of completion tokens to generate. Useful for reasoning models.
       */
      maxCompletionTokens: import_v441.z.number().optional(),
      /**
       * Whether to enable persistence in responses API.
       */
      store: import_v441.z.boolean().optional(),
      /**
       * Metadata to associate with the request.
       */
      metadata: import_v441.z.record(import_v441.z.string().max(64), import_v441.z.string().max(512)).optional(),
      /**
       * Parameters for prediction mode.
       */
      prediction: import_v441.z.record(import_v441.z.string(), import_v441.z.any()).optional(),
      /**
       ...
       * @default 'auto'
       */
      serviceTier: import_v441.z.enum(["auto", "flex", "priority", "default"]).optional(),
      /**
       * Whether to use strict JSON schema validation.
       *
       * @default true
       */
      strictJsonSchema: import_v441.z.boolean().optional(),
      /**
       * Controls the verbosity of the model's responses.
       * Lower values will result in more concise responses, while higher values will result in more verbose responses.
       */
      textVerbosity: import_v441.z.enum(["low", "medium", "high"]).optional(),
      /**
       * A cache key for prompt caching. Allows manual control over prompt caching behavior.
       * Useful for improving cache hit rates and working around automatic caching issues.
       */
      promptCacheKey: import_v441.z.string().optional(),
      /**
       ...
       * @default 'in_memory'
       */
      promptCacheRetention: import_v441.z.enum(["in_memory", "24h"]).optional(),
      /**
       ...
       * information.
       */
      safetyIdentifier: import_v441.z.string().optional(),
      /**
       ...
       */
      systemMessageMode: import_v441.z.enum(["system", "developer", "remove"]).optional(),
      /**
       ...
       */
      forceReasoning: import_v441.z.boolean().optional()
    })
  )
);
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a20, _b20, _c, _d, _e;
    const warnings = [];
    const openaiOptions = (_a20 = await parseProviderOptions3({
      provider: "openai",
      providerOptions,
      schema: openaiLanguageModelChatOptions
    })) != null ? _a20 : {};
    const modelCapabilities = getOpenAILanguageModelCapabilities(this.modelId);
    const isReasoningModel = (_b20 = openaiOptions.forceReasoning) != null ? _b20 : modelCapabilities.isReasoningModel;
    if (topK != null) {
  ...
  async doGenerate(options) {
    ...
    for (const toolCall of (_a20 = choice.message.tool_calls) != null ? _a20 : []) {
      content.push({
        type: "tool-call",
        toolCallId: (_b20 = toolCall.id) != null ? _b20 : generateId3(),
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a20, _b20, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            if (value.usage != null) {
              usage = value.usage;
              if (((_a20 = value.usage.completion_tokens_details) == null ? void 0 : _a20.accepted_prediction_tokens) != null) {
                providerMetadata.openai.acceptedPredictionTokens = (_b20 = value.usage.completion_tokens_details) == null ? void 0 : _b20.accepted_prediction_tokens;
              }
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_h = toolCall2.function) == null ? void 0 : _h.name) != null && ((_i = toolCall2.function) == null ? void 0 : _i.arguments) != null) {
                    ...
                    if (isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_j = toolCall2.id) != null ? _j : generateId3(),
                ...
                if (((_o = toolCall.function) == null ? void 0 : _o.name) != null && ((_p = toolCall.function) == null ? void 0 : _p.arguments) != null && isParsableJson(toolCall.function.arguments)) {
                  ...
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_q = toolCall.id) != null ? _q : generateId3(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
...
var openaiCompletionResponseSchema = lazySchema3(
  () => zodSchema3(
    import_v442.z.object({
      id: import_v442.z.string().nullish(),
      created: import_v442.z.number().nullish(),
      model: import_v442.z.string().nullish(),
      choices: import_v442.z.array(
        import_v442.z.object({
          text: import_v442.z.string(),
          finish_reason: import_v442.z.string(),
          logprobs: import_v442.z.object({
            tokens: import_v442.z.array(import_v442.z.string()),
            token_logprobs: import_v442.z.array(import_v442.z.number()),
            top_logprobs: import_v442.z.array(import_v442.z.record(import_v442.z.string(), import_v442.z.number())).nullish()
          }).nullish()
        })
      ),
      usage: import_v442.z.object({
        prompt_tokens: import_v442.z.number(),
        completion_tokens: import_v442.z.number(),
        total_tokens: import_v442.z.number()
      }).nullish()
    })
  )
);
    ...
    import_v442.z.union([
      import_v442.z.object({
        ...
        choices: import_v442.z.array(
          import_v442.z.object({
            text: import_v442.z.string(),
            finish_reason: import_v442.z.string().nullish(),
            index: import_v442.z.number(),
            logprobs: import_v442.z.object({
              tokens: import_v442.z.array(import_v442.z.string()),
              token_logprobs: import_v442.z.array(import_v442.z.number()),
              top_logprobs: import_v442.z.array(import_v442.z.record(import_v442.z.string(), import_v442.z.number())).nullish()
...
var openaiLanguageModelCompletionOptions = lazySchema3(
  () => zodSchema3(
    import_v443.z.object({
       ...
       */
      echo: import_v443.z.boolean().optional(),
      /**
       * Modify the likelihood of specified tokens appearing in the completion.
       *
       * Accepts a JSON object that maps tokens (specified by their token ID in
       ...
       */
      logitBias: import_v443.z.record(import_v443.z.string(), import_v443.z.number()).optional(),
      /**
       * The suffix that comes after a completion of inserted text.
       */
      suffix: import_v443.z.string().optional(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse. Learn more.
       */
      user: import_v443.z.string().optional(),
      /**
       ...
       * tokens that were generated.
       */
      logprobs: import_v443.z.union([import_v443.z.boolean(), import_v443.z.number()]).optional()
    })
  )
);
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      finishReason: {
        ...
        raw: (_a20 = choice.finish_reason) != null ? _a20 : void 0
      },
      request: { body: args },
      response: {
...
var openaiEmbeddingModelOptions = lazySchema3(
  () => zodSchema3(
    import_v444.z.object({
       ...
       */
      dimensions: import_v444.z.number().optional(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse. Learn more.
       */
      user: import_v444.z.string().optional()
    })
  )
);
var openaiTextEmbeddingResponseSchema = lazySchema3(
  () => zodSchema3(
    import_v445.z.object({
      data: import_v445.z.array(import_v445.z.object({ embedding: import_v445.z.array(import_v445.z.number()) })),
      usage: import_v445.z.object({ prompt_tokens: import_v445.z.number() }).nullish()
    })
  )
);
...
var openaiImageResponseSchema = lazySchema3(
  () => zodSchema3(
    import_v446.z.object({
      created: import_v446.z.number().nullish(),
      data: import_v446.z.array(
        import_v446.z.object({
          b64_json: import_v446.z.string(),
          revised_prompt: import_v446.z.string().nullish()
        })
      ),
      background: import_v446.z.string().nullish(),
      output_format: import_v446.z.string().nullish(),
      size: import_v446.z.string().nullish(),
      quality: import_v446.z.string().nullish(),
      usage: import_v446.z.object({
        input_tokens: import_v446.z.number().nullish(),
        output_tokens: import_v446.z.number().nullish(),
        total_tokens: import_v446.z.number().nullish(),
        input_tokens_details: import_v446.z.object({
          image_tokens: import_v446.z.number().nullish(),
          text_tokens: import_v446.z.number().nullish()
        }).nullish()
      }).nullish()
    })
  )
...
var baseImageModelOptionsObject = import_v447.z.object({
  /**
   * Quality of the generated image(s).
   *
   * Valid values: `standard`, `hd`, `low`, `medium`, `high`, `auto`.
   */
  quality: import_v447.z.enum(["standard", "hd", "low", "medium", "high", "auto"]).optional(),
  /**
   ...
   * (i.e. `png` or `webp`).
   */
  background: import_v447.z.enum(["transparent", "opaque", "auto"]).optional(),
  /**
   * Format in which the generated image(s) are returned.
   */
  outputFormat: import_v447.z.enum(["png", "jpeg", "webp"]).optional(),
  /**
   * Compression level (0-100) for the generated image(s). Applies to the
   * `jpeg` and `webp` output formats.
   */
  outputCompression: import_v447.z.number().int().min(0).max(100).optional(),
  /**
...
var openaiImageModelOptions = lazySchema3(
  () => zodSchema3(baseImageModelOptionsObject)
);
var openaiImageModelGenerationOptions = lazySchema3(
  () => zodSchema3(
    baseImageModelOptionsObject.extend({
       ...
       * looking images.
       */
      style: import_v447.z.enum(["vivid", "natural"]).optional(),
      /**
       * Content moderation level for the generated image(s). `low` applies
       * less restrictive filtering.
       */
      moderation: import_v447.z.enum(["auto", "low"]).optional()
    })
  )
);
var openaiImageModelEditOptions = lazySchema3(
  () => zodSchema3(
    baseImageModelOptionsObject.extend({
      /**
       * Fidelity of the output image(s) to the input image(s).
       */
      inputFidelity: import_v447.z.enum(["high", "low"]).optional()
    })
  )
);
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const currentDate = (_c = (_b20 = (_a20 = this.config._internal) == null ? void 0 : _a20.currentDate) == null ? void 0 : _b20.call(_a20)) != null ? _c : /* @__PURE__ */ new Date();
    if (files != null) {
      const openaiOptions2 = (_d = await parseProviderOptions3({
        provider: "openai",
        providerOptions,
    ...
    const openaiOptions = (_h = await parseProviderOptions3({
      provider: "openai",
      providerOptions,
...
var applyPatchInputSchema = lazySchema3(
  () => zodSchema3(
    import_v448.z.object({
      callId: import_v448.z.string(),
      operation: import_v448.z.discriminatedUnion("type", [
        import_v448.z.object({
          type: import_v448.z.literal("create_file"),
          path: import_v448.z.string(),
          diff: import_v448.z.string()
        }),
        import_v448.z.object({
          type: import_v448.z.literal("delete_file"),
          path: import_v448.z.string()
        }),
        import_v448.z.object({
          type: import_v448.z.literal("update_file"),
          path: import_v448.z.string(),
          diff: import_v448.z.string()
        })
      ])
...
var applyPatchOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v448.z.object({
      status: import_v448.z.enum(["completed", "failed"]),
      output: import_v448.z.string().optional()
    })
  )
);
var applyPatchArgsSchema = lazySchema3(() => zodSchema3(import_v448.z.object({})));
var applyPatchToolFactory = createProviderToolFactoryWithOutputSchema3({
  id: "openai.apply_patch",
  inputSchema: applyPatchInputSchema,
  outputSchema: applyPatchOutputSchema
});
var applyPatch = applyPatchToolFactory;
var codeInterpreterInputSchema = lazySchema3(
  () => zodSchema3(
    import_v449.z.object({
      code: import_v449.z.string().nullish(),
      containerId: import_v449.z.string()
    })
  )
);
var codeInterpreterOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v449.z.object({
      outputs: import_v449.z.array(
        import_v449.z.discriminatedUnion("type", [
          import_v449.z.object({ type: import_v449.z.literal("logs"), logs: import_v449.z.string() }),
          import_v449.z.object({ type: import_v449.z.literal("image"), url: import_v449.z.string() })
        ])
      ).nullish()
    })
  )
);
var codeInterpreterArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v449.z.object({
      container: import_v449.z.union([
        import_v449.z.string(),
        import_v449.z.object({
          fileIds: import_v449.z.array(import_v449.z.string()).optional()
        })
      ]).optional()
    })
  )
...
var customArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v450.z.object({
      name: import_v450.z.string(),
      description: import_v450.z.string().optional(),
      format: import_v450.z.union([
        import_v450.z.object({
          type: import_v450.z.literal("grammar"),
          syntax: import_v450.z.enum(["regex", "lark"]),
          definition: import_v450.z.string()
        }),
        import_v450.z.object({
          type: import_v450.z.literal("text")
        })
      ]).optional()
    })
  )
);
var customInputSchema = lazySchema3(() => zodSchema3(import_v450.z.string()));
var customToolFactory = createProviderToolFactory3({
  id: "openai.custom",
  inputSchema: customInputSchema
});
var customTool = (args) => customToolFactory(args);
var comparisonFilterSchema = import_v451.z.object({
  key: import_v451.z.string(),
  type: import_v451.z.enum(["eq", "ne", "gt", "gte", "lt", "lte", "in", "nin"]),
  value: import_v451.z.union([import_v451.z.string(), import_v451.z.number(), import_v451.z.boolean(), import_v451.z.array(import_v451.z.string())])
});
var compoundFilterSchema = import_v451.z.object({
  type: import_v451.z.enum(["and", "or"]),
  filters: import_v451.z.array(
    import_v451.z.union([comparisonFilterSchema, import_v451.z.lazy(() => compoundFilterSchema)])
  )
});
var fileSearchArgsSchema2 = lazySchema3(
  () => zodSchema3(
    import_v451.z.object({
      vectorStoreIds: import_v451.z.array(import_v451.z.string()),
      maxNumResults: import_v451.z.number().optional(),
      ranking: import_v451.z.object({
        ranker: import_v451.z.string().optional(),
        scoreThreshold: import_v451.z.number().optional()
      }).optional(),
      filters: import_v451.z.union([comparisonFilterSchema, compoundFilterSchema]).optional()
    })
  )
);
var fileSearchOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v451.z.object({
      queries: import_v451.z.array(import_v451.z.string()),
      results: import_v451.z.array(
        import_v451.z.object({
          attributes: import_v451.z.record(import_v451.z.string(), import_v451.z.unknown()),
          fileId: import_v451.z.string(),
          filename: import_v451.z.string(),
          score: import_v451.z.number(),
          text: import_v451.z.string()
        })
      ).nullable()
    })
  )
);
var fileSearch2 = createProviderToolFactoryWithOutputSchema3({
  id: "openai.file_search",
  inputSchema: import_v451.z.object({}),
  outputSchema: fileSearchOutputSchema
});
var imageGenerationArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v452.z.object({
      background: import_v452.z.enum(["auto", "opaque", "transparent"]).optional(),
      inputFidelity: import_v452.z.enum(["low", "high"]).optional(),
      inputImageMask: import_v452.z.object({
        fileId: import_v452.z.string().optional(),
        imageUrl: import_v452.z.string().optional()
      }).optional(),
      model: import_v452.z.string().optional(),
      moderation: import_v452.z.enum(["auto"]).optional(),
      outputCompression: import_v452.z.number().int().min(0).max(100).optional(),
      outputFormat: import_v452.z.enum(["png", "jpeg", "webp"]).optional(),
      partialImages: import_v452.z.number().int().min(0).max(3).optional(),
      quality: import_v452.z.enum(["auto", "low", "medium", "high"]).optional(),
      size: import_v452.z.enum(["1024x1024", "1024x1536", "1536x1024", "auto"]).optional()
    }).strict()
  )
);
var imageGenerationInputSchema = lazySchema3(() => zodSchema3(import_v452.z.object({})));
var imageGenerationOutputSchema = lazySchema3(
  () => zodSchema3(import_v452.z.object({ result: import_v452.z.string() }))
);
...
var localShellInputSchema = lazySchema3(
  () => zodSchema3(
    import_v453.z.object({
      action: import_v453.z.object({
        type: import_v453.z.literal("exec"),
        command: import_v453.z.array(import_v453.z.string()),
        timeoutMs: import_v453.z.number().optional(),
        user: import_v453.z.string().optional(),
        workingDirectory: import_v453.z.string().optional(),
        env: import_v453.z.record(import_v453.z.string(), import_v453.z.string()).optional()
      })
    })
  )
);
var localShellOutputSchema = lazySchema3(
  () => zodSchema3(import_v453.z.object({ output: import_v453.z.string() }))
);
var localShell = createProviderToolFactoryWithOutputSchema3({
  id: "openai.local_shell",
  inputSchema: localShellInputSchema,
  outputSchema: localShellOutputSchema
});
var shellInputSchema = lazySchema3(
  () => zodSchema3(
    import_v454.z.object({
      action: import_v454.z.object({
        commands: import_v454.z.array(import_v454.z.string()),
        timeoutMs: import_v454.z.number().optional(),
        maxOutputLength: import_v454.z.number().optional()
      })
    })
  )
);
var shellOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v454.z.object({
      output: import_v454.z.array(
        import_v454.z.object({
          stdout: import_v454.z.string(),
          stderr: import_v454.z.string(),
          outcome: import_v454.z.discriminatedUnion("type", [
            import_v454.z.object({ type: import_v454.z.literal("timeout") }),
            import_v454.z.object({ type: import_v454.z.literal("exit"), exitCode: import_v454.z.number() })
          ])
        })
      )
    })
...
var shellSkillsSchema = import_v454.z.array(
  import_v454.z.discriminatedUnion("type", [
    import_v454.z.object({
      type: import_v454.z.literal("skillReference"),
      skillId: import_v454.z.string(),
      version: import_v454.z.string().optional()
    }),
    import_v454.z.object({
      type: import_v454.z.literal("inline"),
      name: import_v454.z.string(),
      description: import_v454.z.string(),
      source: import_v454.z.object({
        type: import_v454.z.literal("base64"),
        mediaType: import_v454.z.literal("application/zip"),
        data: import_v454.z.string()
      })
    })
  ])
).optional();
var shellArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v454.z.object({
      environment: import_v454.z.union([
        import_v454.z.object({
          type: import_v454.z.literal("containerAuto"),
          fileIds: import_v454.z.array(import_v454.z.string()).optional(),
          memoryLimit: import_v454.z.enum(["1g", "4g", "16g", "64g"]).optional(),
          networkPolicy: import_v454.z.discriminatedUnion("type", [
            import_v454.z.object({ type: import_v454.z.literal("disabled") }),
            import_v454.z.object({
              type: import_v454.z.literal("allowlist"),
              allowedDomains: import_v454.z.array(import_v454.z.string()),
              domainSecrets: import_v454.z.array(
                import_v454.z.object({
                  domain: import_v454.z.string(),
                  name: import_v454.z.string(),
                  value: import_v454.z.string()
                })
              ).optional()
            })
          ]).optional(),
        ...
        import_v454.z.object({
          type: import_v454.z.literal("containerReference"),
          containerId: import_v454.z.string()
        }),
        import_v454.z.object({
          type: import_v454.z.literal("local").optional(),
          skills: import_v454.z.array(
            import_v454.z.object({
              name: import_v454.z.string(),
              description: import_v454.z.string(),
              path: import_v454.z.string()
            })
          ).optional()
        })
      ]).optional()
...
var toolSearchArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v455.z.object({
      execution: import_v455.z.enum(["server", "client"]).optional(),
      description: import_v455.z.string().optional(),
      parameters: import_v455.z.record(import_v455.z.string(), import_v455.z.unknown()).optional()
    })
  )
);
var toolSearchInputSchema = lazySchema3(
  () => zodSchema3(
    import_v455.z.object({
      arguments: import_v455.z.unknown().optional(),
      call_id: import_v455.z.string().nullish()
    })
  )
);
var toolSearchOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v455.z.object({
      tools: import_v455.z.array(import_v455.z.record(import_v455.z.string(), import_v455.z.unknown()))
    })
  )
);
var toolSearchToolFactory = createProviderToolFactoryWithOutputSchema3({
...
var webSearchArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v456.z.object({
      externalWebAccess: import_v456.z.boolean().optional(),
      filters: import_v456.z.object({ allowedDomains: import_v456.z.array(import_v456.z.string()).optional() }).optional(),
      searchContextSize: import_v456.z.enum(["low", "medium", "high"]).optional(),
      userLocation: import_v456.z.object({
        type: import_v456.z.literal("approximate"),
        country: import_v456.z.string().optional(),
        city: import_v456.z.string().optional(),
        region: import_v456.z.string().optional(),
        timezone: import_v456.z.string().optional()
      }).optional()
    })
  )
);
var webSearchInputSchema = lazySchema3(() => zodSchema3(import_v456.z.object({})));
var webSearchOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v456.z.object({
      action: import_v456.z.discriminatedUnion("type", [
        import_v456.z.object({
          type: import_v456.z.literal("search"),
          query: import_v456.z.string().optional()
        }),
        import_v456.z.object({
          type: import_v456.z.literal("openPage"),
          url: import_v456.z.string().nullish()
        }),
        import_v456.z.object({
          type: import_v456.z.literal("findInPage"),
          url: import_v456.z.string().nullish(),
          pattern: import_v456.z.string().nullish()
        })
      ]).optional(),
      sources: import_v456.z.array(
        import_v456.z.discriminatedUnion("type", [
          import_v456.z.object({ type: import_v456.z.literal("url"), url: import_v456.z.string() }),
          import_v456.z.object({ type: import_v456.z.literal("api"), name: import_v456.z.string() })
        ])
      ).optional()
    })
  )
...
var webSearchPreviewArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v457.z.object({
      searchContextSize: import_v457.z.enum(["low", "medium", "high"]).optional(),
      userLocation: import_v457.z.object({
        type: import_v457.z.literal("approximate"),
        country: import_v457.z.string().optional(),
        city: import_v457.z.string().optional(),
        region: import_v457.z.string().optional(),
        timezone: import_v457.z.string().optional()
      }).optional()
    })
  )
);
var webSearchPreviewInputSchema = lazySchema3(
  () => zodSchema3(import_v457.z.object({}))
);
var webSearchPreviewOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v457.z.object({
      action: import_v457.z.discriminatedUnion("type", [
        import_v457.z.object({
          type: import_v457.z.literal("search"),
          query: import_v457.z.string().optional()
        }),
        import_v457.z.object({
          type: import_v457.z.literal("openPage"),
          url: import_v457.z.string().nullish()
        }),
        import_v457.z.object({
          type: import_v457.z.literal("findInPage"),
          url: import_v457.z.string().nullish(),
          pattern: import_v457.z.string().nullish()
        })
      ]).optional()
    })
  )
);
var webSearchPreview = createProviderToolFactoryWithOutputSchema3({
  id: "openai.web_search_preview",
  inputSchema: webSearchPreviewInputSchema,
  outputSchema: webSearchPreviewOutputSchema
});
var jsonValueSchema = import_v458.z.lazy(
  () => import_v458.z.union([
    import_v458.z.string(),
    import_v458.z.number(),
    import_v458.z.boolean(),
    import_v458.z.null(),
    import_v458.z.array(jsonValueSchema),
    import_v458.z.record(import_v458.z.string(), jsonValueSchema)
  ])
);
var mcpArgsSchema = lazySchema3(
  () => zodSchema3(
    import_v458.z.object({
      serverLabel: import_v458.z.string(),
      allowedTools: import_v458.z.union([
        import_v458.z.array(import_v458.z.string()),
        import_v458.z.object({
          readOnly: import_v458.z.boolean().optional(),
          toolNames: import_v458.z.array(import_v458.z.string()).optional()
        })
      ]).optional(),
      authorization: import_v458.z.string().optional(),
      connectorId: import_v458.z.string().optional(),
      headers: import_v458.z.record(import_v458.z.string(), import_v458.z.string()).optional(),
      requireApproval: import_v458.z.union([
        import_v458.z.enum(["always", "never"]),
        import_v458.z.object({
          never: import_v458.z.object({
            toolNames: import_v458.z.array(import_v458.z.string()).optional()
          }).optional()
        })
      ]).optional(),
      serverDescription: import_v458.z.string().optional(),
      serverUrl: import_v458.z.string().optional()
    }).refine(
...
var mcpInputSchema = lazySchema3(() => zodSchema3(import_v458.z.object({})));
var mcpOutputSchema = lazySchema3(
  () => zodSchema3(
    import_v458.z.object({
      type: import_v458.z.literal("call"),
      serverLabel: import_v458.z.string(),
      name: import_v458.z.string(),
      arguments: import_v458.z.string(),
      output: import_v458.z.string().nullish(),
      error: import_v458.z.union([import_v458.z.string(), jsonValueSchema]).optional()
    })
  )
);
var mcpToolFactory = createProviderToolFactoryWithOutputSchema3({
  id: "openai.mcp",
...
function convertOpenAIResponsesUsage(usage) {
  ...
  const cachedTokens = (_b20 = (_a20 = usage.input_tokens_details) == null ? void 0 : _a20.cached_tokens) != null ? _b20 : 0;
    ...
    switch (role) {
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    ...part.data instanceof URL ? { image_url: part.data.toString() } : typeof part.data === "string" && isFileId(part.data, fileIdPrefixes) ? { file_id: part.data } : {
                      image_url: `data:${mediaType};base64,${convertToBase643(part.data)}`
                    },
                    detail: (_b24 = (_a24 = part.providerOptions) == null ? void 0 : _a24[providerOptionsName]) == null ? void 0 : _b24.imageDetail
                  };
                } else if (part.mediaType === "application/pdf") {
                  if (part.data instanceof URL) {
                    return {
      ...
      case "assistant": {
        ...
        for (const part of content) {
          switch (part.type) {
            case "text": {
              const providerOpts = (_a20 = part.providerOptions) == null ? void 0 : _a20[providerOptionsName];
            ...
            case "tool-call": {
              const id = (_f = (_c = (_b20 = part.providerOptions) == null ? void 0 : _b20[providerOptionsName]) == null ? void 0 : _c.itemId) != null ? _f : (_e = (_d = part.providerMetadata) == null ? void 0 : _d[providerOptionsName]) == null ? void 0 : _e.itemId;
              if (hasConversation && id != null) {
                break;
              }
              ...
              if (resolvedToolName === "tool_search") {
                ...
                const parsedInput = typeof part.input === "string" ? await parseJSON3({
                  text: part.input,
              ...
              if (hasLocalShellTool && resolvedToolName === "local_shell") {
                const parsedInput = await validateTypes3({
                  value: part.input,
            ...
            case "tool-result": {
              ...
              if (resolvedResultToolName === "tool_search") {
                ...
                if (store) {
                  ...
                  const parsedOutput = await validateTypes3({
            ...
            case "reasoning": {
              const providerOptions = await parseProviderOptions3({
                provider: providerOptionsName,
                providerOptions: part.providerOptions,
                  ...
                  switch (item.type) {
                    ...
                    case "image-data":
                      return {
                        ...
                        detail: (_b24 = (_a24 = item.providerOptions) == null ? void 0 : _a24[providerOptionsName]) == null ? void 0 : _b24.imageDetail
                      };
                    case "image-url":
                      return {
                        type: "input_image",
...
var openaiResponsesReasoningProviderOptionsSchema = import_v459.z.object({
  itemId: import_v459.z.string().nullish(),
  reasoningEncryptedContent: import_v459.z.string().nullish()
});
...
var jsonValueSchema2 = import_v460.z.lazy(
  () => import_v460.z.union([
    import_v460.z.string(),
    import_v460.z.number(),
    import_v460.z.boolean(),
    import_v460.z.null(),
    import_v460.z.array(jsonValueSchema2),
    import_v460.z.record(import_v460.z.string(), jsonValueSchema2.optional())
  ])
);
var openaiResponsesChunkSchema = lazySchema3(
  () => zodSchema3(
    import_v460.z.union([
      import_v460.z.object({
        type: import_v460.z.literal("response.output_text.delta"),
        item_id: import_v460.z.string(),
        delta: import_v460.z.string(),
        logprobs: import_v460.z.array(
          import_v460.z.object({
            token: import_v460.z.string(),
            logprob: import_v460.z.number(),
            top_logprobs: import_v460.z.array(
              import_v460.z.object({
                token: import_v460.z.string(),
                logprob: import_v460.z.number()
              })
      ...
      import_v460.z.object({
        type: import_v460.z.enum(["response.completed", "response.incomplete"]),
        response: import_v460.z.object({
          incomplete_details: import_v460.z.object({ reason: import_v460.z.string() }).nullish(),
          usage: import_v460.z.object({
            input_tokens: import_v460.z.number(),
            input_tokens_details: import_v460.z.object({ cached_tokens: import_v460.z.number().nullish() }).nullish(),
            output_tokens: import_v460.z.number(),
            output_tokens_details: import_v460.z.object({ reasoning_tokens: import_v460.z.number().nullish() }).nullish()
          }),
          service_tier: import_v460.z.string().nullish()
        })
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.failed"),
        response: import_v460.z.object({
          error: import_v460.z.object({
            code: import_v460.z.string().nullish(),
      ...
      import_v460.z.object({
        type: import_v460.z.literal("response.created"),
        response: import_v460.z.object({
          id: import_v460.z.string(),
          created_at: import_v460.z.number(),
          model: import_v460.z.string(),
          service_tier: import_v460.z.string().nullish()
        })
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.output_item.added"),
        output_index: import_v460.z.number(),
        item: import_v460.z.discriminatedUnion("type", [
          import_v460.z.object({
            type: import_v460.z.literal("message"),
            id: import_v460.z.string(),
            phase: import_v460.z.enum(["commentary", "final_answer"]).nullish()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("reasoning"),
            id: import_v460.z.string(),
            encrypted_content: import_v460.z.string().nullish()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("function_call"),
            id: import_v460.z.string(),
            call_id: import_v460.z.string(),
            name: import_v460.z.string(),
            arguments: import_v460.z.string(),
            namespace: import_v460.z.string().nullish()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("web_search_call"),
            id: import_v460.z.string(),
            status: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("computer_call"),
            id: import_v460.z.string(),
            status: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("file_search_call"),
            id: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("image_generation_call"),
            id: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("code_interpreter_call"),
            id: import_v460.z.string(),
            container_id: import_v460.z.string(),
            code: import_v460.z.string().nullable(),
            outputs: import_v460.z.array(
              import_v460.z.discriminatedUnion("type", [
                import_v460.z.object({ type: import_v460.z.literal("logs"), logs: import_v460.z.string() }),
                import_v460.z.object({ type: import_v460.z.literal("image"), url: import_v460.z.string() })
              ])
            ).nullable(),
            status: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("mcp_call"),
            id: import_v460.z.string(),
            status: import_v460.z.string(),
            approval_request_id: import_v460.z.string().nullish()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("mcp_list_tools"),
            id: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("mcp_approval_request"),
            id: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("apply_patch_call"),
            id: import_v460.z.string(),
            call_id: import_v460.z.string(),
            status: import_v460.z.enum(["in_progress", "completed"]),
            operation: import_v460.z.discriminatedUnion("type", [
              import_v460.z.object({
                type: import_v460.z.literal("create_file"),
                path: import_v460.z.string(),
                diff: import_v460.z.string()
              }),
              import_v460.z.object({
                type: import_v460.z.literal("delete_file"),
                path: import_v460.z.string()
              }),
              import_v460.z.object({
                type: import_v460.z.literal("update_file"),
                path: import_v460.z.string(),
                diff: import_v460.z.string()
              })
            ])
          ...
          import_v460.z.object({
            type: import_v460.z.literal("custom_tool_call"),
            id: import_v460.z.string(),
            call_id: import_v460.z.string(),
            name: import_v460.z.string(),
            input: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("shell_call"),
            id: import_v460.z.string(),
            call_id: import_v460.z.string(),
            status: import_v460.z.enum(["in_progress", "completed", "incomplete"]),
            action: import_v460.z.object({
              commands: import_v460.z.array(import_v460.z.string())
            })
          }),
          import_v460.z.object({
            type: import_v460.z.literal("shell_call_output"),
            id: import_v460.z.string(),
            call_id: import_v460.z.string(),
            status: import_v460.z.enum(["in_progress", "completed", "incomplete"]),
            output: import_v460.z.array(
              import_v460.z.object({
                stdout: import_v460.z.string(),
                stderr: import_v460.z.string(),
                outcome: import_v460.z.discriminatedUnion("type", [
                  import_v460.z.object({ type: import_v460.z.literal("timeout") }),
                  import_v460.z.object({
                    type: import_v460.z.literal("exit"),
                    exit_code: import_v460.z.number()
                  })
                ])
              })
            )
          ...
          import_v460.z.object({
            type: import_v460.z.literal("tool_search_call"),
            id: import_v460.z.string(),
            execution: import_v460.z.enum(["server", "client"]),
            call_id: import_v460.z.string().nullable(),
            status: import_v460.z.enum(["in_progress", "completed", "incomplete"]),
            arguments: import_v460.z.unknown()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("tool_search_output"),
            id: import_v460.z.string(),
            execution: import_v460.z.enum(["server", "client"]),
            call_id: import_v460.z.string().nullable(),
            status: import_v460.z.enum(["in_progress", "completed", "incomplete"]),
            tools: import_v460.z.array(import_v460.z.record(import_v460.z.string(), jsonValueSchema2.optional()))
          })
        ])
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.output_item.done"),
        output_index: import_v460.z.number(),
        item: import_v460.z.discriminatedUnion("type", [
          import_v460.z.object({
            type: import_v460.z.literal("message"),
          ...
          import_v460.z.object({
            ...
            name: import_v460.z.string(),
            arguments: import_v460.z.string(),
            status: import_v460.z.literal("completed"),
            namespace: import_v460.z.string().nullish()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("custom_tool_call"),
          ...
          import_v460.z.object({
            type: import_v460.z.literal("image_generation_call"),
            id: import_v460.z.string(),
            result: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("web_search_call"),
            id: import_v460.z.string(),
            status: import_v460.z.string(),
            action: import_v460.z.discriminatedUnion("type", [
              import_v460.z.object({
                type: import_v460.z.literal("search"),
                query: import_v460.z.string().nullish(),
                sources: import_v460.z.array(
                  import_v460.z.discriminatedUnion("type", [
                    import_v460.z.object({ type: import_v460.z.literal("url"), url: import_v460.z.string() }),
                    import_v460.z.object({ type: import_v460.z.literal("api"), name: import_v460.z.string() })
                  ])
                ).nullish()
              }),
              import_v460.z.object({
                type: import_v460.z.literal("open_page"),
                url: import_v460.z.string().nullish()
              }),
              import_v460.z.object({
                type: import_v460.z.literal("find_in_page"),
                url: import_v460.z.string().nullish(),
                pattern: import_v460.z.string().nullish()
              })
            ]).nullish()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("file_search_call"),
            id: import_v460.z.string(),
            queries: import_v460.z.array(import_v460.z.string()),
            results: import_v460.z.array(
              import_v460.z.object({
                attributes: import_v460.z.record(
                  import_v460.z.string(),
                  import_v460.z.union([import_v460.z.string(), import_v460.z.number(), import_v460.z.boolean()])
                ),
                file_id: import_v460.z.string(),
                filename: import_v460.z.string(),
                score: import_v460.z.number(),
                text: import_v460.z.string()
              })
            ).nullish()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("local_shell_call"),
            id: import_v460.z.string(),
            call_id: import_v460.z.string(),
            action: import_v460.z.object({
              type: import_v460.z.literal("exec"),
              command: import_v460.z.array(import_v460.z.string()),
              timeout_ms: import_v460.z.number().optional(),
              user: import_v460.z.string().optional(),
              working_directory: import_v460.z.string().optional(),
              env: import_v460.z.record(import_v460.z.string(), import_v460.z.string()).optional()
            })
          }),
          import_v460.z.object({
            type: import_v460.z.literal("computer_call"),
          ...
          import_v460.z.object({
            ...
            arguments: import_v460.z.string(),
            name: import_v460.z.string(),
            server_label: import_v460.z.string(),
            output: import_v460.z.string().nullish(),
            error: import_v460.z.union([
              import_v460.z.string(),
              import_v460.z.object({
                type: import_v460.z.string().optional(),
                code: import_v460.z.union([import_v460.z.number(), import_v460.z.string()]).optional(),
                message: import_v460.z.string().optional()
              }).loose()
            ]).nullish(),
            approval_request_id: import_v460.z.string().nullish()
          }),
          import_v460.z.object({
            ...
            id: import_v460.z.string(),
            server_label: import_v460.z.string(),
            tools: import_v460.z.array(
              import_v460.z.object({
                name: import_v460.z.string(),
                description: import_v460.z.string().optional(),
                input_schema: import_v460.z.any(),
                annotations: import_v460.z.record(import_v460.z.string(), import_v460.z.unknown()).optional()
              })
            ),
            error: import_v460.z.union([
              import_v460.z.string(),
          ...
          import_v460.z.object({
            ...
            name: import_v460.z.string(),
            arguments: import_v460.z.string(),
            approval_request_id: import_v460.z.string().optional()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("apply_patch_call"),
            id: import_v460.z.string(),
      ...
      import_v460.z.object({
        type: import_v460.z.literal("response.function_call_arguments.delta"),
        item_id: import_v460.z.string(),
        output_index: import_v460.z.number(),
        delta: import_v460.z.string()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.custom_tool_call_input.delta"),
        item_id: import_v460.z.string(),
        output_index: import_v460.z.number(),
        delta: import_v460.z.string()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.image_generation_call.partial_image"),
        item_id: import_v460.z.string(),
        output_index: import_v460.z.number(),
        partial_image_b64: import_v460.z.string()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.code_interpreter_call_code.delta"),
        item_id: import_v460.z.string(),
        output_index: import_v460.z.number(),
        delta: import_v460.z.string()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.code_interpreter_call_code.done"),
        item_id: import_v460.z.string(),
        output_index: import_v460.z.number(),
        code: import_v460.z.string()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.output_text.annotation.added"),
        annotation: import_v460.z.discriminatedUnion("type", [
          import_v460.z.object({
            type: import_v460.z.literal("url_citation"),
            start_index: import_v460.z.number(),
            end_index: import_v460.z.number(),
            url: import_v460.z.string(),
            title: import_v460.z.string()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("file_citation"),
            file_id: import_v460.z.string(),
            filename: import_v460.z.string(),
            index: import_v460.z.number()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("container_file_citation"),
            container_id: import_v460.z.string(),
            file_id: import_v460.z.string(),
            filename: import_v460.z.string(),
            start_index: import_v460.z.number(),
          ...
          import_v460.z.object({
            type: import_v460.z.literal("file_path"),
            file_id: import_v460.z.string(),
            index: import_v460.z.number()
          })
        ])
      ...
      import_v460.z.object({
        type: import_v460.z.literal("response.reasoning_summary_part.added"),
        item_id: import_v460.z.string(),
        summary_index: import_v460.z.number()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.reasoning_summary_text.delta"),
        item_id: import_v460.z.string(),
        summary_index: import_v460.z.number(),
        delta: import_v460.z.string()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.reasoning_summary_part.done"),
        item_id: import_v460.z.string(),
        summary_index: import_v460.z.number()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.apply_patch_call_operation_diff.delta"),
        item_id: import_v460.z.string(),
        output_index: import_v460.z.number(),
        delta: import_v460.z.string(),
        obfuscation: import_v460.z.string().nullish()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("response.apply_patch_call_operation_diff.done"),
        item_id: import_v460.z.string(),
        output_index: import_v460.z.number(),
        diff: import_v460.z.string()
      }),
      import_v460.z.object({
        type: import_v460.z.literal("error"),
        sequence_number: import_v460.z.number(),
        error: import_v460.z.object({
          type: import_v460.z.string(),
          code: import_v460.z.string(),
          message: import_v460.z.string(),
          param: import_v460.z.string().nullish()
        })
      }),
      import_v460.z.object({ type: import_v460.z.string() }).loose().transform((value) => ({
        type: "unknown_chunk",
        message: value.type
      }))
...
var openaiResponsesResponseSchema = lazySchema3(
  () => zodSchema3(
    import_v460.z.object({
      id: import_v460.z.string().optional(),
      created_at: import_v460.z.number().optional(),
      error: import_v460.z.object({
        message: import_v460.z.string(),
        type: import_v460.z.string(),
        param: import_v460.z.string().nullish(),
      ...
      model: import_v460.z.string().optional(),
      output: import_v460.z.array(
        import_v460.z.discriminatedUnion("type", [
          import_v460.z.object({
            type: import_v460.z.literal("message"),
            role: import_v460.z.literal("assistant"),
            id: import_v460.z.string(),
            phase: import_v460.z.enum(["commentary", "final_answer"]).nullish(),
            content: import_v460.z.array(
              import_v460.z.object({
                type: import_v460.z.literal("output_text"),
                text: import_v460.z.string(),
                logprobs: import_v460.z.array(
                  import_v460.z.object({
                    token: import_v460.z.string(),
                ...
                annotations: import_v460.z.array(
                  import_v460.z.discriminatedUnion("type", [
                    import_v460.z.object({
                      type: import_v460.z.literal("url_citation"),
                      start_index: import_v460.z.number(),
              ...
              import_v460.z.object({
                ...
                sources: import_v460.z.array(
                  import_v460.z.discriminatedUnion("type", [
                    import_v460.z.object({ type: import_v460.z.literal("url"), url: import_v460.z.string() }),
                    import_v460.z.object({
                      type: import_v460.z.literal("api"),
                      name: import_v460.z.string()
                    })
                  ])
                ).nullish()
          ...
          import_v460.z.object({
            type: import_v460.z.literal("computer_call"),
            id: import_v460.z.string(),
            status: import_v460.z.string().optional()
          }),
          import_v460.z.object({
            type: import_v460.z.literal("reasoning"),
            id: import_v460.z.string(),
            encrypted_content: import_v460.z.string().nullish(),
            summary: import_v460.z.array(
              import_v460.z.object({
                type: import_v460.z.literal("summary_text"),
                text: import_v460.z.string()
              })
            )
          }),
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema3(
  () => zodSchema3(
    import_v461.z.object({
       ...
       */
      conversation: import_v461.z.string().nullish(),
      /**
       * The set of extra fields to include in the response (advanced, usually not needed).
       * Example values: 'reasoning.encrypted_content', 'file_search_call.results', 'message.output_text.logprobs'.
       */
      include: import_v461.z.array(
        import_v461.z.enum([
       ...
       * Defaults to `undefined`.
       */
      instructions: import_v461.z.string().nullish(),
      /**
       * Return the log probabilities of the tokens. Including logprobs will increase
       * the response size and can slow down response times. However, it can
       * be useful to better understand how the model is behaving.
       ...
       */
      logprobs: import_v461.z.union([import_v461.z.boolean(), import_v461.z.number().min(1).max(TOP_LOGPROBS_MAX)]).optional(),
      /**
       * The maximum number of total calls to built-in tools that can be processed in a response.
       * This maximum number applies across all built-in tool calls, not per individual tool.
       * Any further attempts to call a tool by the model will be ignored.
       */
      maxToolCalls: import_v461.z.number().nullish(),
      /**
       * Additional metadata to store with the generation.
       */
      metadata: import_v461.z.any().nullish(),
      /**
       * Whether to use parallel tool calls. Defaults to `true`.
       */
      parallelToolCalls: import_v461.z.boolean().nullish(),
      /**
       * The ID of the previous response. You can use it to continue a conversation.
       * Defaults to `undefined`.
       */
      previousResponseId: import_v461.z.string().nullish(),
      /**
       * Sets a cache key to tie this prompt to cached prefixes for better caching performance.
       */
      promptCacheKey: import_v461.z.string().nullish(),
      /**
       * The retention policy for the prompt cache.
       * - 'in_memory': Default. Standard prompt caching behavior.
       * - '24h': Extended prompt caching that keeps cached prefixes active for up to 24 hours.
       ...
       * @default 'in_memory'
       */
      promptCacheRetention: import_v461.z.enum(["in_memory", "24h"]).nullish(),
      /**
       ...
       * an error.
       */
      reasoningEffort: import_v461.z.string().nullish(),
      /**
       * Controls reasoning summary output from the model.
       * Set to "auto" to automatically receive the richest level available,
       * or "detailed" for comprehensive summaries.
       */
      reasoningSummary: import_v461.z.string().nullish(),
      /**
       * The identifier for safety monitoring and tracking.
       */
      safetyIdentifier: import_v461.z.string().nullish(),
      /**
       * Service tier for the request.
       ...
       * Defaults to 'auto'.
       */
      serviceTier: import_v461.z.enum(["auto", "flex", "priority", "default"]).nullish(),
      /**
       * Whether to store the generation. Defaults to `true`.
       */
      store: import_v461.z.boolean().nullish(),
      /**
       * Whether to use strict JSON schema validation.
       * Defaults to `true`.
       */
      strictJsonSchema: import_v461.z.boolean().nullish(),
      /**
       * Controls the verbosity of the model's responses. Lower values ('low') will result
       * in more concise responses, while higher values ('high') will result in more verbose responses.
       * Valid values: 'low', 'medium', 'high'.
       */
      textVerbosity: import_v461.z.enum(["low", "medium", "high"]).nullish(),
      /**
       * Controls output truncation. 'auto' (default) performs truncation automatically;
       * 'disabled' turns truncation off.
       */
      truncation: import_v461.z.enum(["auto", "disabled"]).nullish(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse.
       * Defaults to `undefined`.
       ...
       */
      user: import_v461.z.string().nullish(),
      /**
       * Override the system message mode for this model.
       * - 'system': Use the 'system' role for system messages (default for most models)
       * - 'developer': Use the 'developer' role for system messages (used by reasoning models)
       ...
       * If not specified, the mode is automatically determined based on the model.
       */
      systemMessageMode: import_v461.z.enum(["system", "developer", "remove"]).optional(),
      /**
       * Force treating this model as a reasoning model.
       *
       * This is useful for "stealth" reasoning models (e.g. via a custom baseURL)
       ...
       * and defaults `systemMessageMode` to `developer` unless overridden.
       */
      forceReasoning: import_v461.z.boolean().optional()
    })
  )
);
async function prepareResponsesTools({
  ...
  for (const tool6 of tools) {
    switch (tool6.type) {
      case "function": {
        const openaiOptions = (_a20 = tool6.providerOptions) == null ? void 0 : _a20.openai;
      ...
      case "provider": {
        switch (tool6.id) {
          case "openai.file_search": {
            const args = await validateTypes3({
              value: tool6.args,
  ...
  switch (type) {
    ...
    case "required":
      return { tools: openaiTools2, toolChoice: type, toolWarnings };
    case "tool": {
      const resolvedToolName = (_b20 = toolNameMapping == null ? void 0 : toolNameMapping.toProviderToolName(toolChoice.toolName)) != null ? _b20 : toolChoice.toolName;
      return {
        tools: openaiTools2,
...
function extractApprovalRequestIdToToolCallIdMapping(prompt) {
  ...
  for (const message of prompt) {
    ...
    for (const part of message.content) {
      ...
      const approvalRequestId = (_b20 = (_a20 = part.providerOptions) == null ? void 0 : _a20.openai) == null ? void 0 : _b20.approvalRequestId;
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    let openaiOptions = await parseProviderOptions3({
      provider: providerOptionsName,
      providerOptions,
      schema: openaiLanguageModelResponsesOptionsSchema
    });
    if (openaiOptions == null && providerOptionsName !== "openai") {
      openaiOptions = await parseProviderOptions3({
        provider: "openai",
        providerOptions,
        schema: openaiLanguageModelResponsesOptionsSchema
      });
    }
    const isReasoningModel = (_a20 = openaiOptions == null ? void 0 : openaiOptions.forceReasoning) != null ? _a20 : modelCapabilities.isReasoningModel;
    ...
    const toolNameMapping = createToolNameMapping2({
      tools,
      providerToolNames: {
      ...
      resolveProviderToolName: (tool6) => tool6.id === "openai.custom" ? tool6.args.name : void 0
    });
    ...
    const { input, warnings: inputWarnings } = await convertToOpenAIResponsesInput({
      prompt,
      toolNameMapping,
      systemMessageMode: (_b20 = openaiOptions == null ? void 0 : openaiOptions.systemMessageMode) != null ? _b20 : isReasoningModel ? "developer" : modelCapabilities.systemMessageMode,
      providerOptionsName,
    ...
    function hasOpenAITool(id) {
      return (tools == null ? void 0 : tools.find((tool6) => tool6.type === "provider" && tool6.id === id)) != null;
    }
    ...
    const webSearchToolName = (_e = tools == null ? void 0 : tools.find(
      (tool6) => tool6.type === "provider" && (tool6.id === "openai.web_search" || tool6.id === "openai.web_search_preview")
    )) == null ? void 0 : _e.name;
    ...
    const shellToolEnvType = (_i = (_h = (_g = tools == null ? void 0 : tools.find(
      (tool6) => tool6.type === "provider" && tool6.id === "openai.shell"
  ...
  async doGenerate(options) {
    var _a20, _b20, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B;
    const {
      args: body,
      warnings,
      webSearchToolName,
    ...
    for (const part of response.output) {
      switch (part.type) {
        ...
        case "tool_search_call": {
          const toolCallId = (_b20 = part.call_id) != null ? _b20 : part.id;
            ...
            for (const annotation of contentPart.annotations) {
              if (annotation.type === "url_citation") {
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_l = (_k = (_j = this.config).generateId) == null ? void 0 : _k.call(_j)) != null ? _l : generateId3(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_o = (_n = (_m = this.config).generateId) == null ? void 0 : _n.call(_m)) != null ? _o : generateId3(),
                  mediaType: "text/plain",
                  title: annotation.filename,
                  filename: annotation.filename,
                  providerMetadata: {
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_r = (_q = (_p = this.config).generateId) == null ? void 0 : _q.call(_p)) != null ? _r : generateId3(),
                  mediaType: "application/octet-stream",
        ...
        case "mcp_approval_request": {
          ...
          const dummyToolCallId = (_w = (_v = (_u = this.config).generateId) == null ? void 0 : _v.call(_u)) != null ? _w : generateId3();
          const toolName = `mcp.${part.name}`;
          content.push({
            type: "tool-call",
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a20, _b20, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              if (value.item.type === "function_call") {
                ...
                ongoingToolCalls[value.output_index] = {
                  toolName,
                  toolCallId,
                  toolSearchExecution: (_a20 = value.item.execution) != null ? _a20 : "server"
                };
                if (isHosted) {
                  controller.enqueue({
                    type: "tool-input-start",
                ...
                activeMessagePhase = (_b20 = value.item.phase) != null ? _b20 : void 0;
                controller.enqueue({
                  type: "text-start",
                  id: value.item.id,
                  providerMetadata: {
              ...
              if (value.item.type === "message") {
                ...
                ongoingToolCalls[value.output_index] = void 0;
                const dummyToolCallId = (_o = (_n = (_m = self.config).generateId) == null ? void 0 : _n.call(_m)) != null ? _o : generateId3();
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_C = (_B = (_A = self.config).generateId) == null ? void 0 : _B.call(_A)) != null ? _C : generateId3(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_F = (_E = (_D = self.config).generateId) == null ? void 0 : _E.call(_D)) != null ? _F : generateId3(),
                  mediaType: "text/plain",
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_I = (_H = (_G = self.config).generateId) == null ? void 0 : _H.call(_G)) != null ? _I : generateId3(),
                  mediaType: "text/plain",
                  title: value.annotation.filename,
                  filename: value.annotation.filename,
                  providerMetadata: {
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_L = (_K = (_J = self.config).generateId) == null ? void 0 : _K.call(_J)) != null ? _L : generateId3(),
                  mediaType: "application/octet-stream",
...
function mapWebSearchOutput(action) {
  ...
  switch (action.type) {
    case "search":
      return {
        action: { type: "search", query: (_a20 = action.query) != null ? _a20 : void 0 },
...
var openaiSpeechModelOptionsSchema = lazySchema3(
  () => zodSchema3(
    import_v462.z.object({
      instructions: import_v462.z.string().nullish(),
      speed: import_v462.z.number().min(0.25).max(4).default(1).nullish()
    })
  )
);
...
var openaiTranscriptionResponseSchema = lazySchema3(
  () => zodSchema3(
    import_v463.z.object({
      text: import_v463.z.string(),
      language: import_v463.z.string().nullish(),
      duration: import_v463.z.number().nullish(),
      words: import_v463.z.array(
        import_v463.z.object({
          word: import_v463.z.string(),
          start: import_v463.z.number(),
          end: import_v463.z.number()
        })
      ).nullish(),
      segments: import_v463.z.array(
        import_v463.z.object({
          id: import_v463.z.number(),
          seek: import_v463.z.number(),
          start: import_v463.z.number(),
          end: import_v463.z.number(),
          text: import_v463.z.string(),
          tokens: import_v463.z.array(import_v463.z.number()),
          temperature: import_v463.z.number(),
          avg_logprob: import_v463.z.number(),
          compression_ratio: import_v463.z.number(),
          no_speech_prob: import_v463.z.number()
        })
      ).nullish()
    })
  )
);
var openAITranscriptionModelOptions = lazySchema3(
  () => zodSchema3(
    import_v464.z.object({
      /**
       * Additional information to include in the transcription response.
       */
      include: import_v464.z.array(import_v464.z.string()).optional(),
      /**
       * The language of the input audio in ISO-639-1 format.
       */
      language: import_v464.z.string().optional(),
      /**
       * An optional text to guide the model's style or continue a previous audio segment.
       */
      prompt: import_v464.z.string().optional(),
      /**
       * The sampling temperature, between 0 and 1.
       * @default 0
       */
      temperature: import_v464.z.number().min(0).max(1).default(0).optional(),
      /**
       * The timestamp granularities to populate for this transcription.
       * @default ['segment']
       */
      timestampGranularities: import_v464.z.array(import_v464.z.enum(["word", "segment"])).default(["segment"]).optional()
    })
  )
);
var languageMap = {
...
var VERSION6 = true ? "3.0.61" : "0.0.0-test";
function createOpenAI(options = {}) {
  var _a20, _b20;
  const baseURL = (_a20 = withoutTrailingSlash3(
    loadOptionalSetting2({
      settingValue: options.baseURL,
      environmentVariableName: "OPENAI_BASE_URL"
    })
  )) != null ? _a20 : "https://api.openai.com/v1";
  const providerName = (_b20 = options.name) != null ? _b20 : "openai";
...
function gatewayUrlFor(provider, baseUrl) {
  const trimmed = baseUrl.replace(/\/$/, "");
  const providerPath = GATEWAY_PATHS[provider];
  if (trimmed.endsWith(providerPath)) {
    return trimmed;
  }
  if (/\/(anthropic|openai|genai)\/v\d+[a-z]*$/i.test(trimmed) || /\/v\d+[a-z]*$/i.test(trimmed)) {
    return trimmed;
  }
  return `${trimmed}${providerPath}`;
}
function gatewayUrlForModel(modelName, baseUrl) {
  return gatewayUrlFor(getProviderForModel(modelName), baseUrl);
}
function gatewayEnvForProviders(baseUrl) {
  return {
...
var normalizeCallerBaseURL = gatewayUrlFor;
var PROVIDERS = [
  "anthropic",
  "google",
  "openai",
...
function computeSessionCost(provider, usage, modelId, actualCost) {
  if (typeof actualCost === "number" && actualCost >= 0) return actualCost;
  const pricing = (modelId ? getModelPricing(modelId) : void 0) ?? TOKEN_PRICING[provider];
  if (!pricing) return 0;
  const inputCost = usage.input / 1e6 * pricing.inputTokenPrice;
  const cacheReadCost = usage.cache_read / 1e6 * (pricing.cacheReadPrice ?? pricing.inputTokenPrice);
  const cacheWriteCost = usage.cache_write / 1e6 * (pricing.cacheWritePrice ?? pricing.inputTokenPrice);
  const outputCost = usage.output / 1e6 * pricing.outputTokenPrice;
...
function getModelForProvider(provider, modelName) {
  ...
  if (!model) {
    throw new Error(
      `Model "${modelName}" is not available for provider "${provider}". Available models: ${Object.keys(MODELS[provider]).join(", ")}`
    );
  }
  return model;
}
function getModelDetails(modelName, apiKeyIn, baseUrl, headers, abortSignal, timeoutMs) {
  ...
  if (modelName && modelName.includes("/")) {
    ...
    const shortcut = MODELS[provider][modelName];
...
function getModel(provider, opts) {
  ...
  const baseURL = opts?.baseUrl ? gatewayUrlFor(provider, opts.baseUrl) : getGatewayBaseURL(provider);
  if (baseURL) {
  ...
  switch (provider) {
    ...
    case "openrouter": {
      ...
      const settings = {
        usage: { include: true },
        ...isMoonshot ? { provider: { order: ["moonshotai"], allow_fallbacks: true } } : {}
      };
...
async function loadModelPricing() {
  try {
    ...
    for (const m of data) {
      const p = m.pricing || {};
      const inputTokenPrice = parseFloat(p.prompt) * 1e6;
      const outputTokenPrice = parseFloat(p.completion) * 1e6;
      if (!inputTokenPrice && !outputTokenPrice) continue;
      modelPricing[m.id] = {
        inputTokenPrice,
        outputTokenPrice,
        ...parseFloat(p.input_cache_read) > 0 && {
          cacheReadPrice: parseFloat(p.input_cache_read) * 1e6
        },
        ...parseFloat(p.input_cache_write) > 0 && {
          cacheWritePrice: parseFloat(p.input_cache_write) * 1e6
        }
      };
    }
  } catch {
...
function anthropicSupportsAdaptiveThinking(modelName) {
  if (!modelName) return false;
  const m = modelName.toLowerCase();
  if (m.includes("haiku")) return false;
  return m.includes("sonnet") || m.includes("opus");
}
function getProviderOptions(provider, thinkingSpeed, modelName) {
  const fast = thinkingSpeed === "fast";
  const explicitThinking = thinkingSpeed === "thinking";
  const googleBudget = fast ? 0 : 24e3;
  switch (provider) {
    case "anthropic":
      let thinking;
      if (fast) {
      ...
      thinking = explicitThinking ? { type: "enabled", budgetTokens: 24e3 } : { type: "disabled" };
      return {
        anthropic: {
          thinking,
          cacheControl: { type: "ephemeral" }
...
function resolveLLMConfig(opts) {
  ...
  if (providerHint && !PROVIDERS.includes(providerHint)) {
...
function withLegacyUsage(usage) {
...
function normalizeUsage(raw) {
  ...
  const total = raw?.total !== void 0 ? tokenCount(raw.total) : tokenCount(raw?.totalTokens) || input + cache_read + cache_write + output;
...
function withProviderCacheUsage(usage, providerMetadata) {
  const cached = providerMetadata?.openrouter?.usage?.promptTokensDetails?.cachedTokens;
...
async function callGenerateText(args) {
  const messages = [
    {
      role: "user",
      content: args.prompt
...
var DEFAULT_MAX_USES = 3;
var DEFAULT_NUM_RESULTS = 5;
var DEFAULT_MAX_CHARACTERS = 4e3;
...
function resolveSearchBackend(provider) {
...
async function searchWeb(query, opts = {}) {
  ...
  const res = await fetch(EXA_SEARCH_URL, {
    ...
    body: JSON.stringify({
      ...
      ...opts.allowedDomains?.length ? { includeDomains: opts.allowedDomains } : {},
      ...opts.blockedDomains?.length ? { excludeDomains: opts.blockedDomains } : {}
    })
  });
  if (!res.ok) {
...
function citationSnippet(backend) {
  const indexRule = backend === "exa" ? "Every result carries an `index` field. Use that number exactly as returned \u2014 never invent or renumber one. Indices are global across all searches in this conversation." : "Use the index Anthropic assigns to the search result you are citing.";
  return `
...
function createWebSearch(opts) {
  ...
  if (backend === "anthropic") {
    const apiKey = normalizeApiKey(opts.apiKey) || normalizeApiKey(process.env.ANTHROPIC_API_KEY);
    if (!apiKey) {
      return emptyHandle(results);
    }
    const baseURL = getGatewayBaseURL("anthropic");
    const anthropic2 = createAnthropic({ apiKey, ...baseURL && { baseURL } });
    return {
      tool: anthropic2.tools.webSearch_20250305({
        maxUses,
  ...
  let uses = 0;
  return {
    tool: (0, import_ai2.tool)({
      description: "Search the web for current information. Returns numbered results with page text. Prefer one specific query per call over broad multi-topic queries.",
      inputSchema: import_zod.z.object({
        query: import_zod.z.string().describe("The search query."),
        num_results: import_zod.z.number().int().min(1).max(10).optional().describe("How many results to return. Default 5.")
      }),
      execute: async ({
        query,
        num_results
        ...
        try {
          ...
          return hits.map((hit) => {
            const indexed = { ...hit, index: results.length + 1 };
...
function formatOutput(markdown, results, citations) {
  return citations ? linkifyCitations(markdown, results) : { content: stripCitations(markdown), converted: 0, skipped: 0 };
}
function captureNativeResults(stepContent, target) {
...
function stripCitations(markdown) {
  return markdown.replace(/[ \t]*<cite\b[^>]*>\s*<\/cite>/g, "").replace(/<cite\b[^>]*>(.*?)<\/cite>/g, "$1").replace(/<\/?cite\b[^>]*>/g, "");
}
function linkifyCitations(markdown, results) {
  let converted = 0;
  let skipped = 0;
  const content = markdown.replace(
    /<cite index="(\d+)(?:-\d+(?:,\d+-\d+)*)?">(.*?)<\/cite>/g,
    (_match, indexStr, anchor) => {
...
var DEFAULT_MAX_USES2 = 5;
var DEFAULT_MAX_CHARACTERS2 = 4e4;
var CHARS_PER_TOKEN = 4;
var DEFAULT_TIMEOUT_MS = 2e4;
var MAX_REDIRECTS = 5;
var MAX_BODY_BYTES = 4 * 1024 * 1024;
var USER_AGENT = "aieo-web-fetch/1 (+https://github.com/stakwork/stakgraph)";
var ACCEPT = "text/html, application/xhtml+xml, text/plain;q=0.9, application/json;q=0.9, text/*;q=0.8, */*;q=0.5";
function resolveFetchBackend(provider) {
  return provider === "anthropic" ? "anthropic" : "http";
}
var PRIVATE_ADDRESSES = buildBlockList();
function buildBlockList() {
  const b = new import_node_net.BlockList();
  const v42 = [
    ["0.0.0.0", 8],
    // "this" network
    ["10.0.0.0", 8],
  ...
  for (const [net, prefix] of v42) b.addSubnet(net, prefix, "ipv4");
  b.addAddress("::", "ipv6");
  b.addAddress("::1", "ipv6");
  const v6 = [
    ["64:ff9b::", 96],
    ...
    // link-local
    ["fec0::", 10],
    // site-local (deprecated, still routed on old gear)
    ["ff00::", 8]
    // multicast
  ];
...
function isPrivateAddress(ip) {
  ...
  const family = (0, import_node_net.isIP)(bare);
  try {
...
var defaultLookup = async (hostname) => {
  const addresses = await (0, import_promises.lookup)(hostname, { all: true });
  return addresses.map((a) => a.address);
};
function matchesDomain(host, domains) {
  return domains.some((d) => {
    const dom = d.trim().toLowerCase().replace(/^https?:\/\//, "").replace(/\/.*$/, "").replace(/^\*\./, "").replace(/\.$/, "");
    return !!dom && (host === dom || host.endsWith("." + dom));
  });
}
async function validateFetchUrl(raw, opts = {}) {
  let url;
  try {
    url = new URL(raw);
  } catch {
  ...
  if ((0, import_node_net.isIP)(literal)) {
...
async function fetchUrl(rawUrl, opts = {}) {
  const maxCharacters = opts.maxCharacters ?? DEFAULT_MAX_CHARACTERS2;
  ...
  const isHtml = mediaType === "text/html" || mediaType === "application/xhtml+xml" || looksLikeHtml(raw);
...
function isTextual(mediaType) {
  ...
  return mediaType === "application/json" || mediaType === "application/xml" || mediaType === "application/xhtml+xml" || mediaType === "application/javascript";
}
...
function codePoint(cp, fallback) {
  if (!Number.isFinite(cp) || cp <= 0 || cp > 1114111 || cp >= 55296 && cp <= 57343) {
    return fallback;
  }
  return String.fromCodePoint(cp);
}
function decodeEntities(s) {
  return s.replace(/&#x([0-9a-f]{1,6});/gi, (m, hex) => codePoint(parseInt(hex, 16), m)).replace(/&#(\d{1,7});/g, (m, dec) => codePoint(parseInt(dec, 10), m)).replace(/&([a-z]+);/gi, (m, name19) => NAMED_ENTITIES[name19.toLowerCase()] ?? m).replace(/&amp;/g, "&");
}
var BLOCK_TAGS = "p|div|section|article|header|footer|main|aside|nav|h[1-6]|ul|ol|tr|table|thead|tbody|tfoot|blockquote|pre|hr|dd|dt|dl|figure|figcaption|form|fieldset|address|details|summary";
function htmlToText(html) {
  const titleMatch = /<title[^>]*>([\s\S]*?)<\/title>/i.exec(html);
  const title = titleMatch ? decodeEntities(titleMatch[1]).replace(/\s+/g, " ").trim() || null : null;
  const stripped = html.replace(/<!--[\s\S]*?-->/g, " ").replace(/<(script|style|noscript|svg|template|head)\b[\s\S]*?<\/\1\s*>/gi, " ").replace(/<br\s*\/?>/gi, "\n").replace(/<li\b[^>]*>/gi, "\n- ").replace(new RegExp(`<\\/?(?:${BLOCK_TAGS})\\b[^>]*>`, "gi"), "\n").replace(/<[^>]+>/g, " ");
  const text = decodeEntities(stripped).replace(/[ \t\r\f\v ]+/g, " ").replace(/ ?\n ?/g, "\n").replace(/\n{3,}/g, "\n\n").trim();
  return { title, text };
}
function createWebFetch(opts) {
  const results = [];
  const backend = opts.backend ?? resolveFetchBackend(opts.provider);
  const maxUses = opts.maxUses ?? DEFAULT_MAX_USES2;
  const maxCharacters = opts.maxCharacters ?? (opts.maxContentTokens ? opts.maxContentTokens * CHARS_PER_TOKEN : DEFAULT_MAX_CHARACTERS2);
  const maxContentTokens = opts.maxContentTokens ?? (opts.maxCharacters ? Math.ceil(opts.maxCharacters / CHARS_PER_TOKEN) : void 0);
  if (backend === "anthropic") {
    const apiKey = normalizeApiKey(opts.apiKey) || normalizeApiKey(process.env.ANTHROPIC_API_KEY);
    if (!apiKey) {
    ...
    const anthropic2 = createAnthropic({ apiKey, ...baseURL && { baseURL } });
    return {
      tool: anthropic2.tools.webFetch_20250910({
        maxUses,
  ...
  let uses = 0;
  return {
    tool: (0, import_ai3.tool)({
      description: "Fetch a specific web page by URL and return its text. HTML is converted to plain text; JSON and plain text come back as-is. Use this to read a page whose address you already have \u2014 one the user gave you, or one returned by web_search. It is not a search engine: it needs a full http(s) URL. PDFs and other binary content are not supported.",
      inputSchema: import_zod2.z.object({
        url: import_zod2.z.string().describe("The absolute http(s) URL to fetch.")
      }),
...
function emptyFetchHandle(results) {
  return {
    tool: void 0,
    backend: void 0,
    native: false,
...
function captureNativeFetchResults(stepContent, target) {
  if (!Array.isArray(stepContent)) return;
  for (const content of stepContent) {
    if (content?.type !== "tool-result") continue;
    ...
    target.push({
      ...
      ...source.type === "text" && typeof source.data === "string" ? { text: source.data } : {},
...
// src/tools.ts
function getProviderTool(provider, apiKey, toolName) {
...
function getAnthropicTool(apiKey, toolName) {
  const baseURL = getGatewayBaseURL("anthropic");
  const anthropic2 = createAnthropic({
    apiKey,
    ...baseURL && { baseURL }
  ...
  switch (toolName) {
    case "webSearch":
      return anthropic2.tools.webSearch_20250305({
        maxUses: 3
      });
    case "bash":
      return anthropic2.tools.bash_20250124({});
    default:
...
// src/logger.ts
function consoleLogger(name19) {
  return {
    info(message) {
      console.log(`[${name19}] ${message}`);
    },
    error(message) {
      console.error(`[${name19}] ${message}`);
    },
    warn(message) {
      console.warn(`[${name19}] ${message}`);
    },
    debug(message) {
      console.debug(`[${name19}] ${message}`);
    },
    trace(message) {
      console.trace(`[${name19}] ${message}`);
    },
    fatal(message) {
      console.error(`==FATAL== [${name19}] ${message}`);
    }
  };
}
...
0 && (module.exports = {
  ...
  emptyUsage,
  fetchUrl,
  gatewayEnvForProviders,
  gatewayUrlFor,
  gatewayUrlForModel,
  getApiKeyForProvider,
  getContextLimit,
  getGatewayBaseURL,
  getLightModelForProvider,
  getModel,
  getModelDetails,
  getProviderForModel,
  getProviderOptions,
