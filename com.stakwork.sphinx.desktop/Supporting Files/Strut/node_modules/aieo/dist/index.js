...
function parseArrayDef(def, refs) {
  ...
  if (((_a24 = def.type) == null ? void 0 : _a24._def) && ((_c = (_b24 = def.type) == null ? void 0 : _b24._def) == null ? void 0 : _c.typeName) !== ZodFirstPartyTypeKind.ZodAny) {
...
var advisor_20260301ArgsSchema = lazySchema(
  () => zodSchema(
    z42.object({
      model: z42.string(),
      maxUses: z42.number().optional(),
      caching: z42.object({
        type: z42.literal("ephemeral"),
        ttl: z42.union([z42.literal("5m"), z42.literal("1h")])
      }).optional()
    })
  )
);
var advisor_20260301OutputSchema = lazySchema(
  () => zodSchema(
    z42.discriminatedUnion("type", [
      z42.object({
        type: z42.literal("advisor_result"),
        text: z42.string()
      }),
      z42.object({
        type: z42.literal("advisor_redacted_result"),
        encryptedContent: z42.string()
      }),
      z42.object({
        type: z42.literal("advisor_tool_result_error"),
        errorCode: z42.string()
      })
    ])
  )
);
var advisor_20260301InputSchema = lazySchema(
  () => zodSchema(z42.object({}).strict())
);
...
function parseArrayDef2(def, refs) {
  ...
  if (((_a24 = def.type) == null ? void 0 : _a24._def) && ((_c = (_b24 = def.type) == null ? void 0 : _b24._def) == null ? void 0 : _c.typeName) !== ZodFirstPartyTypeKind4.ZodAny) {
...
var googleEmbeddingContentPartSchema = z25.union([
  z25.object({ text: z25.string() }),
  z25.object({
    inlineData: z25.object({
      mimeType: z25.string(),
      data: z25.string()
    })
  })
...
var googleEmbeddingModelOptions = lazySchema2(
  () => zodSchema2(
    z25.object({
       ...
       */
      outputDimensionality: z25.number().optional(),
      /**
       ...
       */
      content: z25.array(z25.array(googleEmbeddingContentPartSchema).min(1).nullable()).optional()
    })
  )
);
...
var googleLanguageModelOptions = lazySchema2(
  () => zodSchema2(
    z44.object({
      responseModalities: z44.array(z44.enum(["TEXT", "IMAGE"])).optional(),
      thinkingConfig: z44.object({
        thinkingBudget: z44.number().optional(),
        includeThoughts: z44.boolean().optional(),
        // https://ai.google.dev/gemini-api/docs/gemini-3?thinking=high#thinking_level
        thinkingLevel: z44.enum(["minimal", "low", "medium", "high"]).optional()
      }).optional(),
      /**
       * Optional.
       ...
       */
      cachedContent: z44.string().optional(),
      /**
       ...
       */
      structuredOutputs: z44.boolean().optional(),
      /**
       * Optional. A list of unique safety settings for blocking unsafe content.
       */
      safetySettings: z44.array(
        z44.object({
          category: z44.enum([
       ...
       */
      audioTimestamp: z44.boolean().optional(),
      /**
       * Optional. Defines labels used in billing reports. Available on Vertex AI only.
       *
       * https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/add-labels-to-api-calls
       */
      labels: z44.record(z44.string(), z44.string()).optional(),
      /**
       * Optional. If specified, the media resolution specified will be used.
       *
       * https://ai.google.dev/api/generate-content#MediaResolution
       */
      mediaResolution: z44.enum([
       ...
       */
      imageConfig: z44.object({
        aspectRatio: z44.enum([
          "1:1",
          "2:3",
          "3:2",
          "3:4",
        ...
        imageSize: z44.enum(["1K", "2K", "4K", "512"]).optional()
      }).optional(),
      /**
       ...
       */
      retrievalConfig: z44.object({
        latLng: z44.object({
          latitude: z44.number(),
          longitude: z44.number()
        }).optional()
      }).optional(),
      /**
       ...
       */
      streamFunctionCallArguments: z44.boolean().optional(),
      /**
       * Optional. The service tier to use for the request.
       */
      serviceTier: z44.enum(["standard", "flex", "priority"]).optional()
    })
  )
);
...
var getGroundingMetadataSchema = () => z52.object({
...
var partialArgSchema = z52.object({
  jsonPath: z52.string(),
...
var getContentSchema = () => z52.object({
  parts: z52.array(
    z52.union([
...
var getSafetyRatingSchema = () => z52.object({
...
var tokenDetailsSchema = z52.array(
  z52.object({
    modality: z52.string(),
    tokenCount: z52.number()
  })
).nullish();
var usageSchema = z52.object({
...
var getUrlContextMetadataSchema = () => z52.object({
...
var enterpriseWebSearch = createProviderToolFactory2({
  ...
  inputSchema: lazySchema2(() => zodSchema2(z72.object({})))
});
var fileSearchArgsBaseSchema = z82.object({
...
var googleMaps = createProviderToolFactory2({
  ...
  inputSchema: lazySchema2(() => zodSchema2(z92.object({})))
});
var googleSearchToolArgsBaseSchema = z102.object({
...
var urlContext = createProviderToolFactory2({
  ...
  inputSchema: lazySchema2(() => zodSchema2(z112.object({})))
});
var vertexRagStore = createProviderToolFactory2({
  id: "google.vertex_rag_store",
  inputSchema: z122.object({
    ragCorpus: z122.string(),
    topK: z122.number().optional()
  })
});
var googleTools = {
  /**
...
var googleImageResponseSchema = lazySchema2(
  () => zodSchema2(
    z132.object({
      predictions: z132.array(z132.object({ bytesBase64Encoded: z132.string() })).default([])
    })
  )
);
...
var googleOperationSchema = z142.object({
  name: z142.string().nullish(),
  done: z142.boolean().nullish(),
  error: z142.object({
    code: z142.number().nullish(),
    message: z142.string(),
    status: z142.string().nullish()
  }).nullish(),
  response: z142.object({
    generateVideoResponse: z142.object({
      generatedSamples: z142.array(
        z142.object({
          video: z142.object({
            uri: z142.string().nullish()
          }).nullish()
        })
      ).nullish()
    }).nullish()
...
var googleVideoModelOptionsSchema = lazySchema2(
  () => zodSchema2(
    z142.object({
      pollIntervalMs: z142.number().positive().nullish(),
      pollTimeoutMs: z142.number().positive().nullish(),
      personGeneration: z142.enum(["dont_allow", "allow_adult", "allow_all"]).nullish(),
      negativePrompt: z142.string().nullish(),
      referenceImages: z142.array(
        z142.object({
          bytesBase64Encoded: z142.string().nullish(),
          gcsUri: z142.string().nullish()
        })
      ).nullish()
    }).passthrough()
  )
...
import { ZodFirstPartyTypeKind as ZodFirstPartyTypeKind33 } from "zod/v3";
import { ZodFirstPartyTypeKind as ZodFirstPartyTypeKind5 } from "zod/v3";
import {
...
function parseArrayDef3(def, refs) {
  ...
  if (((_a24 = def.type) == null ? void 0 : _a24._def) && ((_c = (_b24 = def.type) == null ? void 0 : _b24._def) == null ? void 0 : _c.typeName) !== ZodFirstPartyTypeKind5.ZodAny) {
...
function parseRecordDef3(def, refs) {
  ...
  if (((_b24 = def.keyType) == null ? void 0 : _b24._def.typeName) === ZodFirstPartyTypeKind23.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
...
var selectParser3 = (def, typeName, refs) => {
  switch (typeName) {
    case ZodFirstPartyTypeKind33.ZodString:
      return parseStringDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodNumber:
      return parseNumberDef3(def);
    case ZodFirstPartyTypeKind33.ZodObject:
      return parseObjectDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodBigInt:
      return parseBigintDef3(def);
    case ZodFirstPartyTypeKind33.ZodBoolean:
      return parseBooleanDef3();
    case ZodFirstPartyTypeKind33.ZodDate:
      return parseDateDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodUndefined:
      return parseUndefinedDef3();
    case ZodFirstPartyTypeKind33.ZodNull:
      return parseNullDef3();
    case ZodFirstPartyTypeKind33.ZodArray:
      return parseArrayDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodUnion:
    case ZodFirstPartyTypeKind33.ZodDiscriminatedUnion:
      return parseUnionDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodIntersection:
      return parseIntersectionDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodTuple:
      return parseTupleDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodRecord:
      return parseRecordDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodLiteral:
      return parseLiteralDef3(def);
    case ZodFirstPartyTypeKind33.ZodEnum:
      return parseEnumDef3(def);
    case ZodFirstPartyTypeKind33.ZodNativeEnum:
      return parseNativeEnumDef3(def);
    case ZodFirstPartyTypeKind33.ZodNullable:
      return parseNullableDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodOptional:
      return parseOptionalDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodMap:
      return parseMapDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodSet:
      return parseSetDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodLazy:
      return () => def.getter()._def;
    case ZodFirstPartyTypeKind33.ZodPromise:
      return parsePromiseDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodNaN:
    case ZodFirstPartyTypeKind33.ZodNever:
      return parseNeverDef3();
    case ZodFirstPartyTypeKind33.ZodEffects:
      return parseEffectsDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodAny:
      return parseAnyDef3();
    case ZodFirstPartyTypeKind33.ZodUnknown:
      return parseUnknownDef3();
    case ZodFirstPartyTypeKind33.ZodDefault:
      return parseDefaultDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodBranded:
      return parseBrandedDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodReadonly:
      return parseReadonlyDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodCatch:
      return parseCatchDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodPipeline:
      return parsePipelineDef3(def, refs);
    case ZodFirstPartyTypeKind33.ZodFunction:
    case ZodFirstPartyTypeKind33.ZodVoid:
    case ZodFirstPartyTypeKind33.ZodSymbol:
      return void 0;
    default:
      return /* @__PURE__ */ ((_) => void 0)(typeName);
  }
...
import { z as z262 } from "zod/v4";
var openaiErrorDataSchema = z26.object({
  error: z26.object({
    message: z26.string(),
    // The additional information below is handled loosely to support
    // OpenAI-compatible providers that have slightly different error
    // responses:
    type: z26.string().nullish(),
    param: z26.any().nullish(),
    code: z26.union([z26.string(), z26.number()]).nullish()
  })
});
...
var openaiChatResponseSchema = lazySchema3(
  () => zodSchema3(
    z27.object({
      ...
      created: z27.number().nullish(),
      model: z27.string().nullish(),
      choices: z27.array(
        z27.object({
          message: z27.object({
            role: z27.literal("assistant").nullish(),
            content: z27.string().nullish(),
            tool_calls: z27.array(
              z27.object({
                id: z27.string().nullish(),
                type: z27.literal("function"),
                function: z27.object({
                  name: z27.string(),
                  arguments: z27.string()
                })
              })
            ).nullish(),
            annotations: z27.array(
              z27.object({
                type: z27.literal("url_citation"),
                url_citation: z27.object({
                  start_index: z27.number(),
                  end_index: z27.number(),
                  url: z27.string(),
                  title: z27.string()
                })
              })
          ...
          finish_reason: z27.string().nullish()
        })
      ),
      usage: z27.object({
        prompt_tokens: z27.number().nullish(),
        completion_tokens: z27.number().nullish(),
        total_tokens: z27.number().nullish(),
        prompt_tokens_details: z27.object({
          cached_tokens: z27.number().nullish()
        }).nullish(),
        completion_tokens_details: z27.object({
          reasoning_tokens: z27.number().nullish(),
          accepted_prediction_tokens: z27.number().nullish(),
          rejected_prediction_tokens: z27.number().nullish()
        }).nullish()
      }).nullish()
    })
  )
    ...
    z27.union([
      z27.object({
        ...
        choices: z27.array(
          z27.object({
            delta: z27.object({
              role: z27.enum(["assistant"]).nullish(),
              content: z27.string().nullish(),
              tool_calls: z27.array(
                z27.object({
                  index: z27.number(),
                  id: z27.string().nullish(),
                  type: z27.literal("function").nullish(),
                  function: z27.object({
                    name: z27.string().nullish(),
                    arguments: z27.string().nullish()
                  })
                })
              ).nullish(),
              annotations: z27.array(
...
var openaiLanguageModelChatOptions = lazySchema3(
  () => zodSchema3(
    z33.object({
       ...
       */
      logitBias: z33.record(z33.coerce.number(), z33.number()).optional(),
      /**
       ...
       */
      logprobs: z33.union([z33.boolean(), z33.number()]).optional(),
      /**
       * Whether to enable parallel function calling during tool use. Default to true.
       */
      parallelToolCalls: z33.boolean().optional(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse.
       */
      user: z33.string().optional(),
      /**
       * Reasoning effort for reasoning models. Defaults to `medium`.
       */
      reasoningEffort: z33.enum(["none", "minimal", "low", "medium", "high", "xhigh"]).optional(),
      /**
       * Maximum number of completion tokens to generate. Useful for reasoning models.
       */
      maxCompletionTokens: z33.number().optional(),
      /**
       * Whether to enable persistence in responses API.
       */
      store: z33.boolean().optional(),
      /**
       * Metadata to associate with the request.
       */
      metadata: z33.record(z33.string().max(64), z33.string().max(512)).optional(),
      /**
       * Parameters for prediction mode.
       */
      prediction: z33.record(z33.string(), z33.any()).optional(),
      /**
       ...
       * @default 'auto'
       */
      serviceTier: z33.enum(["auto", "flex", "priority", "default"]).optional(),
      /**
       * Whether to use strict JSON schema validation.
       *
       * @default true
       */
      strictJsonSchema: z33.boolean().optional(),
      /**
       * Controls the verbosity of the model's responses.
       * Lower values will result in more concise responses, while higher values will result in more verbose responses.
       */
      textVerbosity: z33.enum(["low", "medium", "high"]).optional(),
      /**
       * A cache key for prompt caching. Allows manual control over prompt caching behavior.
       * Useful for improving cache hit rates and working around automatic caching issues.
       */
      promptCacheKey: z33.string().optional(),
      /**
       ...
       * @default 'in_memory'
       */
      promptCacheRetention: z33.enum(["in_memory", "24h"]).optional(),
      /**
       ...
       * information.
       */
      safetyIdentifier: z33.string().optional(),
      /**
       ...
       */
      systemMessageMode: z33.enum(["system", "developer", "remove"]).optional(),
      /**
       ...
       */
      forceReasoning: z33.boolean().optional()
    })
  )
);
...
var openaiLanguageModelCompletionOptions = lazySchema3(
  () => zodSchema3(
    z53.object({
       ...
       */
      logitBias: z53.record(z53.string(), z53.number()).optional(),
      /**
       * The suffix that comes after a completion of inserted text.
       */
      suffix: z53.string().optional(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse. Learn more.
       */
      user: z53.string().optional(),
      /**
       ...
       * tokens that were generated.
       */
      logprobs: z53.union([z53.boolean(), z53.number()]).optional()
    })
  )
);
...
var openaiEmbeddingModelOptions = lazySchema3(
  () => zodSchema3(
    z63.object({
       ...
       */
      dimensions: z63.number().optional(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse. Learn more.
       */
      user: z63.string().optional()
    })
  )
);
var openaiTextEmbeddingResponseSchema = lazySchema3(
  () => zodSchema3(
    z73.object({
      data: z73.array(z73.object({ embedding: z73.array(z73.number()) })),
      usage: z73.object({ prompt_tokens: z73.number() }).nullish()
    })
  )
);
...
var openaiImageResponseSchema = lazySchema3(
  () => zodSchema3(
    z83.object({
      created: z83.number().nullish(),
      data: z83.array(
        z83.object({
          b64_json: z83.string(),
          revised_prompt: z83.string().nullish()
        })
      ),
      background: z83.string().nullish(),
      output_format: z83.string().nullish(),
      size: z83.string().nullish(),
      quality: z83.string().nullish(),
      usage: z83.object({
        input_tokens: z83.number().nullish(),
        output_tokens: z83.number().nullish(),
        total_tokens: z83.number().nullish(),
        input_tokens_details: z83.object({
          image_tokens: z83.number().nullish(),
          text_tokens: z83.number().nullish()
        }).nullish()
      }).nullish()
    })
  )
...
var baseImageModelOptionsObject = z93.object({
  /**
   * Quality of the generated image(s).
   *
   * Valid values: `standard`, `hd`, `low`, `medium`, `high`, `auto`.
   */
  quality: z93.enum(["standard", "hd", "low", "medium", "high", "auto"]).optional(),
  /**
   ...
   * (i.e. `png` or `webp`).
   */
  background: z93.enum(["transparent", "opaque", "auto"]).optional(),
  /**
   * Format in which the generated image(s) are returned.
   */
  outputFormat: z93.enum(["png", "jpeg", "webp"]).optional(),
  /**
   * Compression level (0-100) for the generated image(s). Applies to the
   * `jpeg` and `webp` output formats.
   */
  outputCompression: z93.number().int().min(0).max(100).optional(),
  /**
   * A unique identifier representing your end-user, which can help OpenAI
   * to monitor and detect abuse.
   */
  user: z93.string().optional()
});
...
var openaiImageModelGenerationOptions = lazySchema3(
  () => zodSchema3(
    baseImageModelOptionsObject.extend({
       ...
       * looking images.
       */
      style: z93.enum(["vivid", "natural"]).optional(),
      /**
       * Content moderation level for the generated image(s). `low` applies
       * less restrictive filtering.
       */
      moderation: z93.enum(["auto", "low"]).optional()
    })
  )
);
var openaiImageModelEditOptions = lazySchema3(
  () => zodSchema3(
    baseImageModelOptionsObject.extend({
       ...
       */
      inputFidelity: z93.enum(["high", "low"]).optional()
    })
  )
);
...
var applyPatchInputSchema = lazySchema3(
  () => zodSchema3(
    z103.object({
      callId: z103.string(),
      operation: z103.discriminatedUnion("type", [
        z103.object({
          type: z103.literal("create_file"),
          path: z103.string(),
          diff: z103.string()
        }),
        z103.object({
          type: z103.literal("delete_file"),
          path: z103.string()
        }),
        z103.object({
          type: z103.literal("update_file"),
          path: z103.string(),
          diff: z103.string()
        })
      ])
...
var applyPatchOutputSchema = lazySchema3(
  () => zodSchema3(
    z103.object({
      status: z103.enum(["completed", "failed"]),
      output: z103.string().optional()
    })
  )
);
var applyPatchArgsSchema = lazySchema3(() => zodSchema3(z103.object({})));
...
var codeInterpreterInputSchema = lazySchema3(
  () => zodSchema3(
    z113.object({
      code: z113.string().nullish(),
      containerId: z113.string()
    })
  )
);
var codeInterpreterOutputSchema = lazySchema3(
  () => zodSchema3(
    z113.object({
      outputs: z113.array(
        z113.discriminatedUnion("type", [
          z113.object({ type: z113.literal("logs"), logs: z113.string() }),
          z113.object({ type: z113.literal("image"), url: z113.string() })
        ])
      ).nullish()
    })
  )
...
var codeInterpreterArgsSchema = lazySchema3(
  () => zodSchema3(
    z113.object({
      container: z113.union([
        z113.string(),
        z113.object({
          fileIds: z113.array(z113.string()).optional()
        })
      ]).optional()
    })
  )
...
var customInputSchema = lazySchema3(() => zodSchema3(z123.string()));
var customToolFactory = createProviderToolFactory3({
  id: "openai.custom",
  inputSchema: customInputSchema
});
var customTool = (args) => customToolFactory(args);
var comparisonFilterSchema = z133.object({
  key: z133.string(),
  type: z133.enum(["eq", "ne", "gt", "gte", "lt", "lte", "in", "nin"]),
  value: z133.union([z133.string(), z133.number(), z133.boolean(), z133.array(z133.string())])
});
var compoundFilterSchema = z133.object({
  type: z133.enum(["and", "or"]),
  filters: z133.array(
    z133.union([comparisonFilterSchema, z133.lazy(() => compoundFilterSchema)])
  )
});
var fileSearchArgsSchema2 = lazySchema3(
  () => zodSchema3(
    z133.object({
      vectorStoreIds: z133.array(z133.string()),
      maxNumResults: z133.number().optional(),
      ranking: z133.object({
        ranker: z133.string().optional(),
        scoreThreshold: z133.number().optional()
      }).optional(),
      filters: z133.union([comparisonFilterSchema, compoundFilterSchema]).optional()
    })
  )
);
var fileSearchOutputSchema = lazySchema3(
  () => zodSchema3(
    z133.object({
      queries: z133.array(z133.string()),
      results: z133.array(
        z133.object({
          attributes: z133.record(z133.string(), z133.unknown()),
          fileId: z133.string(),
          filename: z133.string(),
          score: z133.number(),
          text: z133.string()
        })
      ).nullable()
...
var fileSearch2 = createProviderToolFactoryWithOutputSchema3({
  ...
  inputSchema: z133.object({}),
  outputSchema: fileSearchOutputSchema
});
var imageGenerationArgsSchema = lazySchema3(
  () => zodSchema3(
    z143.object({
      background: z143.enum(["auto", "opaque", "transparent"]).optional(),
      inputFidelity: z143.enum(["low", "high"]).optional(),
      inputImageMask: z143.object({
        fileId: z143.string().optional(),
        imageUrl: z143.string().optional()
      }).optional(),
      model: z143.string().optional(),
      moderation: z143.enum(["auto"]).optional(),
      outputCompression: z143.number().int().min(0).max(100).optional(),
      outputFormat: z143.enum(["png", "jpeg", "webp"]).optional(),
      partialImages: z143.number().int().min(0).max(3).optional(),
      quality: z143.enum(["auto", "low", "medium", "high"]).optional(),
      size: z143.enum(["1024x1024", "1024x1536", "1536x1024", "auto"]).optional()
    }).strict()
  )
);
var imageGenerationInputSchema = lazySchema3(() => zodSchema3(z143.object({})));
var imageGenerationOutputSchema = lazySchema3(
  () => zodSchema3(z143.object({ result: z143.string() }))
);
...
var localShellInputSchema = lazySchema3(
  () => zodSchema3(
    z152.object({
      action: z152.object({
        type: z152.literal("exec"),
        command: z152.array(z152.string()),
        timeoutMs: z152.number().optional(),
        user: z152.string().optional(),
        workingDirectory: z152.string().optional(),
        env: z152.record(z152.string(), z152.string()).optional()
      })
    })
  )
);
var localShellOutputSchema = lazySchema3(
  () => zodSchema3(z152.object({ output: z152.string() }))
);
...
var shellInputSchema = lazySchema3(
  () => zodSchema3(
    z162.object({
      action: z162.object({
        commands: z162.array(z162.string()),
        timeoutMs: z162.number().optional(),
        maxOutputLength: z162.number().optional()
      })
    })
  )
);
    ...
    z162.object({
      output: z162.array(
        z162.object({
          stdout: z162.string(),
          stderr: z162.string(),
          outcome: z162.discriminatedUnion("type", [
            z162.object({ type: z162.literal("timeout") }),
            z162.object({ type: z162.literal("exit"), exitCode: z162.number() })
          ])
        })
      )
    })
...
var shellSkillsSchema = z162.array(
  z162.discriminatedUnion("type", [
    z162.object({
      type: z162.literal("skillReference"),
      skillId: z162.string(),
      version: z162.string().optional()
    }),
    z162.object({
      type: z162.literal("inline"),
      name: z162.string(),
      description: z162.string(),
      source: z162.object({
        type: z162.literal("base64"),
        mediaType: z162.literal("application/zip"),
        data: z162.string()
      })
    })
  ])
...
var shellArgsSchema = lazySchema3(
  () => zodSchema3(
    z162.object({
      environment: z162.union([
        z162.object({
          type: z162.literal("containerAuto"),
          fileIds: z162.array(z162.string()).optional(),
          memoryLimit: z162.enum(["1g", "4g", "16g", "64g"]).optional(),
          networkPolicy: z162.discriminatedUnion("type", [
            z162.object({ type: z162.literal("disabled") }),
            z162.object({
              type: z162.literal("allowlist"),
              allowedDomains: z162.array(z162.string()),
              domainSecrets: z162.array(
                z162.object({
                  domain: z162.string(),
                  name: z162.string(),
                  value: z162.string()
        ...
        z162.object({
          type: z162.literal("containerReference"),
          containerId: z162.string()
        }),
        z162.object({
          type: z162.literal("local").optional(),
          skills: z162.array(
            z162.object({
              name: z162.string(),
              description: z162.string(),
...
var toolSearchArgsSchema = lazySchema3(
  () => zodSchema3(
    z172.object({
      execution: z172.enum(["server", "client"]).optional(),
      description: z172.string().optional(),
      parameters: z172.record(z172.string(), z172.unknown()).optional()
    })
  )
);
var toolSearchInputSchema = lazySchema3(
  () => zodSchema3(
    z172.object({
      arguments: z172.unknown().optional(),
      call_id: z172.string().nullish()
    })
  )
);
var toolSearchOutputSchema = lazySchema3(
  () => zodSchema3(
    z172.object({
      tools: z172.array(z172.record(z172.string(), z172.unknown()))
    })
  )
);
...
var webSearchArgsSchema = lazySchema3(
  () => zodSchema3(
    z182.object({
      externalWebAccess: z182.boolean().optional(),
      filters: z182.object({ allowedDomains: z182.array(z182.string()).optional() }).optional(),
      searchContextSize: z182.enum(["low", "medium", "high"]).optional(),
      userLocation: z182.object({
        type: z182.literal("approximate"),
        country: z182.string().optional(),
        city: z182.string().optional(),
        region: z182.string().optional(),
        timezone: z182.string().optional()
      }).optional()
    })
  )
);
var webSearchInputSchema = lazySchema3(() => zodSchema3(z182.object({})));
var webSearchOutputSchema = lazySchema3(
  () => zodSchema3(
    z182.object({
      action: z182.discriminatedUnion("type", [
        z182.object({
          type: z182.literal("search"),
          query: z182.string().optional()
        }),
        z182.object({
          type: z182.literal("openPage"),
          url: z182.string().nullish()
        }),
        z182.object({
          type: z182.literal("findInPage"),
          url: z182.string().nullish(),
          pattern: z182.string().nullish()
        })
      ]).optional(),
      sources: z182.array(
        z182.discriminatedUnion("type", [
          z182.object({ type: z182.literal("url"), url: z182.string() }),
          z182.object({ type: z182.literal("api"), name: z182.string() })
        ])
      ).optional()
    })
  )
...
var webSearchPreviewArgsSchema = lazySchema3(
  () => zodSchema3(
    z192.object({
      searchContextSize: z192.enum(["low", "medium", "high"]).optional(),
      userLocation: z192.object({
        type: z192.literal("approximate"),
        country: z192.string().optional(),
        city: z192.string().optional(),
        region: z192.string().optional(),
        timezone: z192.string().optional()
      }).optional()
    })
  )
);
var webSearchPreviewInputSchema = lazySchema3(
  () => zodSchema3(z192.object({}))
);
    ...
    z192.object({
      action: z192.discriminatedUnion("type", [
        z192.object({
          ...
          query: z192.string().optional()
        }),
        z192.object({
          type: z192.literal("openPage"),
          url: z192.string().nullish()
        }),
        z192.object({
          type: z192.literal("findInPage"),
          url: z192.string().nullish(),
...
var jsonValueSchema = z202.lazy(
  () => z202.union([
    z202.string(),
    z202.number(),
    z202.boolean(),
    z202.null(),
    z202.array(jsonValueSchema),
    z202.record(z202.string(), jsonValueSchema)
  ])
);
var mcpArgsSchema = lazySchema3(
  () => zodSchema3(
    z202.object({
      serverLabel: z202.string(),
      allowedTools: z202.union([
        z202.array(z202.string()),
        z202.object({
          readOnly: z202.boolean().optional(),
          toolNames: z202.array(z202.string()).optional()
        })
      ]).optional(),
      authorization: z202.string().optional(),
      connectorId: z202.string().optional(),
      headers: z202.record(z202.string(), z202.string()).optional(),
      requireApproval: z202.union([
        z202.enum(["always", "never"]),
        z202.object({
          never: z202.object({
            toolNames: z202.array(z202.string()).optional()
          }).optional()
      ...
      serverDescription: z202.string().optional(),
      serverUrl: z202.string().optional()
    }).refine(
...
var mcpInputSchema = lazySchema3(() => zodSchema3(z202.object({})));
var mcpOutputSchema = lazySchema3(
  () => zodSchema3(
    z202.object({
      type: z202.literal("call"),
      serverLabel: z202.string(),
      name: z202.string(),
      arguments: z202.string(),
      output: z202.string().nullish(),
      error: z202.union([z202.string(), jsonValueSchema]).optional()
    })
  )
);
...
var openaiResponsesReasoningProviderOptionsSchema = z212.object({
  itemId: z212.string().nullish(),
  reasoningEncryptedContent: z212.string().nullish()
});
...
var jsonValueSchema2 = z222.lazy(
  () => z222.union([
    z222.string(),
    z222.number(),
    z222.boolean(),
    z222.null(),
    z222.array(jsonValueSchema2),
    z222.record(z222.string(), jsonValueSchema2.optional())
  ])
);
var openaiResponsesChunkSchema = lazySchema3(
  () => zodSchema3(
    z222.union([
      z222.object({
        type: z222.literal("response.output_text.delta"),
        item_id: z222.string(),
        delta: z222.string(),
        logprobs: z222.array(
          z222.object({
      ...
      z222.object({
        type: z222.enum(["response.completed", "response.incomplete"]),
        response: z222.object({
          incomplete_details: z222.object({ reason: z222.string() }).nullish(),
          usage: z222.object({
            input_tokens: z222.number(),
            input_tokens_details: z222.object({ cached_tokens: z222.number().nullish() }).nullish(),
            output_tokens: z222.number(),
            output_tokens_details: z222.object({ reasoning_tokens: z222.number().nullish() }).nullish()
          }),
          service_tier: z222.string().nullish()
        })
      }),
      z222.object({
        type: z222.literal("response.failed"),
        response: z222.object({
          error: z222.object({
            code: z222.string().nullish(),
            message: z222.string()
          }).nullish(),
          incomplete_details: z222.object({ reason: z222.string() }).nullish(),
          usage: z222.object({
      ...
      z222.object({
        type: z222.literal("response.created"),
        response: z222.object({
          id: z222.string(),
          created_at: z222.number(),
          model: z222.string(),
          service_tier: z222.string().nullish()
        })
      }),
      z222.object({
        type: z222.literal("response.output_item.added"),
        output_index: z222.number(),
        item: z222.discriminatedUnion("type", [
          z222.object({
            type: z222.literal("message"),
            id: z222.string(),
            phase: z222.enum(["commentary", "final_answer"]).nullish()
          }),
          z222.object({
            type: z222.literal("reasoning"),
            id: z222.string(),
            encrypted_content: z222.string().nullish()
          }),
          z222.object({
            type: z222.literal("function_call"),
            id: z222.string(),
            call_id: z222.string(),
            name: z222.string(),
            arguments: z222.string(),
            namespace: z222.string().nullish()
          }),
          z222.object({
            type: z222.literal("web_search_call"),
            id: z222.string(),
            status: z222.string()
          }),
          z222.object({
            type: z222.literal("computer_call"),
            id: z222.string(),
            status: z222.string()
          }),
          z222.object({
            type: z222.literal("file_search_call"),
            id: z222.string()
          }),
          z222.object({
            type: z222.literal("image_generation_call"),
            id: z222.string()
          }),
          z222.object({
            type: z222.literal("code_interpreter_call"),
            id: z222.string(),
            container_id: z222.string(),
            code: z222.string().nullable(),
            outputs: z222.array(
              z222.discriminatedUnion("type", [
                z222.object({ type: z222.literal("logs"), logs: z222.string() }),
                z222.object({ type: z222.literal("image"), url: z222.string() })
              ])
            ).nullable(),
            status: z222.string()
          }),
          z222.object({
            type: z222.literal("mcp_call"),
            id: z222.string(),
            status: z222.string(),
            approval_request_id: z222.string().nullish()
          }),
          z222.object({
            type: z222.literal("mcp_list_tools"),
            id: z222.string()
          }),
          z222.object({
            type: z222.literal("mcp_approval_request"),
            id: z222.string()
          }),
          z222.object({
            type: z222.literal("apply_patch_call"),
            id: z222.string(),
            call_id: z222.string(),
            status: z222.enum(["in_progress", "completed"]),
            operation: z222.discriminatedUnion("type", [
              z222.object({
                type: z222.literal("create_file"),
                path: z222.string(),
                diff: z222.string()
              }),
              z222.object({
                type: z222.literal("delete_file"),
                path: z222.string()
              }),
              z222.object({
                type: z222.literal("update_file"),
                path: z222.string(),
                diff: z222.string()
              })
            ])
          ...
          z222.object({
            type: z222.literal("custom_tool_call"),
            id: z222.string(),
            call_id: z222.string(),
            name: z222.string(),
            input: z222.string()
          ...
          z222.object({
            type: z222.literal("shell_call"),
            id: z222.string(),
            call_id: z222.string(),
            status: z222.enum(["in_progress", "completed", "incomplete"]),
            action: z222.object({
              commands: z222.array(z222.string())
            })
          }),
          z222.object({
            type: z222.literal("shell_call_output"),
            id: z222.string(),
            call_id: z222.string(),
            status: z222.enum(["in_progress", "completed", "incomplete"]),
            output: z222.array(
              z222.object({
                stdout: z222.string(),
                stderr: z222.string(),
                outcome: z222.discriminatedUnion("type", [
                  z222.object({ type: z222.literal("timeout") }),
                  z222.object({
                    type: z222.literal("exit"),
                    exit_code: z222.number()
                  })
                ])
              })
            )
          ...
          z222.object({
            type: z222.literal("tool_search_call"),
            id: z222.string(),
            execution: z222.enum(["server", "client"]),
            call_id: z222.string().nullable(),
            status: z222.enum(["in_progress", "completed", "incomplete"]),
            arguments: z222.unknown()
          }),
          z222.object({
            type: z222.literal("tool_search_output"),
            id: z222.string(),
            execution: z222.enum(["server", "client"]),
            call_id: z222.string().nullable(),
            status: z222.enum(["in_progress", "completed", "incomplete"]),
            tools: z222.array(z222.record(z222.string(), jsonValueSchema2.optional()))
          })
        ])
      }),
      z222.object({
        type: z222.literal("response.output_item.done"),
        output_index: z222.number(),
        item: z222.discriminatedUnion("type", [
          z222.object({
            type: z222.literal("message"),
          ...
          z222.object({
            ...
            id: z222.string(),
            status: z222.string(),
            action: z222.discriminatedUnion("type", [
              z222.object({
                type: z222.literal("search"),
                query: z222.string().nullish(),
                sources: z222.array(
                  z222.discriminatedUnion("type", [
                    z222.object({ type: z222.literal("url"), url: z222.string() }),
                    z222.object({ type: z222.literal("api"), name: z222.string() })
                  ])
                ).nullish()
              }),
              z222.object({
                type: z222.literal("open_page"),
                url: z222.string().nullish()
              }),
              z222.object({
                type: z222.literal("find_in_page"),
                url: z222.string().nullish(),
                pattern: z222.string().nullish()
              })
            ]).nullish()
          }),
          z222.object({
            type: z222.literal("file_search_call"),
            id: z222.string(),
            queries: z222.array(z222.string()),
            results: z222.array(
              z222.object({
                attributes: z222.record(
                  z222.string(),
                  z222.union([z222.string(), z222.number(), z222.boolean()])
                ),
                file_id: z222.string(),
                filename: z222.string(),
                score: z222.number(),
                text: z222.string()
              })
            ).nullish()
          ...
          z222.object({
            type: z222.literal("local_shell_call"),
            id: z222.string(),
            call_id: z222.string(),
            action: z222.object({
              type: z222.literal("exec"),
              command: z222.array(z222.string()),
              timeout_ms: z222.number().optional(),
              user: z222.string().optional(),
              working_directory: z222.string().optional(),
              env: z222.record(z222.string(), z222.string()).optional()
            })
          }),
          z222.object({
            type: z222.literal("computer_call"),
          ...
          z222.object({
            ...
            arguments: z222.string(),
            name: z222.string(),
            server_label: z222.string(),
            output: z222.string().nullish(),
            error: z222.union([
              z222.string(),
              z222.object({
                type: z222.string().optional(),
                code: z222.union([z222.number(), z222.string()]).optional(),
                message: z222.string().optional()
              }).loose()
            ]).nullish(),
            approval_request_id: z222.string().nullish()
          }),
          z222.object({
            ...
            tools: z222.array(
              z222.object({
                ...
                input_schema: z222.any(),
                annotations: z222.record(z222.string(), z222.unknown()).optional()
              })
            ),
            error: z222.union([
              z222.string(),
          ...
          z222.object({
            ...
            name: z222.string(),
            arguments: z222.string(),
            approval_request_id: z222.string().optional()
          }),
          z222.object({
            type: z222.literal("apply_patch_call"),
            id: z222.string(),
      ...
      z222.object({
        type: z222.literal("response.function_call_arguments.delta"),
        item_id: z222.string(),
        output_index: z222.number(),
        delta: z222.string()
      }),
      z222.object({
        type: z222.literal("response.custom_tool_call_input.delta"),
        item_id: z222.string(),
        output_index: z222.number(),
        delta: z222.string()
      }),
      z222.object({
        type: z222.literal("response.image_generation_call.partial_image"),
        item_id: z222.string(),
        output_index: z222.number(),
        partial_image_b64: z222.string()
      }),
      z222.object({
        type: z222.literal("response.code_interpreter_call_code.delta"),
        item_id: z222.string(),
        output_index: z222.number(),
        delta: z222.string()
      }),
      z222.object({
        type: z222.literal("response.code_interpreter_call_code.done"),
        item_id: z222.string(),
        output_index: z222.number(),
        code: z222.string()
      }),
      z222.object({
        type: z222.literal("response.output_text.annotation.added"),
        annotation: z222.discriminatedUnion("type", [
          z222.object({
            type: z222.literal("url_citation"),
            start_index: z222.number(),
            end_index: z222.number(),
            url: z222.string(),
            title: z222.string()
          }),
          z222.object({
            type: z222.literal("file_citation"),
            file_id: z222.string(),
            filename: z222.string(),
            index: z222.number()
          }),
          z222.object({
            type: z222.literal("container_file_citation"),
            container_id: z222.string(),
            file_id: z222.string(),
            filename: z222.string(),
            start_index: z222.number(),
      ...
      z222.object({
        type: z222.literal("response.reasoning_summary_part.added"),
        item_id: z222.string(),
        summary_index: z222.number()
      }),
      z222.object({
        type: z222.literal("response.reasoning_summary_text.delta"),
        item_id: z222.string(),
        summary_index: z222.number(),
        delta: z222.string()
      }),
      z222.object({
        type: z222.literal("response.reasoning_summary_part.done"),
        item_id: z222.string(),
        summary_index: z222.number()
      }),
      z222.object({
        type: z222.literal("response.apply_patch_call_operation_diff.delta"),
        item_id: z222.string(),
        output_index: z222.number(),
        delta: z222.string(),
        obfuscation: z222.string().nullish()
      }),
      z222.object({
        type: z222.literal("response.apply_patch_call_operation_diff.done"),
        item_id: z222.string(),
        output_index: z222.number(),
        diff: z222.string()
      }),
      z222.object({
        type: z222.literal("error"),
        sequence_number: z222.number(),
        error: z222.object({
          type: z222.string(),
          code: z222.string(),
          message: z222.string(),
          param: z222.string().nullish()
        })
      }),
      z222.object({ type: z222.string() }).loose().transform((value) => ({
        type: "unknown_chunk",
        message: value.type
      }))
...
var openaiResponsesResponseSchema = lazySchema3(
  () => zodSchema3(
    z222.object({
      id: z222.string().optional(),
      created_at: z222.number().optional(),
      error: z222.object({
        message: z222.string(),
        type: z222.string(),
        param: z222.string().nullish(),
      ...
      model: z222.string().optional(),
      output: z222.array(
        z222.discriminatedUnion("type", [
          z222.object({
            type: z222.literal("message"),
            role: z222.literal("assistant"),
            id: z222.string(),
            phase: z222.enum(["commentary", "final_answer"]).nullish(),
            content: z222.array(
              z222.object({
                type: z222.literal("output_text"),
                text: z222.string(),
                logprobs: z222.array(
                  z222.object({
                    token: z222.string(),
          ...
          z222.object({
            ...
            summary: z222.array(
              z222.object({
                type: z222.literal("summary_text"),
                text: z222.string()
              })
            )
          }),
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema3(
  () => zodSchema3(
    z232.object({
       ...
       */
      conversation: z232.string().nullish(),
      /**
       ...
       * Defaults to `undefined`.
       */
      instructions: z232.string().nullish(),
      /**
       * Return the log probabilities of the tokens. Including logprobs will increase
       * the response size and can slow down response times. However, it can
       * be useful to better understand how the model is behaving.
       ...
       */
      logprobs: z232.union([z232.boolean(), z232.number().min(1).max(TOP_LOGPROBS_MAX)]).optional(),
      /**
       * The maximum number of total calls to built-in tools that can be processed in a response.
       * This maximum number applies across all built-in tool calls, not per individual tool.
       * Any further attempts to call a tool by the model will be ignored.
       */
      maxToolCalls: z232.number().nullish(),
      /**
       * Additional metadata to store with the generation.
       */
      metadata: z232.any().nullish(),
      /**
       * Whether to use parallel tool calls. Defaults to `true`.
       */
      parallelToolCalls: z232.boolean().nullish(),
      /**
       * The ID of the previous response. You can use it to continue a conversation.
       * Defaults to `undefined`.
       */
      previousResponseId: z232.string().nullish(),
      /**
       * Sets a cache key to tie this prompt to cached prefixes for better caching performance.
       */
      promptCacheKey: z232.string().nullish(),
      /**
       * The retention policy for the prompt cache.
       * - 'in_memory': Default. Standard prompt caching behavior.
       * - '24h': Extended prompt caching that keeps cached prefixes active for up to 24 hours.
       ...
       * @default 'in_memory'
       */
      promptCacheRetention: z232.enum(["in_memory", "24h"]).nullish(),
      /**
       ...
       * an error.
       */
      reasoningEffort: z232.string().nullish(),
      /**
       * Controls reasoning summary output from the model.
       * Set to "auto" to automatically receive the richest level available,
       * or "detailed" for comprehensive summaries.
       */
      reasoningSummary: z232.string().nullish(),
      /**
       * The identifier for safety monitoring and tracking.
       */
      safetyIdentifier: z232.string().nullish(),
      /**
       * Service tier for the request.
       ...
       * Defaults to 'auto'.
       */
      serviceTier: z232.enum(["auto", "flex", "priority", "default"]).nullish(),
      /**
       * Whether to store the generation. Defaults to `true`.
       */
      store: z232.boolean().nullish(),
      /**
       * Whether to use strict JSON schema validation.
       * Defaults to `true`.
       */
      strictJsonSchema: z232.boolean().nullish(),
      /**
       * Controls the verbosity of the model's responses. Lower values ('low') will result
       * in more concise responses, while higher values ('high') will result in more verbose responses.
       * Valid values: 'low', 'medium', 'high'.
       */
      textVerbosity: z232.enum(["low", "medium", "high"]).nullish(),
      /**
       * Controls output truncation. 'auto' (default) performs truncation automatically;
       * 'disabled' turns truncation off.
       */
      truncation: z232.enum(["auto", "disabled"]).nullish(),
      /**
       * A unique identifier representing your end-user, which can help OpenAI to
       * monitor and detect abuse.
       * Defaults to `undefined`.
       ...
       * If not specified, the mode is automatically determined based on the model.
       */
      systemMessageMode: z232.enum(["system", "developer", "remove"]).optional(),
      /**
       * Force treating this model as a reasoning model.
       *
       * This is useful for "stealth" reasoning models (e.g. via a custom baseURL)
       ...
       * and defaults `systemMessageMode` to `developer` unless overridden.
       */
      forceReasoning: z232.boolean().optional()
    })
  )
);
...
var openaiSpeechModelOptionsSchema = lazySchema3(
  () => zodSchema3(
    z242.object({
      instructions: z242.string().nullish(),
      speed: z242.number().min(0.25).max(4).default(1).nullish()
    })
  )
);
...
var openaiTranscriptionResponseSchema = lazySchema3(
  () => zodSchema3(
    z252.object({
      text: z252.string(),
      language: z252.string().nullish(),
      duration: z252.number().nullish(),
      words: z252.array(
        z252.object({
          word: z252.string(),
          start: z252.number(),
      ...
      segments: z252.array(
        z252.object({
          ...
          text: z252.string(),
          tokens: z252.array(z252.number()),
          temperature: z252.number(),
          avg_logprob: z252.number(),
          compression_ratio: z252.number(),
          no_speech_prob: z252.number()
        })
      ).nullish()
    })
  )
...
var openAITranscriptionModelOptions = lazySchema3(
  () => zodSchema3(
    z262.object({
       ...
       */
      include: z262.array(z262.string()).optional(),
      /**
       * The language of the input audio in ISO-639-1 format.
       */
      language: z262.string().optional(),
      /**
       * An optional text to guide the model's style or continue a previous audio segment.
       */
      prompt: z262.string().optional(),
      /**
       * The sampling temperature, between 0 and 1.
       * @default 0
       */
      temperature: z262.number().min(0).max(1).default(0).optional(),
      /**
       * The timestamp granularities to populate for this transcription.
       * @default ['segment']
       */
      timestampGranularities: z262.array(z262.enum(["word", "segment"])).default(["segment"]).optional()
    })
  )
);
var languageMap = {
...
function lookupApiKeyForProvider(provider) {
  ...
  return normalizeApiKey(process.env[API_KEY_ENV[provider]]);
}
...
function parseModelName(name19) {
  if (!name19) return {};
  const slash = name19.indexOf("/");
  if (slash > 0) {
    const head = name19.slice(0, slash);
    if (PROVIDERS.includes(head)) {
      return { provider: head, modelId: name19.slice(slash + 1) || void 0 };
    }
  }
  return { modelId: name19 };
}
var ALIASES = new Set(Object.values(MODELS).flatMap((m) => Object.keys(m)));
function envProvider() {
  const v = process.env.LLM_PROVIDER;
  return v && PROVIDERS.includes(v) ? v : void 0;
}
function canonicalModelName(model, provider) {
  ...
  if (model && !provider && !parsed.provider && model.includes("/") && !envProvider()) {
    ...
    throw new Error(
      `Model "${model}" has no provider prefix: "${head}" is not a provider (${PROVIDERS.join(", ")}). For an OpenRouter-hosted model write "openrouter/${model}"; otherwise pass the provider explicitly.`
    );
  }
  let modelId = parsed.modelId;
  if (modelId && ALIASES.has(modelId)) {
    const hit = MODELS[p][modelId];
    if (!hit) {
      throw new Error(
        `Model "${modelId}" is not available for provider "${p}". Available models: ${Object.keys(MODELS[p]).join(", ")}`
      );
    }
    modelId = hit;
  }
...
function maxOutputTokensFor(provider) {
  const env = Number(process.env.MAX_OUTPUT_TOKENS);
  if (env > 0) return env;
  return provider === "anthropic" ? 128e3 : 64e3;
}
async function resolveModel(opts = {}) {
  ...
  const apiKey = normalizeApiKey(opts.apiKey) ?? normalizeApiKey(await opts.getSecret?.(envName)) ?? normalizeApiKey(process.env[envName]);
  if (!apiKey) {
    throw new Error(
  ...
  return {
    tool: tool4({
      ...
      inputSchema: z28.object({
        query: z28.string().describe("The search query."),
        num_results: z28.number().int().min(1).max(10).optional().describe("How many results to return. Default 5.")
      }),
      execute: async ({
        query,
        num_results
  ...
  return {
    tool: tool5({
      ...
      inputSchema: z29.object({
        url: z29.string().describe("The absolute http(s) URL to fetch.")
      }),
