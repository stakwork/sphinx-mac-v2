...
var baseImageModelOptionsObject = import_v49.z.object({
   ...
   */
  quality: import_v49.z.enum(["standard", "hd", "low", "medium", "high", "xhigh", "max", "auto"]).optional(),
  /**
        ...
        for (const part of content) {
          switch (part.type) {
            ...
            case "tool-call": {
              ...
              if (part.toolName === toolSearchToolName) {
                ...
                input.push({
                  ...
                  execution,
                  call_id: (_q = parsedInput.call_id) != null ? _q : null,
                  status: "completed",
              ...
              const isProviderDefinedToolCall = hasLocalShellTool && resolvedToolName === "local_shell" || hasShellTool && resolvedToolName === "shell" || hasApplyPatchTool && resolvedToolName === "apply_patch" || ((_r = customProviderToolNames == null ? void 0 : customProviderToolNames.has(resolvedToolName)) != null ? _r : false);
            ...
            case "tool-result": {
              ...
              if (part.toolName === toolSearchToolName) {
                const itemId = (_x = (_w = (_t = (_s = part.providerOptions) == null ? void 0 : _s[providerOptionsName]) == null ? void 0 : _t.itemId) != null ? _w : (_v = (_u = part.providerMetadata) == null ? void 0 : _u[providerOptionsName]) == null ? void 0 : _v.itemId) != null ? _x : part.toolCallId;
                if (store) {
              ...
              if (store) {
                const itemId = (_A = (_z = (_y = part.providerOptions) == null ? void 0 : _y[providerOptionsName]) == null ? void 0 : _z.itemId) != null ? _A : part.toolCallId;
                input.push({ type: "item_reference", id: itemId });
              } else {
                warnings.push({
                  type: "other",
...
${text}`,
          ...
          if (output.type === "execution-denied") {
            const approvalId = (_C = (_B = output.providerOptions) == null ? void 0 : _B.openai) == null ? void 0 : _C.approvalId;
            if (approvalId) {
              continue;
            }
          }
            ...
            switch (output.type) {
              ...
              case "execution-denied":
                outputValue = convertScalarOutput(
                  (_D = output.reason) != null ? _D : "Tool call execution denied."
                );
                break;
              case "json":
              case "error-json":
      ...
      import_v418.z.object({
        ...
        item: import_v418.z.discriminatedUnion("type", [
          ...
          import_v418.z.object({
            ...
            async: import_v418.z.boolean().nullish(),
...
var imageGenerationArgsSchema = (0, import_provider_utils30.lazySchema)(
  () => (0, import_provider_utils30.zodSchema)(
    import_v422.z.object({
      ...
      quality: import_v422.z.enum(["auto", "low", "medium", "high", "xhigh", "max"]).optional(),
...
var customArgsSchema = (0, import_provider_utils31.lazySchema)(
  () => (0, import_provider_utils31.zodSchema)(
    import_v423.z.object({
      ...
      async: import_v423.z.boolean().optional(),
