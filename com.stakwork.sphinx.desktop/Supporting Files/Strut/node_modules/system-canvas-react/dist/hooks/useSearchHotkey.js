 ...
 */
export function shouldHandleSearchHotkey(target, container, canvasActive) {
 ...
 */
export function useSearchHotkey(containerRef, onToggle) {
    ...
    useEffect(() => {
        ...
        const onKey = (e) => {
            if (!((e.metaKey || e.ctrlKey) && e.key === 'f'))
                return;
            if (!shouldHandleSearchHotkey(e.target, containerRef.current, canvasActiveRef.current)) {
                return;
            }
            e.preventDefault();
            toggleRef.current();
...
//# sourceMappingURL=useSearchHotkey.js.map