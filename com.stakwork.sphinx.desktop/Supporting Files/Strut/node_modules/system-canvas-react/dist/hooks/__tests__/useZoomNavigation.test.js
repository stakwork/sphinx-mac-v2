 ...
 */
function makeThresholdNode(id, ref) {
    return {
        id,
        type: 'text',
...
function makeDefaultOptions(overrides = {}) {
    ...
    const options = {
        ...
        theme: { background: '#000', node: {}, edge: {}, group: {} },
...
describe('useZoomNavigation — pendingNavRef lock', () => {
    ...
    it('clears lock on canvas change: pendingNavRef is reset when currentCanvas changes', () => {
        ...
        const { result, rerender } = renderHook((opts) => useZoomNavigation(opts), { initialProps: options });
        // Arm lock for ref-A.
        act(() => {
            result.current.setPendingNavRef('ref-A');
        });
...
//# sourceMappingURL=useZoomNavigation.test.js.map