 ...
 */
export function cloneForExport(svgEl, bounds) {
 ...
 */
function svgToBlob(clone, width, height) {
 ...
 */
export async function exportAsPNG(svgEl, nodes, options) {
 ...
 */
export async function copyAsImage(svgEl, nodes) {
