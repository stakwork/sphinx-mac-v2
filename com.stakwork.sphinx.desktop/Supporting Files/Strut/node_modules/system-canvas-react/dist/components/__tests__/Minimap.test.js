...
import { computeUnionedBounds, computeAvgNodeWidth, bucketNodesIntoDensityGrid, applyHysteresis, } from '../Minimap.js';
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
function makeViewport(left, top, width, height) {
    return { left, top, width, height };
}
// Minimal ResolvedNode stub — only the fields the helpers read
function makeNode(x, y, w, h, type = 'text'
