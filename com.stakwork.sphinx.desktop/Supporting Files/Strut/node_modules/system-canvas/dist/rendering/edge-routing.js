 ...
 */
export function buildParallelEdgeGroups(edges) {
 ...
 */
export function computeEdgePath(edge, fromNode, toNode, style = 'bezier', parallelIndex = 0, parallelTotal = 1) {
 ...
 */
function computeBezierPath(from, to, fromSide, toSide, parallelIndex = 0, parallelTotal = 1) {
 ...
 */
function computeWaypointPath(from, to, fromSide, toSide, waypoints) {
...
export function computeEdgeMidpoint(edge, fromNode, toNode) {
    ...
    if (fromNode.id === toNode.id) {
        const exitSide = edge.fromSide ?? 'top';
