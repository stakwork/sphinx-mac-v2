 ...
 */
export function cullNodes(nodes, viewport, containerWidth, containerHeight, margin = 200) {
    if (nodes.length === 0)
        return nodes;
    ...
    return nodes.filter((n) => n.x < right && n.x + n.width > left && n.y < bottom && n.y + n.height > top);
}
