 ...
 */
export function computeCategorySlotRegions(node, theme, slots) {
    ...
    return {
        ...
        topLeft: (() => {
            ...
            const usesInlineRow = slots?.topLeft !== undefined &&
 ...
 */
export function resolveAccessor(accessor, ctx) {
 ...
 */
export function resolveAccessorOr(accessor, fallback, ctx) {
 ...
 */
export function getCategorySlots(node, theme) {
    if (!node.category)
        return undefined;
 ...
 */
export function pickRefIndicatorCorner(defaultCorner, slots) {
    if (!slots)
 ...
 */
export function computeReflowReservations(node, theme, slots) {
...
function computeReflowReservationsInternal(node, theme, slots) {
    ...
    const hasTopRowSignal = slots.header !== undefined ||
        slots.topRight !== undefined ||
        slots.bodyTop !== undefined ||
        slots.footer !== undefined;
    const hasInlineLeftMarker = slots.topLeft !== undefined &&
        (slots.topLeft.kind === 'dot' || slots.topLeft.kind === 'icon');
