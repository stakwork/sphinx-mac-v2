...
export namespace drive_v3 {
   ...
   */
  export interface Schema$AddReviewer {
    /**
     * Required. The email of the reviewer to add.
     */
    addedReviewerEmail?: string | null;
  }
  /**
   ...
   */
  export interface Schema$ApproveApprovalRequest {
    /**
   ...
   */
  export interface Schema$CancelApprovalRequest {
    /**
   ...
   */
  export interface Schema$CommentApprovalRequest {
    /**
   ...
   */
  export interface Schema$DeclineApprovalRequest {
    /**
     * Optional. A message to accompany the reviewer response on the approval. This message is included in notifications for the action and in the approval activity log.
     */
    message?: string | null;
   ...
   */
  export interface Schema$ReassignApprovalRequest {
    /**
     * Optional. The list of reviewers to add.
     */
    addReviewers?: Schema$AddReviewer[];
    /**
     ...
     */
    replaceReviewers?: Schema$ReplaceReviewer[];
  }
  /**
   * Representation of a reviewer replacement.
   */
  export interface Schema$ReplaceReviewer {
    /**
     * Required. The email of the reviewer to add.
     */
    addedReviewerEmail?: string | null;
     ...
     */
    removedReviewerEmail?: string | null;
  }
  /**
   ...
   */
  export interface Schema$StartApprovalRequest {
    /**
  ...
  export class Resource$Approvals {
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/drive/v3/files/{fileId}/approvals/{approvalId}:approve'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    cancel(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/drive/v3/files/{fileId}/approvals/{approvalId}:cancel'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/drive/v3/files/{fileId}/approvals/{approvalId}:comment'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/drive/v3/files/{fileId}/approvals/{approvalId}:decline'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
     ...
     *
     *   // Do the magic
     *   const res = await drive.approvals.reassign({
     ...
     */
    reassign(
      params: Params$Resource$Approvals$Reassign,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    reassign(
      params?: Params$Resource$Approvals$Reassign,
    ...
    reassign(callback: BodyResponseCallback<Schema$Approval>): void;
    reassign(
      paramsOrCallback?:
        | Params$Resource$Approvals$Reassign
        | BodyResponseCallback<Schema$Approval>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Approvals$Reassign;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Approvals$Reassign;
        options = {};
      }
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/drive/v3/files/{fileId}/approvals/{approvalId}:reassign'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
     ...
     *
     *   // Do the magic
     *   const res = await drive.approvals.start({
     ...
     */
    start(
      params: Params$Resource$Approvals$Start,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    start(
      params?: Params$Resource$Approvals$Start,
    ...
    start(callback: BodyResponseCallback<Schema$Approval>): void;
    start(
      paramsOrCallback?:
        | Params$Resource$Approvals$Start
        | BodyResponseCallback<Schema$Approval>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Schema$Approval>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback || {}) as Params$Resource$Approvals$Start;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Approvals$Start;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/drive/v3/files/{fileId}/approvals:start').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export interface Params$Resource$Approvals$Approve extends StandardParameters {
    /**
     * Required. The ID of the approval to approve.
     */
    approvalId?: string;
     ...
     * Request body metadata
     */
    requestBody?: Schema$ApproveApprovalRequest;
  }
  export interface Params$Resource$Approvals$Cancel extends StandardParameters {
     ...
     * Request body metadata
     */
    requestBody?: Schema$CancelApprovalRequest;
  }
  export interface Params$Resource$Approvals$Comment extends StandardParameters {
    /**
     * Required. The ID of the approval to comment on.
     */
    approvalId?: string;
     ...
     * Request body metadata
     */
    requestBody?: Schema$CommentApprovalRequest;
  }
  export interface Params$Resource$Approvals$Decline extends StandardParameters {
    /**
     * Required. The ID of the approval to decline.
     */
    approvalId?: string;
     ...
     * Request body metadata
     */
    requestBody?: Schema$DeclineApprovalRequest;
  }
  ...
  export interface Params$Resource$Approvals$Reassign extends StandardParameters {
    /**
     * Required. The ID of the approval to reassign.
     */
    approvalId?: string;
     ...
     * Request body metadata
     */
    requestBody?: Schema$ReassignApprovalRequest;
  }
  export interface Params$Resource$Approvals$Start extends StandardParameters {
    /**
     * Required. The ID of the file that the approval is created on.
     */
    fileId?: string;
  ...
  export class Resource$Files {
    ...
    generateCseToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/drive/v3/files/generateCseToken').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
