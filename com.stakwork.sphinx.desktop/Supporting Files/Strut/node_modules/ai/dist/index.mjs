...
var _a15;
var ToolChoiceViolationError = class extends AISDKError15 {
  constructor({
    toolChoice,
    finishReason,
    provider,
...
function getGlobalProvider() {
  var _a23;
  return (_a23 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a23 : gateway;
}
  ...
  () => zodSchema(
    z7.union([
      ...
      z7.looseObject({
        ...
        toolCallId: z7.string(),
        approvalDescriptor: z7.unknown().optional(),
          ...
          try {
            ...
            for (const toolApproval of invalidToolApprovals) {
              toolExecutionStepStreamController == null ? void 0 : toolExecutionStepStreamController.enqueue({
                ...
                toolName: toolApproval.toolCall.toolName,
                input: toolApproval.toolCall.input,
                error: getErrorMessage6(toolApproval.error),
          ...
          z8.union([
            ...
            z8.object({
              ...
              approval: z8.object({
                ...
                descriptor: z8.unknown().optional(),
...
import { EXPERIMENTAL_EMBEDDING_MODEL_MAX_INPUT_BYTES_PER_CALL as EXPERIMENTAL_EMBEDDING_MODEL_MAX_INPUT_BYTES_PER_CALL2 } from "@ai-sdk/provider-utils";
...
import { AISDKError as AISDKError26, NoSuchModelError as NoSuchModelError3 } from "@ai-sdk/provider";
...
var NoSuchProviderError = class extends NoSuchModelError3 {
  ...
  static isInstance(error) {
    return AISDKError26.hasMarker(error, marker22);
  }
};
_a22 = symbol22;
