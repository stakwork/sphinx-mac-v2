...
__export(src_exports, {
  AISDKError: () => import_provider23.AISDKError,
  APICallError: () => import_provider23.APICallError,
  ...
  EmptyResponseBodyError: () => import_provider23.EmptyResponseBodyError,
  Experimental_Agent: () => ToolLoopAgent,
  HttpChatTransport: () => HttpChatTransport,
  InvalidArgumentError: () => InvalidArgumentError,
  InvalidDataContentError: () => InvalidDataContentError,
  InvalidMessageRoleError: () => InvalidMessageRoleError,
  InvalidPromptError: () => import_provider23.InvalidPromptError,
  InvalidResponseDataError: () => import_provider23.InvalidResponseDataError,
  ...
  JSONParseError: () => import_provider23.JSONParseError,
  JsonToSseTransformStream: () => JsonToSseTransformStream,
  LoadAPIKeyError: () => import_provider23.LoadAPIKeyError,
  LoadSettingError: () => import_provider23.LoadSettingError,
  MessageConversionError: () => MessageConversionError,
  MissingToolResultsError: () => MissingToolResultsError,
  NoContentGeneratedError: () => import_provider23.NoContentGeneratedError,
  NoImageGeneratedError: () => NoImageGeneratedError,
  NoObjectGeneratedError: () => NoObjectGeneratedError,
  NoOutputGeneratedError: () => NoOutputGeneratedError,
  NoSpeechGeneratedError: () => NoSpeechGeneratedError,
  NoSuchModelError: () => import_provider23.NoSuchModelError,
  ...
  TooManyEmbeddingValuesForCallError: () => import_provider23.TooManyEmbeddingValuesForCallError,
  ...
  TypeValidationError: () => import_provider23.TypeValidationError,
  UIMessageStreamError: () => UIMessageStreamError,
  UI_MESSAGE_STREAM_HEADERS: () => UI_MESSAGE_STREAM_HEADERS,
  UnsupportedFunctionalityError: () => import_provider23.UnsupportedFunctionalityError,
  UnsupportedModelVersionError: () => UnsupportedModelVersionError,
  addToolInputExamplesMiddleware: () => addToolInputExamplesMiddleware,
  asSchema: () => import_provider_utils43.asSchema,
  ...
  createIdGenerator: () => import_provider_utils43.createIdGenerator,
  ...
  dynamicTool: () => import_provider_utils43.dynamicTool,
  embed: () => embed,
  embedMany: () => embedMany,
  ...
  generateId: () => import_provider_utils43.generateId,
  ...
  jsonSchema: () => import_provider_utils43.jsonSchema,
  ...
  parseJsonEventStream: () => import_provider_utils43.parseJsonEventStream,
  ...
  tool: () => import_provider_utils43.tool,
  ...
  zodSchema: () => import_provider_utils43.zodSchema
});
module.exports = __toCommonJS(src_exports);
var import_gateway4 = require("@ai-sdk/gateway");
var import_provider_utils43 = require("@ai-sdk/provider-utils");
...
var name15 = "AI_ToolChoiceViolationError";
var marker15 = `vercel.ai.error.${name15}`;
var symbol15 = Symbol.for(marker15);
var _a15;
var ToolChoiceViolationError = class extends import_provider15.AISDKError {
  constructor({
    toolChoice,
    finishReason,
    provider,
...
var ToolCallRepairError = class extends import_provider16.AISDKError {
  ...
  static isInstance(error) {
    return import_provider16.AISDKError.hasMarker(error, marker16);
  }
};
_a16 = symbol16;
...
var UnsupportedModelVersionError = class extends import_provider17.AISDKError {
  constructor(options) {
    super({
...
var _a17;
var UIMessageStreamError = class extends import_provider18.AISDKError {
  constructor({
    chunkType,
    chunkId,
    message
...
var _a18;
var InvalidDataContentError = class extends import_provider19.AISDKError {
  constructor({
    content,
    cause,
...
var _a19;
var InvalidMessageRoleError = class extends import_provider20.AISDKError {
  constructor({
    role,
...
var _a20;
var MessageConversionError = class extends import_provider21.AISDKError {
  constructor({
    originalMessage,
    message
  }) {
...
var _a21;
var RetryError = class extends import_provider22.AISDKError {
  constructor({
    message,
    reason,
    errors
  ...
  static isInstance(error) {
    return import_provider22.AISDKError.hasMarker(error, marker21);
  }
};
_a21 = symbol21;
...
function getGlobalProvider() {
  var _a23;
  return (_a23 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a23 : import_gateway.gateway;
}
...
// src/version.ts
var VERSION = true ? "6.0.280" : "0.0.0-test";
...
var dataContentSchema = import_v4.z.union([
  ...
  import_v4.z.custom(
    ...
    (value) => {
      var _a23, _b;
      return (_b = (_a23 = globalThis.Buffer) == null ? void 0 : _a23.isBuffer(value)) != null ? _b : false;
    },
      ...
      for (const part of message.content) {
        if (part.type === "image" || part.type === "file") {
          downloadableFiles.push({
            ...
            mediaType: (_a23 = part.mediaType) != null ? _a23 : part.type === "image" ? "image/*" : void 0
          });
        }
      }
    }
  ...
  switch (type) {
    case "image": {
      if (data instanceof Uint8Array || typeof data === "string") {
        mediaType = (_a23 = detectMediaType({ data, signatures: imageMediaTypeSignatures })) != null ? _a23 : mediaType;
      }
      return {
        type: "file",
      ...
      if (item.type === "image-url") {
        ...
        if (downloadedFile) {
          return {
            ...
            mediaType: (_a23 = downloadedFile.mediaType) != null ? _a23 : "image/*",
...
async function createToolModelOutput({
  ...
  if (errorMode === "text") {
    return { type: "error-text", value: (0, import_provider25.getErrorMessage)(output) };
...
async function prepareToolsAndToolChoice({
  ...
  const filteredTools = activeTools != null ? Object.entries(tools).filter(
    ([name23]) => activeTools.includes(name23)
  ) : Object.entries(tools);
  const languageModelTools = [];
  for (const [name23, tool2] of filteredTools) {
...
async function standardizePrompt({
  ...
  if (prompt == null && messages == null) {
    throw new import_provider26.InvalidPromptError({
      prompt,
...
function wrapGatewayError(error) {
  ...
  if (isProductionEnv) {
    return new import_provider27.AISDKError({
      name: "GatewayError",
...
function getBaseTelemetryAttributes({
  ...
  return {
    ...
    ...Object.entries((_a23 = telemetry == null ? void 0 : telemetry.metadata) != null ? _a23 : {}).reduce(
...
var noopTracer = {
  ...
  startActiveSpan(name23, arg1, arg2, arg3) {
...
function bindTelemetryIntegration(integration) {
  ...
  return {
    onStart: (_a23 = integration.onStart) == null ? void 0 : _a23.bind(integration),
...
function getRetryDelayInMs({
  ...
  const headers = import_provider28.APICallError.isInstance(error) ? error.responseHeaders : import_provider28.APICallError.isInstance(error.cause) ? error.cause.responseHeaders : void 0;
  if (!headers)
...
var retryWithExponentialBackoffRespectingRetryHeaders = ({
  ...
  backoffFactor,
  abortSignal,
  shouldRetry: async (error) => error instanceof Error && (import_provider28.APICallError.isInstance(error) && error.isRetryable === true || import_gateway3.GatewayError.isInstance(error) && error.isRetryable === true) || additionalRetryableError != null && await additionalRetryableError(error),
  ...
  return recordSpan({
    ...
    attributes: selectTelemetryAttributes({
      ...
      attributes: {
        ...
        ...Object.fromEntries(
          Object.entries((_a23 = telemetry == null ? void 0 : telemetry.metadata) != null ? _a23 : {}).map(([key, value]) => [
    ...
    if (approvalNeeded) {
      ...
      denied.push({
        ...
        approvalResponse: {
          ...
          approved: false,
          reason: (_a23 = approval.approvalResponse.reason) != null ? _a23 : `Tool "${toolCall.toolName}" does not require approval`
        }
      });
    }
  }
  ...
  return {
    ...
    async parseCompleteOutput({ text: text2 }, context2) {
      ...
      if (outerValue == null || typeof outerValue !== "object" || !("elements" in outerValue) || !Array.isArray(outerValue.elements)) {
        throw new NoObjectGeneratedError({
          message: "No object generated: response did not match schema.",
          cause: new import_provider29.TypeValidationError({
            value: outerValue,
...
async function generateText({
  ...
  try {
    return await recordSpan({
      ...
      tracer,
      fn: async (span) => {
        var _a23, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t;
        ...
        do {
          ...
          try {
            ...
            const stepModel = resolveLanguageModel(
              (_a23 = prepareStepResult == null ? void 0 : prepareStepResult.model) != null ? _a23 : model
            );
            const stepModelInfo = {
  ...
  () => (0, import_provider_utils17.zodSchema)(
    import_v47.z.union([
      ...
      import_v47.z.looseObject({
        ...
        toolCallId: import_v47.z.string(),
        approvalDescriptor: import_v47.z.unknown().optional(),
...
function handleUIMessageStreamFinish({
  ...
  const callOnFinish = async () => {
    ...
    const declaredOutcome = (_a23 = getOutcome == null ? void 0 : getOutcome()) != null ? _a23 : { status: "unknown" };
...
function createStitchableStream() {
  ...
  return {
    ...
    addStream: (innerStream, callbacks) => {
      var _a23;
      if (isCancelled) {
        (_a23 = callbacks == null ? void 0 : callbacks.onCancel) == null ? void 0 : _a23.call(callbacks);
...
var DefaultStreamTextResult = class {
    ...
    const eventProcessor = new TransformStream({
      ...
      async flush(controller) {
        ...
        try {
          ...
          const onFinishWithOutput = onFinish == null ? void 0 : async (event) => {
          ...
          await Promise.all([
            ...
            notify({
              event: onFinishEvent,
              callbacks: globalTelemetry.onFinish
            })
          ]);
            ...
            await selectTelemetryAttributes({
              ...
              attributes: {
                ...
                "ai.response.toolCalls": {
                  output: () => {
                    var _a24;
                    return ((_a24 = finalStep.toolCalls) == null ? void 0 : _a24.length) ? JSON.stringify(finalStep.toolCalls) : void 0;
                  }
                },
                "ai.response.providerMetadata": JSON.stringify(
                ...
                "ai.usage.inputTokens": totalUsage.inputTokens,
                "ai.usage.inputTokenDetails.noCacheTokens": (_a23 = totalUsage.inputTokenDetails) == null ? void 0 : _a23.noCacheTokens,
      ...
      async pull(controller) {
        function abort() {
          ...
          controller.enqueue({
            ...
            ...(abortSignal == null ? void 0 : abortSignal.reason) !== void 0 ? { reason: (0, import_provider30.getErrorMessage)(abortSignal.reason) } : {}
          });
          controller.close();
        }
        try {
          ...
          try {
            ...
            for (const toolApproval of invalidToolApprovals) {
              toolExecutionStepStreamController == null ? void 0 : toolExecutionStepStreamController.enqueue({
                ...
                toolName: toolApproval.toolCall.toolName,
                input: toolApproval.toolCall.input,
                error: (0, import_provider30.getErrorMessage)(toolApproval.error),
            ...
            if (toolOutputs.length > 0 || localDeniedToolApprovals.length > 0 || invalidToolApprovals.length > 0) {
          ...
          try {
            ...
            self.addStream(
              streamWithToolResults.pipeThrough(
                new TransformStream({
                  async transform(chunk, controller) {
                    var _a24, _b2, _c2, _d2, _e2, _f2, _g2, _h2, _i2;
                    resetChunkTimeout();
                    ...
                    switch (chunkType) {
                      ...
                      case "text-end": {
                        controller.enqueue({
                          ...chunk,
                          id: (_a24 = textPartIds.get(chunk.id)) != null ? _a24 : chunk.id
                        });
                  ...
                  async flush(controller) {
                    var _a24, _b2, _c2, _d2, _e2, _f2, _g2;
                      ...
                      doStreamSpan.setAttributes(
                        await selectTelemetryAttributes({
                          ...
                          attributes: {
                            ...
                            "ai.usage.inputTokenDetails.noCacheTokens": (_a24 = stepUsage.inputTokenDetails) == null ? void 0 : _a24.noCacheTokens,
  ...
  toUIMessageStream({
    ...
    const isDynamic = (part) => {
      var _a23;
      const tool2 = (_a23 = this.tools) == null ? void 0 : _a23[part.toolName];
      if (tool2 == null) {
        return part.dynamic;
      }
      return (tool2 == null ? void 0 : tool2.type) === "dynamic" ? true : void 0;
    };
    const trackFatalFailures = (stream) => {
      const reader = stream.getReader();
...
var ToolLoopAgent = class {
  ...
  async prepareCall(options) {
    ...
    const baseCallArgs = {
      ...
      stopWhen: (_a23 = this.settings.stopWhen) != null ? _a23 : stepCountIs(20),
      ...options
    };
          ...
          import_v48.z.union([
            ...
            import_v48.z.object({
              ...
              approval: import_v48.z.object({
                ...
                descriptor: import_v48.z.unknown().optional(),
          ...
          if (shouldValidateToolParts && part.type.startsWith("tool-")) {
            ...
            if (toolPart.state === "output-error") {
              if (toolPart.input !== void 0) {
                const result = await (0, import_provider_utils24.safeValidateTypes)({
                  value: toolPart.input,
...
async function createAgentUIStream({
  ...
  return result.toUIMessageStream({
    ...
    originalMessages: (_a23 = uiMessageStreamOptions.originalMessages) != null ? _a23 : validatedMessages
  });
}
...
function getEmbeddingModelMaxInputBytesPerCall(model) {
  return model[import_provider_utils26.EXPERIMENTAL_EMBEDDING_MODEL_MAX_INPUT_BYTES_PER_CALL];
}
...
function toImageModelV3File(dataContent) {
  ...
  if (typeof dataContent === "string" && dataContent.startsWith("data:")) {
    ...
    if (base64Content != null) {
      const uint8Data2 = (0, import_provider_utils28.convertBase64ToUint8Array)(base64Content);
      return {
        type: "file",
        data: uint8Data2,
...
var objectOutputStrategy = (schema) => ({
  ...
  async validateFinalResult(value) {
    return (0, import_provider_utils29.safeValidateTypes)({ value, schema });
  },
  createElementStream() {
    throw new import_provider32.UnsupportedFunctionalityError({
...
var arrayOutputStrategy = (schema) => {
  return {
    ...
    async validatePartialResult({
      ...
      var _a23;
      if (!(0, import_provider32.isJSONObject)(value) || !(0, import_provider32.isJSONArray)(value.elements)) {
        return {
          success: false,
      ...
      for (let i = 0; i < inputArray.length; i++) {
        ...
        const result = await (0, import_provider_utils29.safeValidateTypes)({ value: element, schema });
...
var enumOutputStrategy = (enumValues) => {
  return {
    ...
    async validateFinalResult(value) {
      if (!(0, import_provider32.isJSONObject)(value) || typeof value.result !== "string") {
        return {
          success: false,
          error: new import_provider32.TypeValidationError({
            value,
...
function getOutputStrategy({
  ...
  switch (output) {
    case "object":
      return objectOutputStrategy((0, import_provider_utils29.asSchema)(schema));
    case "array":
      return arrayOutputStrategy((0, import_provider_utils29.asSchema)(schema));
    case "enum":
...
async function parseAndValidateObjectResult(result, outputStrategy, context2) {
  const parseResult = await (0, import_provider_utils30.safeParseJSON)({ text: result });
  if (!parseResult.success) {
    throw new NoObjectGeneratedError({
      message: "No object generated: could not parse the response.",
      cause: parseResult.error,
...
async function parseAndValidateObjectResultWithRepair(result, outputStrategy, repairText, context2) {
  try {
    ...
    if (repairText != null && NoObjectGeneratedError.isInstance(error) && (import_provider33.JSONParseError.isInstance(error.cause) || import_provider33.TypeValidationError.isInstance(error.cause))) {
...
// src/generate-object/generate-object.ts
var originalGenerateId3 = (0, import_provider_utils31.createIdGenerator)({ prefix: "aiobj", size: 24 });
  ...
  try {
    return await recordSpan({
      ...
      fn: async (span) => {
        ...
        const generateResult = await retry(
          () => recordSpan({
            ...
            fn: async (span2) => {
              ...
              const responseData = {
                id: (_b = (_a24 = result2.response) == null ? void 0 : _a24.id) != null ? _b : generateId2(),
        ...
        request = (_a23 = generateResult.request) != null ? _a23 : {};
...
function simulateReadableStream({
  ...
  var _a23;
  const delay = (_a23 = _internal == null ? void 0 : _internal.delay) != null ? _a23 : import_provider_utils32.delay;
  let index = 0;
  return new ReadableStream({
    async pull(controller) {
...
// src/generate-object/stream-object.ts
var originalGenerateId4 = (0, import_provider_utils33.createIdGenerator)({ prefix: "aiobj", size: 24 });
...
var DefaultStreamObjectResult = class {
  constructor({
    ...
    this._object = new import_provider_utils33.DelayedPromise();
    this._usage = new import_provider_utils33.DelayedPromise();
    this._providerMetadata = new import_provider_utils33.DelayedPromise();
    this._warnings = new import_provider_utils33.DelayedPromise();
    this._request = new import_provider_utils33.DelayedPromise();
    this._response = new import_provider_utils33.DelayedPromise();
    this._finishReason = new import_provider_utils33.DelayedPromise();
    const model = resolveLanguageModel(modelArg);
    const { maxRetries, retry } = prepareRetries({
      maxRetries: maxRetriesArg,
      abortSignal
...
function smoothStream({
  delayInMs = 10,
  chunking = "word",
  _internal: { delay = import_provider_utils35.delay } = {}
} = {}) {
  let detectChunk;
  if (chunking != null && typeof chunking === "object" && "segment" in chunking && typeof chunking.segment === "function") {
    ...
    if (chunkingRegex == null) {
      throw new import_provider34.InvalidArgumentError({
        argument: "chunking",
...
function detectFileMediaType(data, restrictToImages) {
  var _a23;
  const detected = restrictToImages ? detectMediaType({ data, signatures: imageMediaTypeSignatures }) : (_a23 = detectMediaType({ data, signatures: imageMediaTypeSignatures })) != null ? _a23 : detectMediaType({ data, signatures: videoMediaTypeSignatures });
...
function normalizeImageData(dataContent, { restrictToImages = true } = {}) {
  if (typeof dataContent === "string") {
    ...
    if (dataContent.startsWith("data:")) {
      ...
      const data = (0, import_provider_utils36.convertBase64ToUint8Array)(base64Content != null ? base64Content : "");
      return {
        type: "file",
    ...
    const bytes = (0, import_provider_utils36.convertBase64ToUint8Array)(dataContent);
    return {
      type: "file",
...
var doWrap2 = ({
  ...
  return {
    ...
    [import_provider_utils37.EXPERIMENTAL_EMBEDDING_MODEL_MAX_INPUT_BYTES_PER_CALL]: getEmbeddingModelMaxInputBytesPerCall(model),
...
function customProvider({
  ...
  return {
    ...
    languageModel(modelId) {
      ...
      throw new import_provider35.NoSuchModelError({ modelId, modelType: "languageModel" });
    },
    embeddingModel(modelId) {
      ...
      throw new import_provider35.NoSuchModelError({ modelId, modelType: "embeddingModel" });
    },
    imageModel(modelId) {
      ...
      throw new import_provider35.NoSuchModelError({ modelId, modelType: "imageModel" });
    },
    transcriptionModel(modelId) {
      ...
      throw new import_provider35.NoSuchModelError({ modelId, modelType: "transcriptionModel" });
    },
    speechModel(modelId) {
      ...
      throw new import_provider35.NoSuchModelError({ modelId, modelType: "speechModel" });
    },
    rerankingModel(modelId) {
      ...
      throw new import_provider35.NoSuchModelError({ modelId, modelType: "rerankingModel" });
    },
    videoModel(modelId) {
      ...
      throw new import_provider35.NoSuchModelError({ modelId, modelType: "videoModel" });
    }
  };
}
...
var _a22;
var NoSuchProviderError = class extends import_provider36.NoSuchModelError {
  constructor({
    modelId,
    modelType,
    providerId,
  ...
  static isInstance(error) {
    return import_provider36.AISDKError.hasMarker(error, marker22);
  }
};
_a22 = symbol22;
...
var DefaultProviderRegistry = class {
  ...
  splitId(id, modelType) {
    ...
    if (index === -1) {
      throw new import_provider37.NoSuchModelError({
        modelId: id,
        modelType,
  ...
  languageModel(id) {
    ...
    if (model == null) {
      throw new import_provider37.NoSuchModelError({ modelId: id, modelType: "languageModel" });
    }
  ...
  imageModel(id) {
    ...
    if (model == null) {
      throw new import_provider37.NoSuchModelError({ modelId: id, modelType: "imageModel" });
    }
  ...
  speechModel(id) {
    ...
    if (model == null) {
      throw new import_provider37.NoSuchModelError({ modelId: id, modelType: "speechModel" });
    }
    return model;
  }
  rerankingModel(id) {
    ...
    if (model == null) {
      throw new import_provider37.NoSuchModelError({ modelId: id, modelType: "rerankingModel" });
    }
    return model;
  }
};
  ...
  return recordSpan({
    ...
    attributes: selectTelemetryAttributes({
      ...
      attributes: {
        ...
        ...baseTelemetryAttributes,
        "ai.documents": {
          input: () => documents.map((document2) => JSON.stringify(document2))
        }
      }
    }),
    tracer,
...
async function transcribe({
  ...
  const headersWithUserAgent = (0, import_provider_utils38.withUserAgentSuffix)(
    headers != null ? headers : {},
    `ai/${VERSION}`
  );
...
async function callCompletionApi({
  ...
  try {
    ...
    const response = await fetch2(api, {
      ...
      credentials,
      headers: (0, import_provider_utils39.withUserAgentSuffix)(
        {
          "Content-Type": "application/json",
          ...headers
        },
        `ai-sdk/${VERSION}`,
        (0, import_provider_utils39.getRuntimeEnvironmentUserAgent)()
      ),
    ...
    switch (streamProtocol) {
      ...
      case "data": {
        await consumeStream({
          stream: (0, import_provider_utils39.parseJsonEventStream)({
            stream: response.body,
...
// src/ui/chat.ts
var import_provider_utils42 = require("@ai-sdk/provider-utils");
...
var HttpChatTransport = class {
  ...
  async sendMessages({
    ...
    const resolvedBody = await (0, import_provider_utils40.resolve)(this.body);
    const resolvedHeaders = await (0, import_provider_utils40.resolve)(this.headers);
    const resolvedCredentials = await (0, import_provider_utils40.resolve)(this.credentials);
    const baseHeaders = {
      ...(0, import_provider_utils40.normalizeHeaders)(resolvedHeaders),
      ...(0, import_provider_utils40.normalizeHeaders)(options.headers)
    };
    ...
    const headers = (preparedRequest == null ? void 0 : preparedRequest.headers) !== void 0 ? (0, import_provider_utils40.normalizeHeaders)(preparedRequest.headers) : baseHeaders;
...
var DefaultChatTransport = class extends HttpChatTransport {
  ...
  processResponseStream(stream) {
    return (0, import_provider_utils41.parseJsonEventStream)({
      stream,
      schema: uiMessageChunkSchema
    }).pipeThrough(
      new TransformStream({
...
var AbstractChat = class {
  constructor({
    generateId: generateId2 = import_provider_utils42.generateId,
    id = generateId2(),
